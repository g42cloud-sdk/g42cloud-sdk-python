...
class ListPoolsResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, page_info=None, pools=None):
        ...
        :param request_id: The param of the ListPoolsResponse
        :type request_id: str
        :param page_info: The param of the ListPoolsResponse
        :type page_info: :class:`g42cloudsdkelb.v3.PageInfo`
        :param pools: The param of the ListPoolsResponse
        :type pools: list[:class:`g42cloudsdkelb.v3.Pool`]
        """
    ...
    def pools(self):
        ...
        :rtype: list[:class:`g42cloudsdkelb.v3.Pool`]
        """
        return self._pools
