...
class BatchCreateMembersRequest:
    ...
    openapi_types = {
        'pool_id': 'str',
        'body': 'BatchCreateMembersRequestBody'
    }
    ...
    def __init__(self, pool_id=None, body=None):
        ...
        :param pool_id: The param of the BatchCreateMembersRequest
        :type pool_id: str
        :param body: The param of the BatchCreateMembersRequest
        :type body: :class:`g42cloudsdkelb.v3.BatchCreateMembersRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkelb.v3.BatchCreateMembersRequestBody`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchCreateMembersRequest):
            return False
