...
class ShowIpGroupResponse(SdkResponse):
    ...
    def __init__(self, ipgroup=None, request_id=None):
        ...
        :param ipgroup: The param of the ShowIpGroupResponse
        :type ipgroup: :class:`g42cloudsdkelb.v3.IpGroup`
        :param request_id: The param of the ShowIpGroupResponse
        :type request_id: str
        """
    ...
    @property
    def ipgroup(self):
        """Gets the ipgroup of this ShowIpGroupResponse.
    ...
    def ipgroup(self, ipgroup):
        """Sets the ipgroup of this ShowIpGroupResponse.
