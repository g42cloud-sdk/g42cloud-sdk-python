...
class UpdatePoolRequest:
    ...
    def __init__(self, pool_id=None, body=None):
        ...
        :param pool_id: The param of the UpdatePoolRequest
        :type pool_id: str
        :param body: The param of the UpdatePoolRequest
        :type body: :class:`g42cloudsdkelb.v3.UpdatePoolRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkelb.v3.UpdatePoolRequestBody`
        """
        return self._body
