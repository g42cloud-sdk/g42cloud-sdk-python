...
class BatchDeleteMembersRequest:
    ...
    def __init__(self, pool_id=None, body=None):
        ...
        :param pool_id: The param of the BatchDeleteMembersRequest
        :type pool_id: str
        :param body: The param of the BatchDeleteMembersRequest
        :type body: :class:`g42cloudsdkelb.v3.BatchDeleteMembersRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkelb.v3.BatchDeleteMembersRequestBody`
        """
        return self._body
