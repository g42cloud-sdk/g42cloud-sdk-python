...
class ListIpGroupsResponse(SdkResponse):
    ...
    def __init__(self, ipgroups=None, request_id=None, page_info=None):
        ...
        :param ipgroups: The param of the ListIpGroupsResponse
        :type ipgroups: list[:class:`g42cloudsdkelb.v3.IpGroup`]
        :param request_id: The param of the ListIpGroupsResponse
        :type request_id: str
        :param page_info: The param of the ListIpGroupsResponse
    ...
    def ipgroups(self):
        ...
        :rtype: list[:class:`g42cloudsdkelb.v3.IpGroup`]
        """
