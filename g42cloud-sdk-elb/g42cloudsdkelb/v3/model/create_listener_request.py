...
class CreateListenerRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the CreateListenerRequest
        :type body: :class:`g42cloudsdkelb.v3.CreateListenerRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkelb.v3.CreateListenerRequestBody`
        """
        return self._body
