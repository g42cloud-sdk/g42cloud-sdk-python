...
class CreateIpGroupOption:
    ...
    def __init__(self, project_id=None, description=None, name=None, ip_list=None, enterprise_project_id=None):
        ...
        :param project_id: The param of the CreateIpGroupOption
        :type project_id: str
        :param description: The param of the CreateIpGroupOption
        :type description: str
        :param name: The param of the CreateIpGroupOption
        :type name: str
        :param ip_list: The param of the CreateIpGroupOption
        :type ip_list: list[:class:`g42cloudsdkelb.v3.CreateIpGroupIpOption`]
        :param enterprise_project_id: The param of the CreateIpGroupOption
    ...
    def ip_list(self):
        ...
        :rtype: list[:class:`g42cloudsdkelb.v3.CreateIpGroupIpOption`]
        """
