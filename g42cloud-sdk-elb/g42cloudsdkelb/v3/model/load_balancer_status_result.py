...
class LoadBalancerStatusResult:
    ...
    def __init__(self, loadbalancer=None):
        ...
        :param loadbalancer: The param of the LoadBalancerStatusResult
        :type loadbalancer: :class:`g42cloudsdkelb.v3.LoadBalancerStatus`
        """
    ...
    def loadbalancer(self):
        ...
        :rtype: :class:`g42cloudsdkelb.v3.LoadBalancerStatus`
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LoadBalancerStatusResult):
            return False
