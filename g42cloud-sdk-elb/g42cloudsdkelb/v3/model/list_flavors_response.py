...
class ListFlavorsResponse(SdkResponse):
    ...
    def __init__(self, flavors=None, page_info=None, request_id=None):
        ...
        :type flavors: list[:class:`g42cloudsdkelb.v3.Flavor`]
        :param page_info: The param of the ListFlavorsResponse
        :type page_info: :class:`g42cloudsdkelb.v3.PageInfo`
        :param request_id: The param of the ListFlavorsResponse
        :type request_id: str
        """
    ...
    def flavors(self):
        ...
        :rtype: list[:class:`g42cloudsdkelb.v3.Flavor`]
        """
