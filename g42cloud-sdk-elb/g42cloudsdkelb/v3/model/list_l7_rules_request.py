...
class ListL7RulesRequest:
    ...
    def __init__(self, l7policy_id=None, limit=None, marker=None, page_reverse=None, id=None, compare_type=None, provisioning_status=None, invert=None, admin_state_up=None, value=None, key=None, type=None, enterprise_project_id=None):
        ...
        :param l7policy_id: The param of the ListL7RulesRequest
        :type l7policy_id: str
        :param limit: The param of the ListL7RulesRequest
        :type limit: int
        :param marker: The param of the ListL7RulesRequest
        :type marker: str
        :param page_reverse: The param of the ListL7RulesRequest
        :type page_reverse: bool
        :param id: The param of the ListL7RulesRequest
        :type id: list[str]
        :param compare_type: The param of the ListL7RulesRequest
        :type compare_type: list[str]
        :param provisioning_status: The param of the ListL7RulesRequest
        :type provisioning_status: list[str]
        :param invert: The param of the ListL7RulesRequest
        :type invert: bool
        :param admin_state_up: The param of the ListL7RulesRequest
        :type admin_state_up: bool
        :param value: The param of the ListL7RulesRequest
        :type value: list[str]
        :param key: The param of the ListL7RulesRequest
        :type key: list[str]
        :param type: The param of the ListL7RulesRequest
        :type type: list[str]
        :param enterprise_project_id: The param of the ListL7RulesRequest
