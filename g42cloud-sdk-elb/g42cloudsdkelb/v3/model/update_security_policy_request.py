...
class UpdateSecurityPolicyRequest:
    ...
    def __init__(self, security_policy_id=None, body=None):
        ...
        :param security_policy_id: The param of the UpdateSecurityPolicyRequest
        :type security_policy_id: str
        :param body: The param of the UpdateSecurityPolicyRequest
        :type body: :class:`g42cloudsdkelb.v3.UpdateSecurityPolicyRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkelb.v3.UpdateSecurityPolicyRequestBody`
        """
        return self._body
