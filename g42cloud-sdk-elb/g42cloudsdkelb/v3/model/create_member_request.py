...
class CreateMemberRequest:
    ...
    def __init__(self, pool_id=None, body=None):
        ...
        :param pool_id: The param of the CreateMemberRequest
        :type pool_id: str
        :param body: The param of the CreateMemberRequest
        :type body: :class:`g42cloudsdkelb.v3.CreateMemberRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkelb.v3.CreateMemberRequestBody`
        """
        return self._body
