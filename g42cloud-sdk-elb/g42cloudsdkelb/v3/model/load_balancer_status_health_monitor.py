...
class LoadBalancerStatusHealthMonitor:
    ...
    def __init__(self, type=None, id=None, name=None, provisioning_status=None):
        ...
        :param type: The param of the LoadBalancerStatusHealthMonitor
        :type type: str
        :param id: The param of the LoadBalancerStatusHealthMonitor
        :type id: str
        :param name: The param of the LoadBalancerStatusHealthMonitor
        :type name: str
        :param provisioning_status: The param of the LoadBalancerStatusHealthMonitor
