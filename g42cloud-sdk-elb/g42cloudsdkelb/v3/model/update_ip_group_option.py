...
class UpdateIpGroupOption:
    ...
    def __init__(self, description=None, name=None, ip_list=None):
        ...
        :param description: The param of the UpdateIpGroupOption
        :type description: str
        :param name: The param of the UpdateIpGroupOption
        :type name: str
        :param ip_list: The param of the UpdateIpGroupOption
        :type ip_list: list[:class:`g42cloudsdkelb.v3.UpadateIpGroupIpOption`]
        """
    ...
    def ip_list(self):
        ...
        :rtype: list[:class:`g42cloudsdkelb.v3.UpadateIpGroupIpOption`]
        """
