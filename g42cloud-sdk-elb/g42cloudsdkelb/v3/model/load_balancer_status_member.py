...
class LoadBalancerStatusMember:
    ...
    def __init__(self, provisioning_status=None, address=None, protocol_port=None, id=None, operating_status=None):
        ...
        :param provisioning_status: The param of the LoadBalancerStatusMember
        :type provisioning_status: str
        :param address: The param of the LoadBalancerStatusMember
        :type address: str
        :param protocol_port: The param of the LoadBalancerStatusMember
        :type protocol_port: int
        :param id: The param of the LoadBalancerStatusMember
        :type id: str
        :param operating_status: The param of the LoadBalancerStatusMember
