...
class UpdateIpListRequest:
    ...
    def __init__(self, ipgroup_id=None, body=None):
        ...
        :param ipgroup_id: The param of the UpdateIpListRequest
        :type ipgroup_id: str
        :param body: The param of the UpdateIpListRequest
        :type body: :class:`g42cloudsdkelb.v3.UpdateIpListRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkelb.v3.UpdateIpListRequestBody`
        """
        return self._body
