...
class CreateLoadBalancerResponse(SdkResponse):
    ...
    def __init__(self, loadbalancer=None, loadbalancer_id=None, order_id=None, request_id=None):
        ...
        :param loadbalancer: The param of the CreateLoadBalancerResponse
        :type loadbalancer: :class:`g42cloudsdkelb.v3.LoadBalancer`
        :param loadbalancer_id: The param of the CreateLoadBalancerResponse
        :type loadbalancer_id: str
        :param order_id: The param of the CreateLoadBalancerResponse
        :type order_id: str
        :param request_id: The param of the CreateLoadBalancerResponse
        :type request_id: str
        """
