...
class BatchDeleteMembersResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, members=None):
        ...
        :param request_id: The param of the BatchDeleteMembersResponse
        :type request_id: str
        :param members: The param of the BatchDeleteMembersResponse
        :type members: list[:class:`g42cloudsdkelb.v3.BatchDeleteMembersState`]
        """
    ...
    @property
    def request_id(self):
        """Gets the request_id of this BatchDeleteMembersResponse.
    ...
    def request_id(self, request_id):
        """Sets the request_id of this BatchDeleteMembersResponse.
    ...
    @property
    def members(self):
        """Gets the members of this BatchDeleteMembersResponse.

        :return: The members of this BatchDeleteMembersResponse.
        :rtype: list[:class:`g42cloudsdkelb.v3.BatchDeleteMembersState`]
        """
        return self._members

    @members.setter
    def members(self, members):
        """Sets the members of this BatchDeleteMembersResponse.
