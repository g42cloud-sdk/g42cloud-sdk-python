...
class ListL7PoliciesResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, page_info=None, l7policies=None):
        ...
        :param request_id: The param of the ListL7PoliciesResponse
        :type request_id: str
        :param page_info: The param of the ListL7PoliciesResponse
        :type page_info: :class:`g42cloudsdkelb.v3.PageInfo`
        :param l7policies: The param of the ListL7PoliciesResponse
        :type l7policies: list[:class:`g42cloudsdkelb.v3.L7Policy`]
        """
    ...
    def l7policies(self):
        ...
        :rtype: list[:class:`g42cloudsdkelb.v3.L7Policy`]
        """
