...
class SystemSecurityPolicy:
    ...
    def __init__(self, name=None, protocols=None, ciphers=None, project_id=None):
        ...
        :param name: The param of the SystemSecurityPolicy
        :type name: str
        :param protocols: The param of the SystemSecurityPolicy
        :type protocols: str
        :param ciphers: The param of the SystemSecurityPolicy
        :type ciphers: str
        :param project_id: The param of the SystemSecurityPolicy
        :type project_id: str
        """
