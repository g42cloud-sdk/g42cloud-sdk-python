...
class CreateHealthMonitorOption:
    ...
    def __init__(self, admin_state_up=None, delay=None, domain_name=None, expected_codes=None, http_method=None, max_retries=None, max_retries_down=None, monitor_port=None, name=None, pool_id=None, project_id=None, timeout=None, type=None, url_path=None):
        ...
        :param admin_state_up: The param of the CreateHealthMonitorOption
        :type admin_state_up: bool
        :param delay: The param of the CreateHealthMonitorOption
        :type delay: int
        :param domain_name: The param of the CreateHealthMonitorOption
        :type domain_name: str
        :param expected_codes: The param of the CreateHealthMonitorOption
        :type expected_codes: str
        :param http_method: The param of the CreateHealthMonitorOption
        :type http_method: str
        :param max_retries: The param of the CreateHealthMonitorOption
        :type max_retries: int
        :param max_retries_down: The param of the CreateHealthMonitorOption
        :type max_retries_down: int
        :param monitor_port: The param of the CreateHealthMonitorOption
        :type monitor_port: int
        :param name: The param of the CreateHealthMonitorOption
        :type name: str
        :param pool_id: The param of the CreateHealthMonitorOption
        :type pool_id: str
        :param project_id: The param of the CreateHealthMonitorOption
        :type project_id: str
        :param timeout: The param of the CreateHealthMonitorOption
        :type timeout: int
        :param type: The param of the CreateHealthMonitorOption
        :type type: str
        :param url_path: The param of the CreateHealthMonitorOption
        :type url_path: str
        """
