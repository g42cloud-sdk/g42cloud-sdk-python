...
class Logtank:
    ...
    def __init__(self, id=None, project_id=None, loadbalancer_id=None, log_group_id=None, log_topic_id=None):
        ...
        :param id: The param of the Logtank
        :type id: str
        :param project_id: The param of the Logtank
        :type project_id: str
        :param loadbalancer_id: The param of the Logtank
        :type loadbalancer_id: str
        :param log_group_id: The param of the Logtank
        :type log_group_id: str
        :param log_topic_id: The param of the Logtank
