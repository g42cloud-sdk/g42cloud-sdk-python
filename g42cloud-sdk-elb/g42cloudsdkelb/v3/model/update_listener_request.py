...
class UpdateListenerRequest:
    ...
    def __init__(self, listener_id=None, body=None):
        ...
        :param listener_id: The param of the UpdateListenerRequest
        :type listener_id: str
        :param body: The param of the UpdateListenerRequest
        :type body: :class:`g42cloudsdkelb.v3.UpdateListenerRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkelb.v3.UpdateListenerRequestBody`
        """
        return self._body
