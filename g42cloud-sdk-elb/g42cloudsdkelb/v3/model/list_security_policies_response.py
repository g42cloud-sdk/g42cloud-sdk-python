...
class ListSecurityPoliciesResponse(SdkResponse):
    ...
    def __init__(self, security_policies=None, request_id=None, page_info=None):
        ...
        :param security_policies: The param of the ListSecurityPoliciesResponse
        :type security_policies: list[:class:`g42cloudsdkelb.v3.SecurityPolicy`]
        :param request_id: The param of the ListSecurityPoliciesResponse
        :type request_id: str
        :param page_info: The param of the ListSecurityPoliciesResponse
    ...
    def security_policies(self):
        ...
        :rtype: list[:class:`g42cloudsdkelb.v3.SecurityPolicy`]
        """
