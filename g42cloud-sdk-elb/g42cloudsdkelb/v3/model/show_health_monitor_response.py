...
class ShowHealthMonitorResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, healthmonitor=None):
        """ShowHealthMonitorResponse

        The model defined in g42cloud sdk

        :param request_id: The param of the ShowHealthMonitorResponse
        :type request_id: str
        :param healthmonitor: The param of the ShowHealthMonitorResponse
        :type healthmonitor: :class:`g42cloudsdkelb.v3.HealthMonitor`
        """
        
        super(ShowHealthMonitorResponse, self).__init__()
