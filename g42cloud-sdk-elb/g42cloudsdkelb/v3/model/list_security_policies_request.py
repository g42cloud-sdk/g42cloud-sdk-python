...
class ListSecurityPoliciesRequest:
    ...
    def __init__(self, marker=None, limit=None, page_reverse=None, id=None, name=None, description=None, protocols=None, ciphers=None):
        ...
        :param marker: The param of the ListSecurityPoliciesRequest
        :type marker: str
        :param limit: The param of the ListSecurityPoliciesRequest
        :type limit: int
        :param page_reverse: The param of the ListSecurityPoliciesRequest
        :type page_reverse: bool
        :param id: The param of the ListSecurityPoliciesRequest
        :type id: list[str]
        :param name: The param of the ListSecurityPoliciesRequest
        :type name: list[str]
        :param description: The param of the ListSecurityPoliciesRequest
        :type description: list[str]
        :param protocols: The param of the ListSecurityPoliciesRequest
        :type protocols: list[str]
        :param ciphers: The param of the ListSecurityPoliciesRequest
