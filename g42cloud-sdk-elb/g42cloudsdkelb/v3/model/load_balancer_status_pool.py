...
class LoadBalancerStatusPool:
    ...
    def __init__(self, provisioning_status=None, name=None, healthmonitor=None, members=None, id=None, operating_status=None):
        ...
        :param provisioning_status: The param of the LoadBalancerStatusPool
        :type provisioning_status: str
        :param name: The param of the LoadBalancerStatusPool
        :type name: str
        :param healthmonitor: The param of the LoadBalancerStatusPool
        :type healthmonitor: :class:`g42cloudsdkelb.v3.LoadBalancerStatusHealthMonitor`
        :param members: The param of the LoadBalancerStatusPool
        :type members: list[:class:`g42cloudsdkelb.v3.LoadBalancerStatusMember`]
        :param id: The param of the LoadBalancerStatusPool
        :type id: str
        :param operating_status: The param of the LoadBalancerStatusPool
    ...
    def healthmonitor(self):
        ...
        :rtype: :class:`g42cloudsdkelb.v3.LoadBalancerStatusHealthMonitor`
        """
    ...
    def members(self):
        ...
        :rtype: list[:class:`g42cloudsdkelb.v3.LoadBalancerStatusMember`]
        """
