...
class ListSystemSecurityPoliciesResponse(SdkResponse):
    ...
    def __init__(self, system_security_policies=None, request_id=None):
        ...
        :param system_security_policies: The param of the ListSystemSecurityPoliciesResponse
        :type system_security_policies: list[:class:`g42cloudsdkelb.v3.SystemSecurityPolicy`]
        :param request_id: The param of the ListSystemSecurityPoliciesResponse
        :type request_id: str
        """
    ...
    def system_security_policies(self):
        ...
        :rtype: list[:class:`g42cloudsdkelb.v3.SystemSecurityPolicy`]
        """
