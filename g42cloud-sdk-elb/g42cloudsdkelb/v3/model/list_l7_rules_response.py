...
class ListL7RulesResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, page_info=None, rules=None):
        ...
        :param request_id: The param of the ListL7RulesResponse
        :type request_id: str
        :param page_info: The param of the ListL7RulesResponse
        :type page_info: :class:`g42cloudsdkelb.v3.PageInfo`
        :param rules: The param of the ListL7RulesResponse
        :type rules: list[:class:`g42cloudsdkelb.v3.L7Rule`]
        """
    ...
    def rules(self):
        ...
        :rtype: list[:class:`g42cloudsdkelb.v3.L7Rule`]
        """
        return self._rules
