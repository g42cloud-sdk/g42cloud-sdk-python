...
class UpdateL7RuleRequest:
    ...
    def __init__(self, l7policy_id=None, l7rule_id=None, body=None):
        ...
        :param l7policy_id: The param of the UpdateL7RuleRequest
        :type l7policy_id: str
        :param l7rule_id: The param of the UpdateL7RuleRequest
        :type l7rule_id: str
        :param body: The param of the UpdateL7RuleRequest
        :type body: :class:`g42cloudsdkelb.v3.UpdateL7RuleRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkelb.v3.UpdateL7RuleRequestBody`
        """
        return self._body
