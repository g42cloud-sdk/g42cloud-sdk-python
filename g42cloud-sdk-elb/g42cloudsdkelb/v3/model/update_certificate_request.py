...
class UpdateCertificateRequest:
    ...
    def __init__(self, certificate_id=None, body=None):
        ...
        :param certificate_id: The param of the UpdateCertificateRequest
        :type certificate_id: str
        :param body: The param of the UpdateCertificateRequest
        :type body: :class:`g42cloudsdkelb.v3.UpdateCertificateRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkelb.v3.UpdateCertificateRequestBody`
        """
        return self._body
