...
class GlobalEipInfo:
    ...
    def __init__(self, global_eip_id=None, global_eip_address=None, ip_version=None):
        ...
        :param global_eip_id: The param of the GlobalEipInfo
        :type global_eip_id: str
        :param global_eip_address: The param of the GlobalEipInfo
        :type global_eip_address: str
        :param ip_version: The param of the GlobalEipInfo
        :type ip_version: int
        """
