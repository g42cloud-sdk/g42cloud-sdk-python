...
class ShowLoadBalancerStatusResponse(SdkResponse):
    ...
    def __init__(self, statuses=None, request_id=None):
        ...
        :param statuses: The param of the ShowLoadBalancerStatusResponse
        :type statuses: :class:`g42cloudsdkelb.v3.LoadBalancerStatusResult`
        :param request_id: The param of the ShowLoadBalancerStatusResponse
        :type request_id: str
        """
    ...
    def statuses(self):
        ...
        :rtype: :class:`g42cloudsdkelb.v3.LoadBalancerStatusResult`
        """
