...
class BatchMember:
    ...
    def __init__(self, id=None, name=None, project_id=None, admin_state_up=None, subnet_cidr_id=None, protocol_port=None, weight=None, address=None, operating_status=None, status=None, member_type=None, instance_id=None, port_id=None, ret_status=None):
        ...
        :param id: The param of the BatchMember
        :type id: str
        :param name: The param of the BatchMember
        :type name: str
        :param project_id: The param of the BatchMember
        :type project_id: str
        :param admin_state_up: The param of the BatchMember
        :type admin_state_up: bool
        :param subnet_cidr_id: The param of the BatchMember
        :type subnet_cidr_id: str
        :param protocol_port: The param of the BatchMember
        :type protocol_port: int
        :param weight: The param of the BatchMember
        :type weight: int
        :param address: The param of the BatchMember
        :type address: str
        :param operating_status: The param of the BatchMember
        :type operating_status: str
        :param status: The param of the BatchMember
        :type status: list[:class:`g42cloudsdkelb.v3.MemberStatus`]
        :param member_type: The param of the BatchMember
        :type member_type: str
        :param instance_id: The param of the BatchMember
        :type instance_id: str
        :param port_id: The param of the BatchMember
        :type port_id: str
        :param ret_status: The param of the BatchMember
        :type ret_status: str
        """
