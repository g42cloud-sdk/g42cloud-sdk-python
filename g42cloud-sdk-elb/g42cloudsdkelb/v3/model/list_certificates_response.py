...
class ListCertificatesResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, page_info=None, certificates=None):
        ...
        :param request_id: The param of the ListCertificatesResponse
        :type request_id: str
        :param page_info: The param of the ListCertificatesResponse
        :type page_info: :class:`g42cloudsdkelb.v3.PageInfo`
        :param certificates: The param of the ListCertificatesResponse
        :type certificates: list[:class:`g42cloudsdkelb.v3.CertificateInfo`]
        """
    ...
    def certificates(self):
        ...
        :rtype: list[:class:`g42cloudsdkelb.v3.CertificateInfo`]
        """
