...
class CreateL7RuleRequest:
    ...
    def __init__(self, l7policy_id=None, body=None):
        ...
        :param l7policy_id: The param of the CreateL7RuleRequest
        :type l7policy_id: str
        :param body: The param of the CreateL7RuleRequest
        :type body: :class:`g42cloudsdkelb.v3.CreateL7RuleRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkelb.v3.CreateL7RuleRequestBody`
        """
        return self._body
