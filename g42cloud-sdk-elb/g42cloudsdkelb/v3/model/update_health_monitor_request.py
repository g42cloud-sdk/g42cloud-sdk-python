...
class UpdateHealthMonitorRequest:
    ...
    def __init__(self, healthmonitor_id=None, body=None):
        ...
        :param healthmonitor_id: The param of the UpdateHealthMonitorRequest
        :type healthmonitor_id: str
        :param body: The param of the UpdateHealthMonitorRequest
        :type body: :class:`g42cloudsdkelb.v3.UpdateHealthMonitorRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkelb.v3.UpdateHealthMonitorRequestBody`
        """
        return self._body
