...
class UpdateIpGroupRequest:
    ...
    def __init__(self, ipgroup_id=None, body=None):
        ...
        :param ipgroup_id: The param of the UpdateIpGroupRequest
        :type ipgroup_id: str
        :param body: The param of the UpdateIpGroupRequest
        :type body: :class:`g42cloudsdkelb.v3.UpdateIpGroupRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkelb.v3.UpdateIpGroupRequestBody`
        """
        return self._body
