...
class BatchCreateMembersResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, members=None):
        ...
        :param request_id: The param of the BatchCreateMembersResponse
        :type request_id: str
        :param members: The param of the BatchCreateMembersResponse
        :type members: list[:class:`g42cloudsdkelb.v3.BatchMember`]
        """
    ...
    def members(self):
        ...
        :rtype: list[:class:`g42cloudsdkelb.v3.BatchMember`]
        """
