...
class CreateListenerIpGroupOption:
    ...
    def __init__(self, ipgroup_id=None, enable_ipgroup=None, type=None):
        ...
        :param ipgroup_id: The param of the CreateListenerIpGroupOption
        :type ipgroup_id: str
        :param enable_ipgroup: The param of the CreateListenerIpGroupOption
        :type enable_ipgroup: bool
        :param type: The param of the CreateListenerIpGroupOption
        :type type: str
        """
