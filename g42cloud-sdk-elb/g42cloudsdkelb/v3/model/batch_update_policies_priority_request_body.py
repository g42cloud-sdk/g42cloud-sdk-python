...
class BatchUpdatePoliciesPriorityRequestBody:
    ...
    def __init__(self, l7policies=None):
        ...
        :param l7policies: The param of the BatchUpdatePoliciesPriorityRequestBody
        :type l7policies: list[:class:`g42cloudsdkelb.v3.BatchUpdatePriorityRequestBody`]
        """
    ...
    def l7policies(self):
        ...
        :rtype: list[:class:`g42cloudsdkelb.v3.BatchUpdatePriorityRequestBody`]
        """
