...
class BatchDeleteIpListRequest:
    ...
    def __init__(self, ipgroup_id=None, body=None):
        ...
        :param ipgroup_id: The param of the BatchDeleteIpListRequest
        :type ipgroup_id: str
        :param body: The param of the BatchDeleteIpListRequest
        :type body: :class:`g42cloudsdkelb.v3.BatchDeleteIpListRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkelb.v3.BatchDeleteIpListRequestBody`
        """
        return self._body
