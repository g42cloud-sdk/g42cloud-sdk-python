...
class UpdateSecurityPolicyRequestBody:
    ...
    openapi_types = {
        'security_policy': 'UpdateSecurityPolicyOption'
    }
    ...
    def __init__(self, security_policy=None):
        ...
        :param security_policy: The param of the UpdateSecurityPolicyRequestBody
        :type security_policy: :class:`g42cloudsdkelb.v3.UpdateSecurityPolicyOption`
        """
    ...
    def security_policy(self):
        ...
        :rtype: :class:`g42cloudsdkelb.v3.UpdateSecurityPolicyOption`
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateSecurityPolicyRequestBody):
            return False
