...
class CreatePoolSessionPersistenceOption:
    ...
    def __init__(self, cookie_name=None, type=None, persistence_timeout=None):
        ...
        :param cookie_name: The param of the CreatePoolSessionPersistenceOption
        :type cookie_name: str
        :param type: The param of the CreatePoolSessionPersistenceOption
        :type type: str
        :param persistence_timeout: The param of the CreatePoolSessionPersistenceOption
