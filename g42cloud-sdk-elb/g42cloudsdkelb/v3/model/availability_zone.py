...
class AvailabilityZone:
    ...
    def __init__(self, code=None, state=None, protocol=None, public_border_group=None, category=None):
        ...
        :param code: The param of the AvailabilityZone
        :type code: str
        :param state: The param of the AvailabilityZone
        :type state: str
        :param protocol: The param of the AvailabilityZone
        :type protocol: list[str]
        :param public_border_group: The param of the AvailabilityZone
        :type public_border_group: str
        :param category: The param of the AvailabilityZone
        :type category: int
        """
