...
class ShowQuotaResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, quota=None):
        ...
        :param request_id: The param of the ShowQuotaResponse
        :type request_id: str
        :param quota: The param of the ShowQuotaResponse
        :type quota: :class:`g42cloudsdkelb.v3.Quota`
        """
    ...
    def quota(self):
        ...
        :rtype: :class:`g42cloudsdkelb.v3.Quota`
        """
        return self._quota
