...
class ChangeLoadbalancerChargeModeResponse(SdkResponse):
    ...
    def __init__(self, eip_id_list=None, loadbalancer_id_list=None, order_id=None, request_id=None):
        ...
        :param eip_id_list: The param of the ChangeLoadbalancerChargeModeResponse
        :type eip_id_list: list[str]
        :param loadbalancer_id_list: The param of the ChangeLoadbalancerChargeModeResponse
        :type loadbalancer_id_list: list[str]
        :param order_id: The param of the ChangeLoadbalancerChargeModeResponse
        :type order_id: str
        :param request_id: The param of the ChangeLoadbalancerChargeModeResponse
        :type request_id: str
        """
