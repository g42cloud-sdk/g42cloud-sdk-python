...
class CreateFixtedResponseConfig:
    ...
    def __init__(self, status_code=None, content_type=None, message_body=None):
        ...
        :param status_code: The param of the CreateFixtedResponseConfig
        :type status_code: str
        :param content_type: The param of the CreateFixtedResponseConfig
        :type content_type: str
        :param message_body: The param of the CreateFixtedResponseConfig
