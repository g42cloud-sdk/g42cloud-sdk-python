...
class FixtedResponseConfig:
    ...
    def __init__(self, status_code=None, content_type=None, message_body=None):
        ...
        :param status_code: The param of the FixtedResponseConfig
        :type status_code: str
        :param content_type: The param of the FixtedResponseConfig
        :type content_type: str
        :param message_body: The param of the FixtedResponseConfig
