...
class UpdateLoadBalancerRequest:
    ...
    def __init__(self, loadbalancer_id=None, body=None):
        ...
        :param loadbalancer_id: The param of the UpdateLoadBalancerRequest
        :type loadbalancer_id: str
        :param body: The param of the UpdateLoadBalancerRequest
        :type body: :class:`g42cloudsdkelb.v3.UpdateLoadBalancerRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkelb.v3.UpdateLoadBalancerRequestBody`
        """
        return self._body
