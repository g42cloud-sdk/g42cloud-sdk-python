...
class ChangeLoadbalancerChargeModeRequestBody:
    ...
    def __init__(self, loadbalancer_ids=None, charge_mode=None, prepaid_options=None):
        ...
        :param loadbalancer_ids: The param of the ChangeLoadbalancerChargeModeRequestBody
        :type loadbalancer_ids: list[str]
        :param charge_mode: The param of the ChangeLoadbalancerChargeModeRequestBody
        :type charge_mode: str
        :param prepaid_options: The param of the ChangeLoadbalancerChargeModeRequestBody
        :type prepaid_options: :class:`g42cloudsdkelb.v3.PrepaidChangeChargeModeOption`
        """
    ...
    def prepaid_options(self):
        ...
        :rtype: :class:`g42cloudsdkelb.v3.PrepaidChangeChargeModeOption`
        """
