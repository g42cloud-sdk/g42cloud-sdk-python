...
class ListenerInsertHeaders:
    ...
    def __init__(self, x_forwarded_elb_ip=None, x_forwarded_port=None, x_forwarded_for_port=None, x_forwarded_host=None):
        ...
        :param x_forwarded_elb_ip: The param of the ListenerInsertHeaders
        :type x_forwarded_elb_ip: bool
        :param x_forwarded_port: The param of the ListenerInsertHeaders
        :type x_forwarded_port: bool
        :param x_forwarded_for_port: The param of the ListenerInsertHeaders
        :type x_forwarded_for_port: bool
        :param x_forwarded_host: The param of the ListenerInsertHeaders
