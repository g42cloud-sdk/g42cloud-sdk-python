...
class ListLoadBalancersResponse(SdkResponse):
    ...
    def __init__(self, loadbalancers=None, page_info=None, request_id=None):
        ...
        :param loadbalancers: The param of the ListLoadBalancersResponse
        :type loadbalancers: list[:class:`g42cloudsdkelb.v3.LoadBalancer`]
        :param page_info: The param of the ListLoadBalancersResponse
        :type page_info: :class:`g42cloudsdkelb.v3.PageInfo`
        :param request_id: The param of the ListLoadBalancersResponse
        :type request_id: str
        """
    ...
    def loadbalancers(self):
        ...
        :rtype: list[:class:`g42cloudsdkelb.v3.LoadBalancer`]
        """
