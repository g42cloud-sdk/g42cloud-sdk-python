...
class NeutronShowSecurityGroupRuleRequest:
    ...
    def __init__(self, security_group_rule_id=None):
        ...
        :param security_group_rule_id: The param of the NeutronShowSecurityGroupRuleRequest
    ...
    def security_group_rule_id(self):
        ...
        :return: The security_group_rule_id of this NeutronShowSecurityGroupRuleRequest.
        :rtype: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NeutronShowSecurityGroupRuleRequest):
            return False
