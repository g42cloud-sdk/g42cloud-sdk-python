...
class SubnetIpAvailability:
    ...
    def __init__(self, used_ips=None, subnet_id=None, subnet_name=None, ip_version=None, cidr=None, total_ips=None):
        ...
        :param used_ips: The param of the SubnetIpAvailability
        :type used_ips: int
        :param subnet_id: The param of the SubnetIpAvailability
        :type subnet_id: str
        :param subnet_name: The param of the SubnetIpAvailability
        :type subnet_name: str
        :param ip_version: The param of the SubnetIpAvailability
        :type ip_version: int
        :param cidr: The param of the SubnetIpAvailability
        :type cidr: str
        :param total_ips: The param of the SubnetIpAvailability
        :type total_ips: int
        """
