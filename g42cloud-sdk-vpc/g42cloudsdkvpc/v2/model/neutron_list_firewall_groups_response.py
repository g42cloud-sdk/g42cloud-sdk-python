...
class NeutronListFirewallGroupsResponse(SdkResponse):
    ...
    def __init__(self, firewall_groups=None, firewall_groups_links=None):
        ...
        :param firewall_groups: The param of the NeutronListFirewallGroupsResponse
        :type firewall_groups: list[:class:`g42cloudsdkvpc.v2.NeutronFirewallGroup`]
        :param firewall_groups_links: The param of the NeutronListFirewallGroupsResponse
        :type firewall_groups_links: list[:class:`g42cloudsdkvpc.v2.NeutronPageLink`]
        """
    ...
    def firewall_groups(self):
        ...
        :rtype: list[:class:`g42cloudsdkvpc.v2.NeutronFirewallGroup`]
        """
