...
class BatchDeleteSubnetTagsRequest:
    ...
    def __init__(self, subnet_id=None, body=None):
        ...
        :param subnet_id: The param of the BatchDeleteSubnetTagsRequest
        :type subnet_id: str
        :param body: The param of the BatchDeleteSubnetTagsRequest
        :type body: :class:`g42cloudsdkvpc.v2.BatchDeleteSubnetTagsRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkvpc.v2.BatchDeleteSubnetTagsRequestBody`
        """
        return self._body
