...
class CreatePrivateipResponse(SdkResponse):
    ...
    def __init__(self, privateips=None):
        ...
        :param privateips: The param of the CreatePrivateipResponse
        :type privateips: list[:class:`g42cloudsdkvpc.v2.Privateip`]
        """
    ...
    def privateips(self):
        ...
        :rtype: list[:class:`g42cloudsdkvpc.v2.Privateip`]
        """
