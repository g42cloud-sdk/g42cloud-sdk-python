...
class ListPrivateipsRequest:
    ...
    def __init__(self, subnet_id=None, limit=None, marker=None):
        ...
        :param subnet_id: The param of the ListPrivateipsRequest
        :type subnet_id: str
        :param limit: The param of the ListPrivateipsRequest
        :type limit: int
        :param marker: The param of the ListPrivateipsRequest
        :type marker: str
        """
