...
class BindingVifDetails:
    ...
    def __init__(self, primary_interface=None, port_filter=None, ovs_hybrid_plug=None):
        ...
        :param primary_interface: The param of the BindingVifDetails
        :type primary_interface: bool
        :param port_filter: The param of the BindingVifDetails
        :type port_filter: bool
        :param ovs_hybrid_plug: The param of the BindingVifDetails
