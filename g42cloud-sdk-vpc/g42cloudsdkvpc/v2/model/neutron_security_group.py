...
class NeutronSecurityGroup:
    ...
    def __init__(self, description=None, id=None, name=None, security_group_rules=None, tenant_id=None, project_id=None, created_at=None, updated_at=None):
        ...
        :param description: The param of the NeutronSecurityGroup
        :type description: str
        :param id: The param of the NeutronSecurityGroup
        :type id: str
        :param name: The param of the NeutronSecurityGroup
        :type name: str
        :param security_group_rules: The param of the NeutronSecurityGroup
        :type security_group_rules: list[:class:`g42cloudsdkvpc.v2.NeutronSecurityGroupRule`]
        :param tenant_id: The param of the NeutronSecurityGroup
        :type tenant_id: str
        :param project_id: The param of the NeutronSecurityGroup
        :type project_id: str
        :param created_at: The param of the NeutronSecurityGroup
        :type created_at: datetime
        :param updated_at: The param of the NeutronSecurityGroup
    ...
    def security_group_rules(self):
        ...
        :rtype: list[:class:`g42cloudsdkvpc.v2.NeutronSecurityGroupRule`]
        """
