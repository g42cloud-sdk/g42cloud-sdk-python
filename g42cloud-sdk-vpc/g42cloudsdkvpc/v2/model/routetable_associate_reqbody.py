...
class RoutetableAssociateReqbody:
    ...
    def __init__(self, routetable=None):
        ...
        :param routetable: The param of the RoutetableAssociateReqbody
        :type routetable: :class:`g42cloudsdkvpc.v2.AsscoiateReq`
        """
    ...
    def routetable(self):
        ...
        :rtype: :class:`g42cloudsdkvpc.v2.AsscoiateReq`
        """
