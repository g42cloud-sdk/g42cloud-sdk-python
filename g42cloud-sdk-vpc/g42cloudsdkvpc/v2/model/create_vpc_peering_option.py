...
class CreateVpcPeeringOption:
    ...
    def __init__(self, name=None, request_vpc_info=None, accept_vpc_info=None):
        ...
        :param name: The param of the CreateVpcPeeringOption
        :type name: str
        :param request_vpc_info: The param of the CreateVpcPeeringOption
        :type request_vpc_info: :class:`g42cloudsdkvpc.v2.VpcInfo`
        :param accept_vpc_info: The param of the CreateVpcPeeringOption
