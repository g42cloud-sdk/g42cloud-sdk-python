...
class BatchCreateSubnetTagsRequest:
    ...
    def __init__(self, subnet_id=None, body=None):
        ...
        :param subnet_id: The param of the BatchCreateSubnetTagsRequest
        :type subnet_id: str
        :param body: The param of the BatchCreateSubnetTagsRequest
        :type body: :class:`g42cloudsdkvpc.v2.BatchCreateSubnetTagsRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkvpc.v2.BatchCreateSubnetTagsRequestBody`
        """
        return self._body
