...
class NeutronFirewallPolicy:
    ...
    def __init__(self, audited=None, description=None, firewall_rules=None, id=None, name=None, public=None, tenant_id=None, project_id=None):
        ...
        :param audited: The param of the NeutronFirewallPolicy
        :type audited: bool
        :param description: The param of the NeutronFirewallPolicy
        :type description: str
        :param firewall_rules: The param of the NeutronFirewallPolicy
        :type firewall_rules: list[str]
        :param id: The param of the NeutronFirewallPolicy
        :type id: str
        :param name: The param of the NeutronFirewallPolicy
        :type name: str
        :param public: The param of the NeutronFirewallPolicy
        :type public: bool
        :param tenant_id: The param of the NeutronFirewallPolicy
        :type tenant_id: str
        :param project_id: The param of the NeutronFirewallPolicy
        :type project_id: str
        """
