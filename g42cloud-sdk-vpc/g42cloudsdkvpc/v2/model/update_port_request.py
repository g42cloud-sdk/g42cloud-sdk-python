...
class UpdatePortRequest:
    ...
    def __init__(self, port_id=None, body=None):
        ...
        :param port_id: The param of the UpdatePortRequest
        :type port_id: str
        :param body: The param of the UpdatePortRequest
        :type body: :class:`g42cloudsdkvpc.v2.UpdatePortRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkvpc.v2.UpdatePortRequestBody`
        """
        return self._body
