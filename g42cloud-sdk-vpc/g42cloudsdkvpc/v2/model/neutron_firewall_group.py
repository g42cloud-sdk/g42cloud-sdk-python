...
class NeutronFirewallGroup:
    ...
    def __init__(self, id=None, name=None, description=None, admin_state_up=None, egress_firewall_policy_id=None, ingress_firewall_policy_id=None, ports=None, public=None, status=None, tenant_id=None, project_id=None, created_at=None, updated_at=None):
        ...
        :param id: The param of the NeutronFirewallGroup
        :type id: str
        :param name: The param of the NeutronFirewallGroup
        :type name: str
        :param description: The param of the NeutronFirewallGroup
        :type description: str
        :param admin_state_up: The param of the NeutronFirewallGroup
        :type admin_state_up: bool
        :param egress_firewall_policy_id: The param of the NeutronFirewallGroup
        :type egress_firewall_policy_id: str
        :param ingress_firewall_policy_id: The param of the NeutronFirewallGroup
        :type ingress_firewall_policy_id: str
        :param ports: The param of the NeutronFirewallGroup
        :type ports: list[str]
        :param public: The param of the NeutronFirewallGroup
        :type public: bool
        :param status: The param of the NeutronFirewallGroup
        :type status: str
        :param tenant_id: The param of the NeutronFirewallGroup
        :type tenant_id: str
        :param project_id: The param of the NeutronFirewallGroup
        :type project_id: str
        :param created_at: The param of the NeutronFirewallGroup
        :type created_at: datetime
        :param updated_at: The param of the NeutronFirewallGroup
