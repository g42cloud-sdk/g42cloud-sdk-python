...
class ListSubnetsByTagsRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the ListSubnetsByTagsRequest
        :type body: :class:`g42cloudsdkvpc.v2.ListSubnetsByTagsRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkvpc.v2.ListSubnetsByTagsRequestBody`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListSubnetsByTagsRequest):
            return False
