...
class CreateSubnetRequestBody:
    ...
    def __init__(self, subnet=None):
        ...
        :param subnet: The param of the CreateSubnetRequestBody
        :type subnet: :class:`g42cloudsdkvpc.v2.CreateSubnetOption`
        """
    ...
    def subnet(self):
        ...
        :rtype: :class:`g42cloudsdkvpc.v2.CreateSubnetOption`
        """
        return self._subnet
