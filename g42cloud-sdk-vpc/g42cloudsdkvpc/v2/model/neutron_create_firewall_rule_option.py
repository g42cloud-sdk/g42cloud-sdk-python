...
class NeutronCreateFirewallRuleOption:
    ...
    def __init__(self, name=None, description=None, protocol=None, action=None, ip_version=None, destination_ip_address=None, destination_port=None, source_ip_address=None, source_port=None, enabled=None):
        ...
        :param name: The param of the NeutronCreateFirewallRuleOption
        :type name: str
        :param description: The param of the NeutronCreateFirewallRuleOption
        :type description: str
        :param protocol: The param of the NeutronCreateFirewallRuleOption
        :type protocol: str
        :param action: The param of the NeutronCreateFirewallRuleOption
        :type action: str
        :param ip_version: The param of the NeutronCreateFirewallRuleOption
        :type ip_version: int
        :param destination_ip_address: The param of the NeutronCreateFirewallRuleOption
        :type destination_ip_address: str
        :param destination_port: The param of the NeutronCreateFirewallRuleOption
        :type destination_port: str
        :param source_ip_address: The param of the NeutronCreateFirewallRuleOption
        :type source_ip_address: str
        :param source_port: The param of the NeutronCreateFirewallRuleOption
        :type source_port: str
        :param enabled: The param of the NeutronCreateFirewallRuleOption
        :type enabled: bool
        """
