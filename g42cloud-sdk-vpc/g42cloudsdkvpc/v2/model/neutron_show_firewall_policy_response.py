...
class NeutronShowFirewallPolicyResponse(SdkResponse):
    ...
    def __init__(self, firewall_policy=None):
        ...
        :param firewall_policy: The param of the NeutronShowFirewallPolicyResponse
        :type firewall_policy: :class:`g42cloudsdkvpc.v2.NeutronFirewallPolicy`
        """
        
        super(NeutronShowFirewallPolicyResponse, self).__init__()
    ...
    def firewall_policy(self):
        ...
        :rtype: :class:`g42cloudsdkvpc.v2.NeutronFirewallPolicy`
        """
