...
class CreateVpcRouteOption:
    ...
    def __init__(self, destination=None, nexthop=None, type=None, vpc_id=None):
        ...
        :param destination: The param of the CreateVpcRouteOption
        :type destination: str
        :param nexthop: The param of the CreateVpcRouteOption
        :type nexthop: str
        :param type: The param of the CreateVpcRouteOption
        :type type: str
        :param vpc_id: The param of the CreateVpcRouteOption
        :type vpc_id: str
        """
