...
class NetworkIpAvailability:
    ...
    def __init__(self, network_id=None, network_name=None, tenant_id=None, total_ips=None, used_ips=None, subnet_ip_availability=None):
        ...
        :param network_id: The param of the NetworkIpAvailability
        :type network_id: str
        :param network_name: The param of the NetworkIpAvailability
        :type network_name: str
        :param tenant_id: The param of the NetworkIpAvailability
        :type tenant_id: str
        :param total_ips: The param of the NetworkIpAvailability
        :type total_ips: int
        :param used_ips: The param of the NetworkIpAvailability
        :type used_ips: int
        :param subnet_ip_availability: The param of the NetworkIpAvailability
        :type subnet_ip_availability: list[:class:`g42cloudsdkvpc.v2.SubnetIpAvailability`]
        """
    ...
    def subnet_ip_availability(self):
        ...
        :rtype: list[:class:`g42cloudsdkvpc.v2.SubnetIpAvailability`]
        """
