...
class ListVpcRoutesResponse(SdkResponse):
    ...
    def __init__(self, routes=None, routes_links=None):
        ...
        :param routes: The param of the ListVpcRoutesResponse
        :type routes: list[:class:`g42cloudsdkvpc.v2.VpcRoute`]
        :param routes_links: The param of the ListVpcRoutesResponse
        :type routes_links: list[:class:`g42cloudsdkvpc.v2.NeutronPageLink`]
        """
    ...
    def routes(self):
        ...
        :rtype: list[:class:`g42cloudsdkvpc.v2.VpcRoute`]
        """
        return self._routes
