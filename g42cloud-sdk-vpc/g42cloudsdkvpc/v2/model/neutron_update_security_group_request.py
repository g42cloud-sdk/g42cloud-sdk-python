...
class NeutronUpdateSecurityGroupRequest:
    ...
    def __init__(self, security_group_id=None, body=None):
        ...
        :param security_group_id: The param of the NeutronUpdateSecurityGroupRequest
        :type security_group_id: str
        :param body: The param of the NeutronUpdateSecurityGroupRequest
        :type body: :class:`g42cloudsdkvpc.v2.NeutronUpdateSecurityGroupRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkvpc.v2.NeutronUpdateSecurityGroupRequestBody`
        """
        return self._body
