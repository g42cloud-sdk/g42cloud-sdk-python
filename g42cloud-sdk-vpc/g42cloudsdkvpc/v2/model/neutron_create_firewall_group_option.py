...
class NeutronCreateFirewallGroupOption:
    ...
    def __init__(self, name=None, description=None, ingress_firewall_policy_id=None, egress_firewall_policy_id=None, ports=None, admin_state_up=None):
        ...
        :param name: The param of the NeutronCreateFirewallGroupOption
        :type name: str
        :param description: The param of the NeutronCreateFirewallGroupOption
        :type description: str
        :param ingress_firewall_policy_id: The param of the NeutronCreateFirewallGroupOption
        :type ingress_firewall_policy_id: str
        :param egress_firewall_policy_id: The param of the NeutronCreateFirewallGroupOption
        :type egress_firewall_policy_id: str
        :param ports: The param of the NeutronCreateFirewallGroupOption
        :type ports: list[str]
        :param admin_state_up: The param of the NeutronCreateFirewallGroupOption
