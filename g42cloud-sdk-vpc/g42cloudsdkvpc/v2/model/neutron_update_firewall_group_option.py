...
class NeutronUpdateFirewallGroupOption:
    ...
    def __init__(self, admin_state_up=None, description=None, egress_firewall_policy_id=None, ingress_firewall_policy_id=None, name=None, ports=None):
        ...
        :param admin_state_up: The param of the NeutronUpdateFirewallGroupOption
        :type admin_state_up: bool
        :param description: The param of the NeutronUpdateFirewallGroupOption
        :type description: str
        :param egress_firewall_policy_id: The param of the NeutronUpdateFirewallGroupOption
        :type egress_firewall_policy_id: str
        :param ingress_firewall_policy_id: The param of the NeutronUpdateFirewallGroupOption
        :type ingress_firewall_policy_id: str
        :param name: The param of the NeutronUpdateFirewallGroupOption
        :type name: str
        :param ports: The param of the NeutronUpdateFirewallGroupOption
        :type ports: list[str]
        """
