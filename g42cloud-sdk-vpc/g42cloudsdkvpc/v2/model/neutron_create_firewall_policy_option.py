...
class NeutronCreateFirewallPolicyOption:
    ...
    def __init__(self, audited=None, description=None, firewall_rules=None, name=None):
        ...
        :param audited: The param of the NeutronCreateFirewallPolicyOption
        :type audited: bool
        :param description: The param of the NeutronCreateFirewallPolicyOption
        :type description: str
        :param firewall_rules: The param of the NeutronCreateFirewallPolicyOption
        :type firewall_rules: list[str]
        :param name: The param of the NeutronCreateFirewallPolicyOption
        :type name: str
        """
