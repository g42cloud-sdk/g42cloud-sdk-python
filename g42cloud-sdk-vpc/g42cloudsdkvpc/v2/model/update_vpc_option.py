...
class UpdateVpcOption:
    ...
    def __init__(self, name=None, description=None, cidr=None, routes=None):
        ...
        :param name: The param of the UpdateVpcOption
        :type name: str
        :param description: The param of the UpdateVpcOption
        :type description: str
        :param cidr: The param of the UpdateVpcOption
        :type cidr: str
        :param routes: The param of the UpdateVpcOption
