...
class RejectVpcPeeringResponse(SdkResponse):
    ...
    def __init__(self, id=None, name=None, status=None, request_vpc_info=None, accept_vpc_info=None, created_at=None, updated_at=None, description=None):
        ...
        :param id: The param of the RejectVpcPeeringResponse
        :type id: str
        :param name: The param of the RejectVpcPeeringResponse
        :type name: str
        :param status: The param of the RejectVpcPeeringResponse
        :type status: str
        :param request_vpc_info: The param of the RejectVpcPeeringResponse
        :type request_vpc_info: :class:`g42cloudsdkvpc.v2.VpcInfo`
        :param accept_vpc_info: The param of the RejectVpcPeeringResponse
        :type accept_vpc_info: :class:`g42cloudsdkvpc.v2.VpcInfo`
        :param created_at: The param of the RejectVpcPeeringResponse
        :type created_at: datetime
        :param updated_at: The param of the RejectVpcPeeringResponse
        :type updated_at: datetime
        :param description: The param of the RejectVpcPeeringResponse
    ...
    @property
    def id(self):
        """Gets the id of this RejectVpcPeeringResponse.
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this RejectVpcPeeringResponse.
    ...
    @property
    def name(self):
        """Gets the name of this RejectVpcPeeringResponse.
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this RejectVpcPeeringResponse.
    ...
    @property
    def status(self):
        """Gets the status of this RejectVpcPeeringResponse.
    ...
    def status(self, status):
        """Sets the status of this RejectVpcPeeringResponse.
    ...
    def request_vpc_info(self):
        """Gets the request_vpc_info of this RejectVpcPeeringResponse.
    ...
    def request_vpc_info(self, request_vpc_info):
        """Sets the request_vpc_info of this RejectVpcPeeringResponse.
    ...
    def accept_vpc_info(self):
        """Gets the accept_vpc_info of this RejectVpcPeeringResponse.
    ...
    def accept_vpc_info(self, accept_vpc_info):
        """Sets the accept_vpc_info of this RejectVpcPeeringResponse.
    ...
    @property
    def created_at(self):
        """Gets the created_at of this RejectVpcPeeringResponse.
    ...
    def created_at(self, created_at):
        """Sets the created_at of this RejectVpcPeeringResponse.
    ...
    @property
    def updated_at(self):
        """Gets the updated_at of this RejectVpcPeeringResponse.
    ...
    def updated_at(self, updated_at):
        """Sets the updated_at of this RejectVpcPeeringResponse.
    ...
    def description(self):
        """Gets the description of this RejectVpcPeeringResponse.
    ...
    def description(self, description):
        """Sets the description of this RejectVpcPeeringResponse.
