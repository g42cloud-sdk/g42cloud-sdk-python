...
class NeutronUpdateFirewallRuleOption:
    ...
    def __init__(self, action=None, description=None, destination_ip_address=None, destination_port=None, enabled=None, ip_version=None, name=None, protocol=None, source_ip_address=None, source_port=None):
        ...
        :param action: The param of the NeutronUpdateFirewallRuleOption
        :type action: str
        :param description: The param of the NeutronUpdateFirewallRuleOption
        :type description: str
        :param destination_ip_address: The param of the NeutronUpdateFirewallRuleOption
        :type destination_ip_address: str
        :param destination_port: The param of the NeutronUpdateFirewallRuleOption
        :type destination_port: str
        :param enabled: The param of the NeutronUpdateFirewallRuleOption
        :type enabled: bool
        :param ip_version: The param of the NeutronUpdateFirewallRuleOption
        :type ip_version: int
        :param name: The param of the NeutronUpdateFirewallRuleOption
        :type name: str
        :param protocol: The param of the NeutronUpdateFirewallRuleOption
        :type protocol: str
        :param source_ip_address: The param of the NeutronUpdateFirewallRuleOption
        :type source_ip_address: str
        :param source_port: The param of the NeutronUpdateFirewallRuleOption
