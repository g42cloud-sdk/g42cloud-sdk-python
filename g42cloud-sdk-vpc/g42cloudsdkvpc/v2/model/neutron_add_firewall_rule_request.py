...
class NeutronAddFirewallRuleRequest:
    ...
    def __init__(self, firewall_policy_id=None, body=None):
        ...
        :param firewall_policy_id: The param of the NeutronAddFirewallRuleRequest
        :type firewall_policy_id: str
        :param body: The param of the NeutronAddFirewallRuleRequest
        :type body: :class:`g42cloudsdkvpc.v2.NeutronInsertFirewallRuleRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkvpc.v2.NeutronInsertFirewallRuleRequestBody`
        """
        return self._body
