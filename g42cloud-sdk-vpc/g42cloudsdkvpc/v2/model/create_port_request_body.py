...
class CreatePortRequestBody:
    ...
    def __init__(self, port=None):
        ...
        :param port: The param of the CreatePortRequestBody
        :type port: :class:`g42cloudsdkvpc.v2.CreatePortOption`
        """
    ...
    def port(self):
        ...
        :rtype: :class:`g42cloudsdkvpc.v2.CreatePortOption`
        """
        return self._port
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreatePortRequestBody):
            return False
