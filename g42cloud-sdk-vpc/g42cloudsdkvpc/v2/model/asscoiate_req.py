...
class AsscoiateReq:
    ...
    def __init__(self, subnets=None):
        ...
        :param subnets: The param of the AsscoiateReq
        :type subnets: :class:`g42cloudsdkvpc.v2.AssociateRouteTableAndSubnetReq`
        """
    ...
    def subnets(self):
        ...
        :rtype: :class:`g42cloudsdkvpc.v2.AssociateRouteTableAndSubnetReq`
        """
