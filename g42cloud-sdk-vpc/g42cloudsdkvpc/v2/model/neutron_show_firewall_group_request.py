...
class NeutronShowFirewallGroupRequest:
    ...
    def __init__(self, firewall_group_id=None):
        ...
        :param firewall_group_id: The param of the NeutronShowFirewallGroupRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NeutronShowFirewallGroupRequest):
            return False
