...
class UpdateRouteTableRequest:
    ...
    def __init__(self, routetable_id=None, body=None):
        ...
        :param routetable_id: The param of the UpdateRouteTableRequest
        :type routetable_id: str
        :param body: The param of the UpdateRouteTableRequest
        :type body: :class:`g42cloudsdkvpc.v2.UpdateRoutetableReqBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkvpc.v2.UpdateRoutetableReqBody`
        """
        return self._body
