...
class CreatePrivateipRequestBody:
    ...
    def __init__(self, privateips=None):
        ...
        :param privateips: The param of the CreatePrivateipRequestBody
        :type privateips: list[:class:`g42cloudsdkvpc.v2.CreatePrivateipOption`]
        """
    ...
    def privateips(self):
        ...
        :rtype: list[:class:`g42cloudsdkvpc.v2.CreatePrivateipOption`]
        """
