...
class NeutronInsertFirewallRuleRequestBody:
    ...
    def __init__(self, firewall_rule_id=None, insert_after=None, insert_before=None):
        ...
        :param firewall_rule_id: The param of the NeutronInsertFirewallRuleRequestBody
        :type firewall_rule_id: str
        :param insert_after: The param of the NeutronInsertFirewallRuleRequestBody
        :type insert_after: str
        :param insert_before: The param of the NeutronInsertFirewallRuleRequestBody
