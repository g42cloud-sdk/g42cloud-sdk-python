...
class ListPortsRequest:
    ...
    def __init__(self, name=None, id=None, limit=None, admin_state_up=None, network_id=None, mac_address=None, device_id=None, device_owner=None, status=None, marker=None, fixed_ips=None, enterprise_project_id=None):
        ...
        :param name: The param of the ListPortsRequest
        :type name: str
        :param id: The param of the ListPortsRequest
        :type id: str
        :param limit: The param of the ListPortsRequest
        :type limit: int
        :param admin_state_up: The param of the ListPortsRequest
        :type admin_state_up: bool
        :param network_id: The param of the ListPortsRequest
        :type network_id: str
        :param mac_address: The param of the ListPortsRequest
        :type mac_address: str
        :param device_id: The param of the ListPortsRequest
        :type device_id: str
        :param device_owner: The param of the ListPortsRequest
        :type device_owner: str
        :param status: The param of the ListPortsRequest
        :type status: str
        :param marker: The param of the ListPortsRequest
        :type marker: str
        :param fixed_ips: The param of the ListPortsRequest
        :type fixed_ips: str
        :param enterprise_project_id: The param of the ListPortsRequest
