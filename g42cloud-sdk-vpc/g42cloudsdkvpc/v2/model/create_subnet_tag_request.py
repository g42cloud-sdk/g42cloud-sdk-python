...
class CreateSubnetTagRequest:
    ...
    def __init__(self, subnet_id=None, body=None):
        ...
        :param subnet_id: The param of the CreateSubnetTagRequest
        :type subnet_id: str
        :param body: The param of the CreateSubnetTagRequest
        :type body: :class:`g42cloudsdkvpc.v2.CreateSubnetTagRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkvpc.v2.CreateSubnetTagRequestBody`
        """
        return self._body
