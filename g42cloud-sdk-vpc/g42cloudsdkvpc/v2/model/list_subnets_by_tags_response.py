...
class ListSubnetsByTagsResponse(SdkResponse):
    ...
    def __init__(self, resources=None, total_count=None):
        ...
        :param resources: The param of the ListSubnetsByTagsResponse
        :type resources: list[:class:`g42cloudsdkvpc.v2.ListResourceResp`]
        :param total_count: The param of the ListSubnetsByTagsResponse
    ...
    def resources(self):
        ...
        :rtype: list[:class:`g42cloudsdkvpc.v2.ListResourceResp`]
        """
