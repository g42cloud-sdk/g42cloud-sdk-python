...
class NeutronListFirewallPoliciesResponse(SdkResponse):
    ...
    def __init__(self, firewall_policies=None, firewall_policies_links=None):
        ...
        :param firewall_policies: The param of the NeutronListFirewallPoliciesResponse
        :type firewall_policies: list[:class:`g42cloudsdkvpc.v2.NeutronFirewallPolicy`]
        :param firewall_policies_links: The param of the NeutronListFirewallPoliciesResponse
        :type firewall_policies_links: list[:class:`g42cloudsdkvpc.v2.NeutronPageLink`]
        """
    ...
    def firewall_policies(self):
        ...
        :rtype: list[:class:`g42cloudsdkvpc.v2.NeutronFirewallPolicy`]
        """
