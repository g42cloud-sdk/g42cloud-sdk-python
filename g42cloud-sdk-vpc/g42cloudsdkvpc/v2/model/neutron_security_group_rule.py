...
class NeutronSecurityGroupRule:
    ...
    def __init__(self, description=None, direction=None, ethertype=None, id=None, port_range_max=None, port_range_min=None, protocol=None, remote_group_id=None, remote_ip_prefix=None, remote_address_group_id=None, security_group_id=None, tenant_id=None, project_id=None, created_at=None, updated_at=None):
        ...
        :param description: The param of the NeutronSecurityGroupRule
        :type description: str
        :param direction: The param of the NeutronSecurityGroupRule
        :type direction: str
        :param ethertype: The param of the NeutronSecurityGroupRule
        :type ethertype: str
        :param id: The param of the NeutronSecurityGroupRule
        :type id: str
        :param port_range_max: The param of the NeutronSecurityGroupRule
        :type port_range_max: int
        :param port_range_min: The param of the NeutronSecurityGroupRule
        :type port_range_min: int
        :param protocol: The param of the NeutronSecurityGroupRule
        :type protocol: str
        :param remote_group_id: The param of the NeutronSecurityGroupRule
        :type remote_group_id: str
        :param remote_ip_prefix: The param of the NeutronSecurityGroupRule
        :type remote_ip_prefix: str
        :param remote_address_group_id: The param of the NeutronSecurityGroupRule
        :type remote_address_group_id: str
        :param security_group_id: The param of the NeutronSecurityGroupRule
        :type security_group_id: str
        :param tenant_id: The param of the NeutronSecurityGroupRule
        :type tenant_id: str
        :param project_id: The param of the NeutronSecurityGroupRule
        :type project_id: str
        :param created_at: The param of the NeutronSecurityGroupRule
        :type created_at: datetime
        :param updated_at: The param of the NeutronSecurityGroupRule
