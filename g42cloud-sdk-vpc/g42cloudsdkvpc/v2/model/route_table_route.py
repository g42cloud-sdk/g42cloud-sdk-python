...
class RouteTableRoute:
    ...
    def __init__(self, type=None, destination=None, nexthop=None, description=None):
        ...
        :param type: The param of the RouteTableRoute
        :type type: str
        :param destination: The param of the RouteTableRoute
        :type destination: str
        :param nexthop: The param of the RouteTableRoute
        :type nexthop: str
        :param description: The param of the RouteTableRoute
