...
class UpdateVpcRequest:
    ...
    def __init__(self, vpc_id=None, body=None):
        ...
        :param vpc_id: The param of the UpdateVpcRequest
        :type vpc_id: str
        :param body: The param of the UpdateVpcRequest
        :type body: :class:`g42cloudsdkvpc.v2.UpdateVpcRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkvpc.v2.UpdateVpcRequestBody`
        """
        return self._body
