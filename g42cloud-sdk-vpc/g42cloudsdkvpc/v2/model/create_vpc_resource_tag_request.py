...
class CreateVpcResourceTagRequest:
    ...
    openapi_types = {
        'vpc_id': 'str',
        'body': 'CreateVpcResourceTagRequestBody'
    }
    ...
    def __init__(self, vpc_id=None, body=None):
        ...
        :param vpc_id: The param of the CreateVpcResourceTagRequest
        :type vpc_id: str
        :param body: The param of the CreateVpcResourceTagRequest
        :type body: :class:`g42cloudsdkvpc.v2.CreateVpcResourceTagRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkvpc.v2.CreateVpcResourceTagRequestBody`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateVpcResourceTagRequest):
            return False
