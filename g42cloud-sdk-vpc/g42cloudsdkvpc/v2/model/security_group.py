...
class SecurityGroup:
    ...
    def __init__(self, name=None, description=None, id=None, vpc_id=None, enterprise_project_id=None, security_group_rules=None):
        ...
        :type id: str
        :param vpc_id: The param of the SecurityGroup
        :type vpc_id: str
        :param enterprise_project_id: The param of the SecurityGroup
        :type enterprise_project_id: str
        :param security_group_rules: The param of the SecurityGroup
        :type security_group_rules: list[:class:`g42cloudsdkvpc.v2.SecurityGroupRule`]
        """
    ...
    def security_group_rules(self):
        ...
        :rtype: list[:class:`g42cloudsdkvpc.v2.SecurityGroupRule`]
        """
