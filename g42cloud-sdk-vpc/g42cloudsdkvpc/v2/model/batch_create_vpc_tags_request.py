...
class BatchCreateVpcTagsRequest:
    ...
    def __init__(self, vpc_id=None, body=None):
        ...
        :param vpc_id: The param of the BatchCreateVpcTagsRequest
        :type vpc_id: str
        :param body: The param of the BatchCreateVpcTagsRequest
        :type body: :class:`g42cloudsdkvpc.v2.BatchCreateVpcTagsRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkvpc.v2.BatchCreateVpcTagsRequestBody`
        """
        return self._body
