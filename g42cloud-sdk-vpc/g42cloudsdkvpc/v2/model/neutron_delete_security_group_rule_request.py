...
class NeutronDeleteSecurityGroupRuleRequest:
    ...
    def __init__(self, security_group_rule_id=None):
        ...
        :param security_group_rule_id: The param of the NeutronDeleteSecurityGroupRuleRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NeutronDeleteSecurityGroupRuleRequest):
            return False
