...
class NeutronListSecurityGroupsResponse(SdkResponse):
    ...
    def __init__(self, security_groups=None, security_groups_links=None):
        ...
        :param security_groups: The param of the NeutronListSecurityGroupsResponse
        :type security_groups: list[:class:`g42cloudsdkvpc.v2.NeutronSecurityGroup`]
        :param security_groups_links: The param of the NeutronListSecurityGroupsResponse
        :type security_groups_links: list[:class:`g42cloudsdkvpc.v2.NeutronPageLink`]
        """
    ...
    def security_groups(self):
        ...
        :rtype: list[:class:`g42cloudsdkvpc.v2.NeutronSecurityGroup`]
        """
