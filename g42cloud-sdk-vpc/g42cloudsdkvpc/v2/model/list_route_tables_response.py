...
class ListRouteTablesResponse(SdkResponse):
    ...
    def __init__(self, routetables=None):
        ...
        :param routetables: The param of the ListRouteTablesResponse
        :type routetables: list[:class:`g42cloudsdkvpc.v2.RouteTableListResp`]
        """
    ...
    def routetables(self):
        ...
        :rtype: list[:class:`g42cloudsdkvpc.v2.RouteTableListResp`]
        """
