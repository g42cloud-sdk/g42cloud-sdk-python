...
class NeutronUpdateFirewallRuleRequest:
    ...
    def __init__(self, firewall_rule_id=None, body=None):
        ...
        :param firewall_rule_id: The param of the NeutronUpdateFirewallRuleRequest
        :type firewall_rule_id: str
        :param body: The param of the NeutronUpdateFirewallRuleRequest
        :type body: :class:`g42cloudsdkvpc.v2.NeutronUpdateFirewallRuleRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkvpc.v2.NeutronUpdateFirewallRuleRequestBody`
        """
        return self._body
