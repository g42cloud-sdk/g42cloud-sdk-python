...
class ListVpcRoutesRequest:
    ...
    def __init__(self, limit=None, marker=None, id=None, type=None, vpc_id=None, destination=None, tenant_id=None):
        ...
        :param limit: The param of the ListVpcRoutesRequest
        :type limit: int
        :param marker: The param of the ListVpcRoutesRequest
        :type marker: str
        :param id: The param of the ListVpcRoutesRequest
        :type id: str
        :param type: The param of the ListVpcRoutesRequest
        :type type: str
        :param vpc_id: The param of the ListVpcRoutesRequest
        :type vpc_id: str
        :param destination: The param of the ListVpcRoutesRequest
        :type destination: str
        :param tenant_id: The param of the ListVpcRoutesRequest
        :type tenant_id: str
        """
