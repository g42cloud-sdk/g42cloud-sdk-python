...
class NeutronUpdateFirewallGroupRequest:
    ...
    def __init__(self, firewall_group_id=None, body=None):
        ...
        :param firewall_group_id: The param of the NeutronUpdateFirewallGroupRequest
        :type firewall_group_id: str
        :param body: The param of the NeutronUpdateFirewallGroupRequest
        :type body: :class:`g42cloudsdkvpc.v2.NeutronUpdateFirewallGroupRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkvpc.v2.NeutronUpdateFirewallGroupRequestBody`
        """
        return self._body
