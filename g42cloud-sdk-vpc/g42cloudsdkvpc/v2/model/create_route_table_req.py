...
class CreateRouteTableReq:
    ...
    def __init__(self, name=None, routes=None, vpc_id=None, description=None):
        ...
        :param name: The param of the CreateRouteTableReq
        :type name: str
        :param routes: The param of the CreateRouteTableReq
        :type routes: list[:class:`g42cloudsdkvpc.v2.RouteTableRoute`]
        :param vpc_id: The param of the CreateRouteTableReq
        :type vpc_id: str
        :param description: The param of the CreateRouteTableReq
