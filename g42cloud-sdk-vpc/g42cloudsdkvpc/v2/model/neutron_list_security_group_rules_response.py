...
class NeutronListSecurityGroupRulesResponse(SdkResponse):
    ...
    def __init__(self, security_group_rules=None, security_group_rules_links=None):
        ...
        :param security_group_rules: The param of the NeutronListSecurityGroupRulesResponse
        :type security_group_rules: list[:class:`g42cloudsdkvpc.v2.NeutronSecurityGroupRule`]
        :param security_group_rules_links: The param of the NeutronListSecurityGroupRulesResponse
        :type security_group_rules_links: list[:class:`g42cloudsdkvpc.v2.NeutronPageLink`]
        """
