...
class NeutronRemoveFirewallRuleRequest:
    ...
    def __init__(self, firewall_policy_id=None, body=None):
        ...
        :param firewall_policy_id: The param of the NeutronRemoveFirewallRuleRequest
        :type firewall_policy_id: str
        :param body: The param of the NeutronRemoveFirewallRuleRequest
        :type body: :class:`g42cloudsdkvpc.v2.NeutronRemoveFirewallRuleRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkvpc.v2.NeutronRemoveFirewallRuleRequestBody`
        """
        return self._body
