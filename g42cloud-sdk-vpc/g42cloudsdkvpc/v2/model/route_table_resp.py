...
class RouteTableResp:
    ...
    def __init__(self, id=None, name=None, default=None, routes=None, subnets=None, tenant_id=None, vpc_id=None, description=None):
        ...
        :param id: The param of the RouteTableResp
        :type id: str
        :param name: The param of the RouteTableResp
        :type name: str
        :param default: The param of the RouteTableResp
        :type default: bool
        :param routes: The param of the RouteTableResp
        :type routes: list[:class:`g42cloudsdkvpc.v2.RouteTableRoute`]
        :param subnets: The param of the RouteTableResp
        :type subnets: list[:class:`g42cloudsdkvpc.v2.SubnetList`]
        :param tenant_id: The param of the RouteTableResp
        :type tenant_id: str
        :param vpc_id: The param of the RouteTableResp
        :type vpc_id: str
        :param description: The param of the RouteTableResp
    ...
    def routes(self):
        ...
        :rtype: list[:class:`g42cloudsdkvpc.v2.RouteTableRoute`]
        """
        return self._routes
