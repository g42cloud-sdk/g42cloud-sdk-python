...
class NeutronListFirewallRulesResponse(SdkResponse):
    ...
    def __init__(self, firewall_rules=None, firewall_rules_links=None):
        ...
        :param firewall_rules: The param of the NeutronListFirewallRulesResponse
        :type firewall_rules: list[:class:`g42cloudsdkvpc.v2.NeutronFirewallRule`]
        :param firewall_rules_links: The param of the NeutronListFirewallRulesResponse
        :type firewall_rules_links: list[:class:`g42cloudsdkvpc.v2.NeutronPageLink`]
        """
    ...
    def firewall_rules(self):
        ...
        :rtype: list[:class:`g42cloudsdkvpc.v2.NeutronFirewallRule`]
        """
