...
class NeutronListFirewallPoliciesRequest:
    ...
    def __init__(self, limit=None, marker=None, id=None, name=None, description=None, tenant_id=None):
        ...
        :param limit: The param of the NeutronListFirewallPoliciesRequest
        :type limit: int
        :param marker: The param of the NeutronListFirewallPoliciesRequest
        :type marker: str
        :param id: The param of the NeutronListFirewallPoliciesRequest
        :type id: list[str]
        :param name: The param of the NeutronListFirewallPoliciesRequest
        :type name: list[str]
        :param description: The param of the NeutronListFirewallPoliciesRequest
        :type description: list[str]
        :param tenant_id: The param of the NeutronListFirewallPoliciesRequest
        :type tenant_id: str
        """
