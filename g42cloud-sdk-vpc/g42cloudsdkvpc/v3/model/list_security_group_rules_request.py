...
class ListSecurityGroupRulesRequest:
    ...
    def __init__(self, limit=None, marker=None, id=None, security_group_id=None, protocol=None, description=None, remote_group_id=None, direction=None, action=None):
        ...
        :param limit: The param of the ListSecurityGroupRulesRequest
        :type limit: int
        :param marker: The param of the ListSecurityGroupRulesRequest
        :type marker: str
        :param id: The param of the ListSecurityGroupRulesRequest
        :type id: list[str]
        :param security_group_id: The param of the ListSecurityGroupRulesRequest
        :type security_group_id: list[str]
        :param protocol: The param of the ListSecurityGroupRulesRequest
        :type protocol: list[str]
        :param description: The param of the ListSecurityGroupRulesRequest
        :type description: list[str]
        :param remote_group_id: The param of the ListSecurityGroupRulesRequest
        :type remote_group_id: list[str]
        :param direction: The param of the ListSecurityGroupRulesRequest
        :type direction: str
        :param action: The param of the ListSecurityGroupRulesRequest
        :type action: str
        """
