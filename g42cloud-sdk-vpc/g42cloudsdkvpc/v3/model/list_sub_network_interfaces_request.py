...
class ListSubNetworkInterfacesRequest:
    ...
    def __init__(self, limit=None, marker=None, id=None, virsubnet_id=None, private_ip_address=None, mac_address=None, vpc_id=None, description=None, parent_id=None):
        ...
        :param limit: The param of the ListSubNetworkInterfacesRequest
        :type limit: int
        :param marker: The param of the ListSubNetworkInterfacesRequest
        :type marker: str
        :param id: The param of the ListSubNetworkInterfacesRequest
        :type id: list[str]
        :param virsubnet_id: The param of the ListSubNetworkInterfacesRequest
        :type virsubnet_id: list[str]
        :param private_ip_address: The param of the ListSubNetworkInterfacesRequest
        :type private_ip_address: list[str]
        :param mac_address: The param of the ListSubNetworkInterfacesRequest
        :type mac_address: list[str]
        :param vpc_id: The param of the ListSubNetworkInterfacesRequest
        :type vpc_id: list[str]
        :param description: The param of the ListSubNetworkInterfacesRequest
        :type description: list[str]
        :param parent_id: The param of the ListSubNetworkInterfacesRequest
