...
class ListSecurityGroupsRequest:
    ...
    def __init__(self, limit=None, marker=None, id=None, name=None, description=None, enterprise_project_id=None):
        ...
        :param limit: The param of the ListSecurityGroupsRequest
        :type limit: int
        :param marker: The param of the ListSecurityGroupsRequest
        :type marker: str
        :param id: The param of the ListSecurityGroupsRequest
        :type id: list[str]
        :param name: The param of the ListSecurityGroupsRequest
        :type name: list[str]
        :param description: The param of the ListSecurityGroupsRequest
        :type description: list[str]
        :param enterprise_project_id: The param of the ListSecurityGroupsRequest
