...
class UpdateVpcResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, error_msg=None, error_code=None):
        ...
        :param request_id: The param of the UpdateVpcResponse
        :type request_id: str
        :param error_msg: The param of the UpdateVpcResponse
        :type error_msg: str
        :param error_code: The param of the UpdateVpcResponse
        :type error_code: str
        """
