...
class ShowSubNetworkInterfacesQuantityResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, sub_network_interfaces=None):
        ...
        :param request_id: The param of the ShowSubNetworkInterfacesQuantityResponse
        :type request_id: str
        :param sub_network_interfaces: The param of the ShowSubNetworkInterfacesQuantityResponse
    ...
    @property
    def request_id(self):
        """Gets the request_id of this ShowSubNetworkInterfacesQuantityResponse.

        :return: The request_id of this ShowSubNetworkInterfacesQuantityResponse.
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        """Sets the request_id of this ShowSubNetworkInterfacesQuantityResponse.
    ...
    def sub_network_interfaces(self):
        """Gets the sub_network_interfaces of this ShowSubNetworkInterfacesQuantityResponse.

        :return: The sub_network_interfaces of this ShowSubNetworkInterfacesQuantityResponse.
        :rtype: int
        """
    ...
    def sub_network_interfaces(self, sub_network_interfaces):
        """Sets the sub_network_interfaces of this ShowSubNetworkInterfacesQuantityResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowSubNetworkInterfacesQuantityResponse):
            return False
