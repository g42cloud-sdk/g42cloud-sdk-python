...
class ListVpcsResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, vpcs=None, page_info=None):
        ...
        :param request_id: The param of the ListVpcsResponse
        :type request_id: str
        :param vpcs: The param of the ListVpcsResponse
        :type vpcs: list[:class:`g42cloudsdkvpc.v3.Vpc`]
        :param page_info: The param of the ListVpcsResponse
    ...
    def vpcs(self):
        ...
        :rtype: list[:class:`g42cloudsdkvpc.v3.Vpc`]
        """
        return self._vpcs
