...
class BatchCreateSubNetworkInterfaceResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, sub_network_interfaces=None):
        ...
        :param request_id: The param of the BatchCreateSubNetworkInterfaceResponse
        :type request_id: str
        :param sub_network_interfaces: The param of the BatchCreateSubNetworkInterfaceResponse
