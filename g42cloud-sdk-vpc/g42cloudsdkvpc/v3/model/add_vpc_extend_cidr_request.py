...
class AddVpcExtendCidrRequest:
    ...
    def __init__(self, vpc_id=None, body=None):
        ...
        :param vpc_id: The param of the AddVpcExtendCidrRequest
        :type vpc_id: str
        :param body: The param of the AddVpcExtendCidrRequest
        :type body: :class:`g42cloudsdkvpc.v3.AddVpcExtendCidrRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkvpc.v3.AddVpcExtendCidrRequestBody`
        """
        return self._body
