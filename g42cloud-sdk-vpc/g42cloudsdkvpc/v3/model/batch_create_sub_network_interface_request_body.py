...
class BatchCreateSubNetworkInterfaceRequestBody:
    ...
    def __init__(self, dry_run=None, sub_network_interface=None, count=None):
        ...
        :param dry_run: The param of the BatchCreateSubNetworkInterfaceRequestBody
        :type dry_run: bool
        :param sub_network_interface: The param of the BatchCreateSubNetworkInterfaceRequestBody
        :type sub_network_interface: :class:`g42cloudsdkvpc.v3.BatchCreateSubNetworkInterfaceOption`
        :param count: The param of the BatchCreateSubNetworkInterfaceRequestBody
        :type count: int
        """
    ...
    def sub_network_interface(self):
        ...
        :rtype: :class:`g42cloudsdkvpc.v3.BatchCreateSubNetworkInterfaceOption`
        """
