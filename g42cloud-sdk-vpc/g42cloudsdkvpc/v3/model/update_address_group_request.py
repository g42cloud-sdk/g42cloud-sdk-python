...
class UpdateAddressGroupRequest:
    ...
    def __init__(self, address_group_id=None, body=None):
        ...
        :param address_group_id: The param of the UpdateAddressGroupRequest
        :type address_group_id: str
        :param body: The param of the UpdateAddressGroupRequest
        :type body: :class:`g42cloudsdkvpc.v3.UpdateAddressGroupRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkvpc.v3.UpdateAddressGroupRequestBody`
        """
        return self._body
