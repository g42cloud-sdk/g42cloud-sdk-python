...
class UpdateSubNetworkInterfaceRequest:
    ...
    def __init__(self, sub_network_interface_id=None, body=None):
        ...
        :param sub_network_interface_id: The param of the UpdateSubNetworkInterfaceRequest
        :type sub_network_interface_id: str
        :param body: The param of the UpdateSubNetworkInterfaceRequest
        :type body: :class:`g42cloudsdkvpc.v3.UpdateSubNetworkInterfaceRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkvpc.v3.UpdateSubNetworkInterfaceRequestBody`
        """
        return self._body
