...
class RemoveVpcExtendCidrRequest:
    ...
    def __init__(self, vpc_id=None, body=None):
        ...
        :param vpc_id: The param of the RemoveVpcExtendCidrRequest
        :type vpc_id: str
        :param body: The param of the RemoveVpcExtendCidrRequest
        :type body: :class:`g42cloudsdkvpc.v3.RemoveVpcExtendCidrRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkvpc.v3.RemoveVpcExtendCidrRequestBody`
        """
        return self._body
