...
class CreateSecurityGroupResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, security_group=None):
        ...
        :param request_id: The param of the CreateSecurityGroupResponse
        :type request_id: str
        :param security_group: The param of the CreateSecurityGroupResponse
        :type security_group: :class:`g42cloudsdkvpc.v3.SecurityGroupInfo`
        """
    ...
    def security_group(self):
        ...
        :rtype: :class:`g42cloudsdkvpc.v3.SecurityGroupInfo`
        """
