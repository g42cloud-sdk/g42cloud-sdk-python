...
class ListSecurityGroupRulesResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, security_group_rules=None, page_info=None):
        ...
        :param request_id: The param of the ListSecurityGroupRulesResponse
        :type request_id: str
        :param security_group_rules: The param of the ListSecurityGroupRulesResponse
        :type security_group_rules: list[:class:`g42cloudsdkvpc.v3.SecurityGroupRule`]
        :param page_info: The param of the ListSecurityGroupRulesResponse
