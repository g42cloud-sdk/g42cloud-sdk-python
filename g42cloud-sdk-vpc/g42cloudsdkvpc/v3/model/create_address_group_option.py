...
class CreateAddressGroupOption:
    ...
    def __init__(self, name=None, description=None, ip_version=None, ip_set=None):
        ...
        :param name: The param of the CreateAddressGroupOption
        :type name: str
        :param description: The param of the CreateAddressGroupOption
        :type description: str
        :param ip_version: The param of the CreateAddressGroupOption
        :type ip_version: int
        :param ip_set: The param of the CreateAddressGroupOption
