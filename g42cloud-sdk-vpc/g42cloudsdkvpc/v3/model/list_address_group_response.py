...
class ListAddressGroupResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, address_groups=None, page_info=None):
        ...
        :param request_id: The param of the ListAddressGroupResponse
        :type request_id: str
        :param address_groups: The param of the ListAddressGroupResponse
        :type address_groups: list[:class:`g42cloudsdkvpc.v3.AddressGroup`]
        :param page_info: The param of the ListAddressGroupResponse
    ...
    def address_groups(self):
        ...
        :rtype: list[:class:`g42cloudsdkvpc.v3.AddressGroup`]
        """
