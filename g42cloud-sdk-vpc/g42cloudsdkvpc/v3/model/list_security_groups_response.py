...
class ListSecurityGroupsResponse(SdkResponse):
    ...
    def __init__(self, security_groups=None, request_id=None, page_info=None):
        ...
        :param security_groups: The param of the ListSecurityGroupsResponse
        :type security_groups: list[:class:`g42cloudsdkvpc.v3.SecurityGroup`]
        :param request_id: The param of the ListSecurityGroupsResponse
        :type request_id: str
        :param page_info: The param of the ListSecurityGroupsResponse
    ...
    def security_groups(self):
        ...
        :rtype: list[:class:`g42cloudsdkvpc.v3.SecurityGroup`]
        """
