...
class ListSubNetworkInterfacesResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, sub_network_interfaces=None, page_info=None):
        ...
        :param request_id: The param of the ListSubNetworkInterfacesResponse
        :type request_id: str
        :param sub_network_interfaces: The param of the ListSubNetworkInterfacesResponse
        :type sub_network_interfaces: list[:class:`g42cloudsdkvpc.v3.SubNetworkInterface`]
        :param page_info: The param of the ListSubNetworkInterfacesResponse
        :type page_info: :class:`g42cloudsdkvpc.v3.PageInfo`
        """
    ...
    def sub_network_interfaces(self):
        ...
        :rtype: list[:class:`g42cloudsdkvpc.v3.SubNetworkInterface`]
        """
    ...
    def page_info(self):
        ...
        :rtype: :class:`g42cloudsdkvpc.v3.PageInfo`
        """
