...
class UpdateSecurityGroupRequest:
    ...
    def __init__(self, security_group_id=None, body=None):
        ...
        :param security_group_id: The param of the UpdateSecurityGroupRequest
        :type security_group_id: str
        :param body: The param of the UpdateSecurityGroupRequest
        :type body: :class:`g42cloudsdkvpc.v3.UpdateSecurityGroupRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkvpc.v3.UpdateSecurityGroupRequestBody`
        """
        return self._body
