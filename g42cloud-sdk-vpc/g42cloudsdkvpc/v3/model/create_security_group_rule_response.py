...
class CreateSecurityGroupRuleResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, security_group_rule=None):
        ...
        :param request_id: The param of the CreateSecurityGroupRuleResponse
        :type request_id: str
        :param security_group_rule: The param of the CreateSecurityGroupRuleResponse
        :type security_group_rule: :class:`g42cloudsdkvpc.v3.SecurityGroupRule`
        """
    ...
    def security_group_rule(self):
        ...
        :rtype: :class:`g42cloudsdkvpc.v3.SecurityGroupRule`
        """
