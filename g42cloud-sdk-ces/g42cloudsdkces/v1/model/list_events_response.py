...
class ListEventsResponse(SdkResponse):
    ...
    def __init__(self, events=None, meta_data=None):
        ...
        :param events: The param of the ListEventsResponse
        :type events: list[:class:`g42cloudsdkces.v1.EventInfo`]
        :param meta_data: The param of the ListEventsResponse
    ...
    def events(self):
        ...
        :rtype: list[:class:`g42cloudsdkces.v1.EventInfo`]
        """
        return self._events
