...
class ShowMetricDataResponse(SdkResponse):
    ...
    def __init__(self, datapoints=None, metric_name=None):
        ...
        :param datapoints: The param of the ShowMetricDataResponse
        :type datapoints: list[:class:`g42cloudsdkces.v1.Datapoint`]
        :param metric_name: The param of the ShowMetricDataResponse
    ...
    def datapoints(self):
        ...
        :rtype: list[:class:`g42cloudsdkces.v1.Datapoint`]
        """
