...
class CreateEventsResponse(SdkResponse):
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the CreateEventsResponse
        :type body: list[:class:`g42cloudsdkces.v1.CreateEventsResponseBody`]
        """
    ...
    def body(self):
        ...
        :rtype: list[:class:`g42cloudsdkces.v1.CreateEventsResponseBody`]
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateEventsResponse):
            return False
