...
class EventInfo:
    ...
    def __init__(self, event_name=None, event_type=None, event_count=None, latest_occur_time=None, latest_event_source=None):
        ...
        :param event_name: The param of the EventInfo
        :type event_name: str
        :param event_type: The param of the EventInfo
        :type event_type: str
        :param event_count: The param of the EventInfo
        :type event_count: int
        :param latest_occur_time: The param of the EventInfo
        :type latest_occur_time: int
        :param latest_event_source: The param of the EventInfo
