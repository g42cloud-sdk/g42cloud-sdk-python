...
class ListEventDetailRequest:
    ...
    def __init__(self, event_name=None, event_type=None, event_source=None, event_level=None, event_user=None, event_state=None, _from=None, to=None, start=None, limit=None):
        ...
        :param event_name: The param of the ListEventDetailRequest
        :type event_name: str
        :param event_type: The param of the ListEventDetailRequest
        :type event_type: str
        :param event_source: The param of the ListEventDetailRequest
        :type event_source: str
        :param event_level: The param of the ListEventDetailRequest
        :type event_level: str
        :param event_user: The param of the ListEventDetailRequest
        :type event_user: str
        :param event_state: The param of the ListEventDetailRequest
        :type event_state: str
        :param _from: The param of the ListEventDetailRequest
        :type _from: int
        :param to: The param of the ListEventDetailRequest
        :type to: int
        :param start: The param of the ListEventDetailRequest
        :type start: int
        :param limit: The param of the ListEventDetailRequest
        :type limit: int
        """
