...
class ShowMetricDataRequest:
    ...
    def __init__(self, namespace=None, metric_name=None, dim_0=None, dim_1=None, dim_2=None, dim_3=None, filter=None, period=None, _from=None, to=None):
        ...
        :param namespace: The param of the ShowMetricDataRequest
        :type namespace: str
        :param metric_name: The param of the ShowMetricDataRequest
        :type metric_name: str
        :param dim_0: The param of the ShowMetricDataRequest
        :type dim_0: str
        :param dim_1: The param of the ShowMetricDataRequest
        :type dim_1: str
        :param dim_2: The param of the ShowMetricDataRequest
        :type dim_2: str
        :param dim_3: The param of the ShowMetricDataRequest
        :type dim_3: str
        :param filter: The param of the ShowMetricDataRequest
        :type filter: str
        :param period: The param of the ShowMetricDataRequest
        :type period: int
        :param _from: The param of the ShowMetricDataRequest
        :type _from: int
        :param to: The param of the ShowMetricDataRequest
        :type to: int
        """
