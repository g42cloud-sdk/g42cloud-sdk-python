...
class ShowEventDataRequest:
    ...
    def __init__(self, namespace=None, dim_0=None, dim_1=None, dim_2=None, dim_3=None, type=None, _from=None, to=None):
        ...
        :param namespace: The param of the ShowEventDataRequest
        :type namespace: str
        :param dim_0: The param of the ShowEventDataRequest
        :type dim_0: str
        :param dim_1: The param of the ShowEventDataRequest
        :type dim_1: str
        :param dim_2: The param of the ShowEventDataRequest
        :type dim_2: str
        :param dim_3: The param of the ShowEventDataRequest
        :type dim_3: str
        :param type: The param of the ShowEventDataRequest
        :type type: str
        :param _from: The param of the ShowEventDataRequest
        :type _from: int
        :param to: The param of the ShowEventDataRequest
        :type to: int
        """
