...
class ListAlarmsResponse(SdkResponse):
    ...
    def __init__(self, metric_alarms=None, meta_data=None):
        ...
        :param metric_alarms: The param of the ListAlarmsResponse
        :type metric_alarms: list[:class:`g42cloudsdkces.v1.MetricAlarms`]
        :param meta_data: The param of the ListAlarmsResponse
    ...
    def metric_alarms(self):
        ...
        :rtype: list[:class:`g42cloudsdkces.v1.MetricAlarms`]
        """
