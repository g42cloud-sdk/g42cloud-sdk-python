...
class MetricForAlarm:
    ...
    def __init__(self, namespace=None, metric_name=None, dimensions=None, resource_group_id=None):
        ...
        :param namespace: The param of the MetricForAlarm
        :type namespace: str
        :param metric_name: The param of the MetricForAlarm
        :type metric_name: str
        :param dimensions: The param of the MetricForAlarm
        :type dimensions: list[:class:`g42cloudsdkces.v1.MetricsDimension`]
        :param resource_group_id: The param of the MetricForAlarm
