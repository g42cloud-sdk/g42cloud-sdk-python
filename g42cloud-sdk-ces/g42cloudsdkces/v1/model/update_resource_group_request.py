...
class UpdateResourceGroupRequest:
    ...
    def __init__(self, group_id=None, body=None):
        ...
        :param group_id: The param of the UpdateResourceGroupRequest
        :type group_id: str
        :param body: The param of the UpdateResourceGroupRequest
        :type body: :class:`g42cloudsdkces.v1.UpdateResourceGroupRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkces.v1.UpdateResourceGroupRequestBody`
        """
        return self._body
