...
class ListAlarmTemplatesResponse(SdkResponse):
    ...
    def __init__(self, alarm_templates=None, meta_data=None):
        ...
        :param alarm_templates: The param of the ListAlarmTemplatesResponse
        :type alarm_templates: list[:class:`g42cloudsdkces.v1.AlarmTemplate`]
        :param meta_data: The param of the ListAlarmTemplatesResponse
    ...
    def alarm_templates(self):
        ...
        :rtype: list[:class:`g42cloudsdkces.v1.AlarmTemplate`]
        """
