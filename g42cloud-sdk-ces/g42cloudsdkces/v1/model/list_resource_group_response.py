...
class ListResourceGroupResponse(SdkResponse):
    ...
    def __init__(self, resource_groups=None, meta_data=None):
        ...
        :param resource_groups: The param of the ListResourceGroupResponse
        :type resource_groups: list[:class:`g42cloudsdkces.v1.ResourceGroupInfo`]
        :param meta_data: The param of the ListResourceGroupResponse
    ...
    def resource_groups(self):
        ...
        :rtype: list[:class:`g42cloudsdkces.v1.ResourceGroupInfo`]
        """
