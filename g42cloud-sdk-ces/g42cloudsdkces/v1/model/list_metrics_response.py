...
class ListMetricsResponse(SdkResponse):
    ...
    def __init__(self, metrics=None, meta_data=None):
        ...
        :param metrics: The param of the ListMetricsResponse
        :type metrics: list[:class:`g42cloudsdkces.v1.MetricInfoList`]
        :param meta_data: The param of the ListMetricsResponse
    ...
    def metrics(self):
        ...
        :rtype: list[:class:`g42cloudsdkces.v1.MetricInfoList`]
        """
