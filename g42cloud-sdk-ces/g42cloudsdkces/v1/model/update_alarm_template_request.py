...
class UpdateAlarmTemplateRequest:
    ...
    def __init__(self, template_id=None, body=None):
        ...
        :param template_id: The param of the UpdateAlarmTemplateRequest
        :type template_id: str
        :param body: The param of the UpdateAlarmTemplateRequest
        :type body: :class:`g42cloudsdkces.v1.UpdateAlarmTemplateRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkces.v1.UpdateAlarmTemplateRequestBody`
        """
        return self._body
