...
class ListAlarmHistoriesRequest:
    ...
    def __init__(self, group_id=None, alarm_id=None, alarm_name=None, alarm_status=None, alarm_level=None, namespace=None, _from=None, to=None, start=None, limit=None):
        ...
        :param group_id: The param of the ListAlarmHistoriesRequest
        :type group_id: str
        :param alarm_id: The param of the ListAlarmHistoriesRequest
        :type alarm_id: str
        :param alarm_name: The param of the ListAlarmHistoriesRequest
        :type alarm_name: str
        :param alarm_status: The param of the ListAlarmHistoriesRequest
        :type alarm_status: str
        :param alarm_level: The param of the ListAlarmHistoriesRequest
        ...
        :type to: str
        :param start: The param of the ListAlarmHistoriesRequest
        :type start: str
