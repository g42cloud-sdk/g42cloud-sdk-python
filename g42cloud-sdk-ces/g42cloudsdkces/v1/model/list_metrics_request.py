...
class ListMetricsRequest:
    ...
    def __init__(self, dim_0=None, dim_1=None, dim_2=None, limit=None, metric_name=None, namespace=None, order=None, start=None):
        ...
        :param dim_0: The param of the ListMetricsRequest
        :type dim_0: str
        :param dim_1: The param of the ListMetricsRequest
        :type dim_1: str
        :param dim_2: The param of the ListMetricsRequest
        :type dim_2: str
        :param limit: The param of the ListMetricsRequest
        :type limit: int
        :param metric_name: The param of the ListMetricsRequest
        :type metric_name: str
        :param namespace: The param of the ListMetricsRequest
        :type namespace: str
        :param order: The param of the ListMetricsRequest
        :type order: str
        :param start: The param of the ListMetricsRequest
        :type start: str
        """
