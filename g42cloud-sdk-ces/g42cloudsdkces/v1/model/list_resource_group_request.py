...
class ListResourceGroupRequest:
    ...
    def __init__(self, group_name=None, group_id=None, status=None, start=None, limit=None):
        ...
        :param group_name: The param of the ListResourceGroupRequest
        :type group_name: str
        :param group_id: The param of the ListResourceGroupRequest
        :type group_id: str
        :param status: The param of the ListResourceGroupRequest
        :type status: str
        :param start: The param of the ListResourceGroupRequest
        :type start: int
        :param limit: The param of the ListResourceGroupRequest
        :type limit: int
        """
