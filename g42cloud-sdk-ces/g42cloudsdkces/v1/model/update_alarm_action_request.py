...
class UpdateAlarmActionRequest:
    ...
    def __init__(self, alarm_id=None, body=None):
        ...
        :param alarm_id: The param of the UpdateAlarmActionRequest
        :type alarm_id: str
        :param body: The param of the UpdateAlarmActionRequest
        :type body: :class:`g42cloudsdkces.v1.ModifyAlarmActionReq`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkces.v1.ModifyAlarmActionReq`
        """
        return self._body
