...
class CreateAlarmTemplateRequestBody:
    ...
    def __init__(self, template_name=None, template_description=None, namespace=None, dimension_name=None, template_items=None):
        ...
        :param template_name: The param of the CreateAlarmTemplateRequestBody
        :type template_name: str
        :param template_description: The param of the CreateAlarmTemplateRequestBody
        :type template_description: str
        :param namespace: The param of the CreateAlarmTemplateRequestBody
        :type namespace: str
        :param dimension_name: The param of the CreateAlarmTemplateRequestBody
        :type dimension_name: str
        :param template_items: The param of the CreateAlarmTemplateRequestBody
