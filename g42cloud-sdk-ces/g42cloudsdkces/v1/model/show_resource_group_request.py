...
class ShowResourceGroupRequest:
    ...
    def __init__(self, group_id=None, status=None, namespace=None, dname=None, start=None, limit=None):
        ...
        :param group_id: The param of the ShowResourceGroupRequest
        :type group_id: str
        :param status: The param of the ShowResourceGroupRequest
        :type status: str
        :param namespace: The param of the ShowResourceGroupRequest
        :type namespace: str
        :param dname: The param of the ShowResourceGroupRequest
        :type dname: str
        :param start: The param of the ShowResourceGroupRequest
        :type start: str
        :param limit: The param of the ShowResourceGroupRequest
        :type limit: str
        """
