...
class CreateAlarmRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the CreateAlarmRequest
        :type body: :class:`g42cloudsdkces.v1.CreateAlarmRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkces.v1.CreateAlarmRequestBody`
        """
        return self._body
