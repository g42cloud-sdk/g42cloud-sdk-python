...
class AlarmHistoryInfo:
    ...
    def __init__(self, alarm_id=None, alarm_name=None, alarm_description=None, metric=None, condition=None, alarm_level=None, alarm_type=None, alarm_enabled=None, alarm_action_enabled=None, alarm_actions=None, ok_actions=None, insufficientdata_actions=None, update_time=None, enterprise_project_id=None, trigger_time=None, alarm_status=None, datapoints=None, additional_info=None):
        ...
        :param alarm_id: The param of the AlarmHistoryInfo
        :type alarm_id: str
        :param alarm_name: The param of the AlarmHistoryInfo
        :type alarm_name: str
        :param alarm_description: The param of the AlarmHistoryInfo
        :type alarm_description: str
        :param metric: The param of the AlarmHistoryInfo
        :type metric: :class:`g42cloudsdkces.v1.MetricInfo`
        :param condition: The param of the AlarmHistoryInfo
        :type condition: :class:`g42cloudsdkces.v1.Condition`
        :param alarm_level: The param of the AlarmHistoryInfo
        :type alarm_level: int
        :param alarm_type: The param of the AlarmHistoryInfo
        :type alarm_type: str
        :param alarm_enabled: The param of the AlarmHistoryInfo
        :type alarm_enabled: bool
        :param alarm_action_enabled: The param of the AlarmHistoryInfo
        :type alarm_action_enabled: bool
        :param alarm_actions: The param of the AlarmHistoryInfo
        :type alarm_actions: list[:class:`g42cloudsdkces.v1.AlarmActions`]
        :param ok_actions: The param of the AlarmHistoryInfo
        :type ok_actions: list[:class:`g42cloudsdkces.v1.AlarmActions`]
        :param insufficientdata_actions: The param of the AlarmHistoryInfo
        :type insufficientdata_actions: list[:class:`g42cloudsdkces.v1.AlarmActions`]
        :param update_time: The param of the AlarmHistoryInfo
        :type update_time: int
        :param enterprise_project_id: The param of the AlarmHistoryInfo
        :type enterprise_project_id: str
        :param trigger_time: The param of the AlarmHistoryInfo
        :type trigger_time: int
        :param alarm_status: The param of the AlarmHistoryInfo
        :type alarm_status: str
        :param datapoints: The param of the AlarmHistoryInfo
        :type datapoints: list[:class:`g42cloudsdkces.v1.DataPointForAlarmHistory`]
        :param additional_info: The param of the AlarmHistoryInfo
        :type additional_info: :class:`g42cloudsdkces.v1.AdditionalInfo`
        """
    ...
    def datapoints(self):
        ...
        :rtype: list[:class:`g42cloudsdkces.v1.DataPointForAlarmHistory`]
        """
    ...
    def additional_info(self):
        ...
        :rtype: :class:`g42cloudsdkces.v1.AdditionalInfo`
        """
