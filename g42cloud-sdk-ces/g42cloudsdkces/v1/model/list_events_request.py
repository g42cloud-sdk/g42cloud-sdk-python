...
class ListEventsRequest:
    ...
    def __init__(self, event_type=None, event_name=None, _from=None, to=None, start=None, limit=None):
        ...
        :param event_type: The param of the ListEventsRequest
        :type event_type: str
        :param event_name: The param of the ListEventsRequest
        :type event_name: str
        :param _from: The param of the ListEventsRequest
        :type _from: int
        :param to: The param of the ListEventsRequest
        :type to: int
        :param start: The param of the ListEventsRequest
        :type start: int
        :param limit: The param of the ListEventsRequest
        :type limit: int
        """
