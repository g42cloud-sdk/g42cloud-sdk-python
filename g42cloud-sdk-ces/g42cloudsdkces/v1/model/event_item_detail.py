...
class EventItemDetail:
    ...
    def __init__(self, content=None, group_id=None, resource_id=None, resource_name=None, event_state=None, event_level=None, event_user=None, event_type=None):
        ...
        :param content: The param of the EventItemDetail
        :type content: str
        :param group_id: The param of the EventItemDetail
        :type group_id: str
        :param resource_id: The param of the EventItemDetail
        :type resource_id: str
        :param resource_name: The param of the EventItemDetail
        :type resource_name: str
        :param event_state: The param of the EventItemDetail
        :type event_state: str
        :param event_level: The param of the EventItemDetail
        :type event_level: str
        :param event_user: The param of the EventItemDetail
        :type event_user: str
        :param event_type: The param of the EventItemDetail
        :type event_type: str
        """
