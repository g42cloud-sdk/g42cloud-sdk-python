...
class UpdateAlarmRequest:
    ...
    def __init__(self, alarm_id=None, body=None):
        ...
        :param alarm_id: The param of the UpdateAlarmRequest
        :type alarm_id: str
        :param body: The param of the UpdateAlarmRequest
        :type body: :class:`g42cloudsdkces.v1.UpdateAlarmRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkces.v1.UpdateAlarmRequestBody`
        """
        return self._body
