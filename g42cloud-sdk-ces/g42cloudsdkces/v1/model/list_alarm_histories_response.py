...
class ListAlarmHistoriesResponse(SdkResponse):
    ...
    def __init__(self, alarm_histories=None, meta_data=None):
        ...
        :param alarm_histories: The param of the ListAlarmHistoriesResponse
        :type alarm_histories: list[:class:`g42cloudsdkces.v1.AlarmHistoryInfo`]
        :param meta_data: The param of the ListAlarmHistoriesResponse
        :type meta_data: :class:`g42cloudsdkces.v1.MetaDataForAlarmHistory`
        """
    ...
    def alarm_histories(self):
        ...
        :rtype: list[:class:`g42cloudsdkces.v1.AlarmHistoryInfo`]
        """
    ...
    def meta_data(self):
        ...
        :rtype: :class:`g42cloudsdkces.v1.MetaDataForAlarmHistory`
        """
