...
class BatchEnableAlarmRulesResponse(SdkResponse):
    ...
    def __init__(self, alarm_ids=None):
        ...
        :param alarm_ids: The param of the BatchEnableAlarmRulesResponse
        :type alarm_ids: list[str]
        """
        
        super(BatchEnableAlarmRulesResponse, self).__init__()
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchEnableAlarmRulesResponse):
            return False
