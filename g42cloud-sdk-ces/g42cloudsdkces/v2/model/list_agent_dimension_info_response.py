...
class ListAgentDimensionInfoResponse(SdkResponse):
    ...
    def __init__(self, dimensions=None, count=None):
        ...
        :param dimensions: The param of the ListAgentDimensionInfoResponse
        :type dimensions: list[:class:`g42cloudsdkces.v2.AgentDimension`]
        :param count: The param of the ListAgentDimensionInfoResponse
        :type count: int
        """
    ...
    def dimensions(self):
        ...
        :rtype: list[:class:`g42cloudsdkces.v2.AgentDimension`]
        """
