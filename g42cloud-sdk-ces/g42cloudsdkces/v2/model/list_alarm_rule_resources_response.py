...
class ListAlarmRuleResourcesResponse(SdkResponse):
    ...
    def __init__(self, resources=None, count=None):
        """ListAlarmRuleResourcesResponse

        The model defined in g42cloud sdk

        :param resources: The param of the ListAlarmRuleResourcesResponse
        :type resources: list[list[Dimension]]
        :param count: The param of the ListAlarmRuleResourcesResponse
        :type count: int
        """
        
        super(ListAlarmRuleResourcesResponse, self).__init__()
    ...
    @property
    def resources(self):
        """Gets the resources of this ListAlarmRuleResourcesResponse.
    ...
    def resources(self, resources):
        """Sets the resources of this ListAlarmRuleResourcesResponse.
    ...
    @property
    def count(self):
        """Gets the count of this ListAlarmRuleResourcesResponse.
    ...
    def count(self, count):
        """Sets the count of this ListAlarmRuleResourcesResponse.
