...
class UpdateAlarmRulePoliciesRequest:
    ...
    def __init__(self, alarm_id=None, body=None):
        ...
        :param alarm_id: The param of the UpdateAlarmRulePoliciesRequest
        :type alarm_id: str
        :param body: The param of the UpdateAlarmRulePoliciesRequest
        :type body: :class:`g42cloudsdkces.v2.PoliciesReqV2`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkces.v2.PoliciesReqV2`
        """
        return self._body
