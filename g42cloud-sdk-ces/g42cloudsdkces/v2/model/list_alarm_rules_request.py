...
class ListAlarmRulesRequest:
    ...
    def __init__(self, alarm_id=None, name=None, namespace=None, resource_id=None, enterprise_project_id=None, offset=None, limit=None):
        ...
        :param alarm_id: The param of the ListAlarmRulesRequest
        :type alarm_id: str
        :param name: The param of the ListAlarmRulesRequest
        :type name: str
        :param namespace: The param of the ListAlarmRulesRequest
        :type namespace: str
        :param resource_id: The param of the ListAlarmRulesRequest
        :type resource_id: str
        :param enterprise_project_id: The param of the ListAlarmRulesRequest
        :type enterprise_project_id: str
        :param offset: The param of the ListAlarmRulesRequest
        :type offset: int
        :param limit: The param of the ListAlarmRulesRequest
        :type limit: int
        """
