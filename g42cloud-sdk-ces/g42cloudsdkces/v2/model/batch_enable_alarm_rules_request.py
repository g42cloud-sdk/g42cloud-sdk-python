...
class BatchEnableAlarmRulesRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the BatchEnableAlarmRulesRequest
        :type body: :class:`g42cloudsdkces.v2.BatchEnableAlarmsRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkces.v2.BatchEnableAlarmsRequestBody`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchEnableAlarmRulesRequest):
            return False
