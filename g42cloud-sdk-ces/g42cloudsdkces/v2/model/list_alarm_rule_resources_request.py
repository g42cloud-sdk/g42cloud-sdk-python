...
class ListAlarmRuleResourcesRequest:
    ...
    def __init__(self, alarm_id=None, offset=None, limit=None):
        ...
        :param alarm_id: The param of the ListAlarmRuleResourcesRequest
        :type alarm_id: str
        :param offset: The param of the ListAlarmRuleResourcesRequest
        :type offset: int
        :param limit: The param of the ListAlarmRuleResourcesRequest
        :type limit: int
        """
