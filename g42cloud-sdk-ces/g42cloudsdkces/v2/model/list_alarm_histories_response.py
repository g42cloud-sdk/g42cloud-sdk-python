...
class ListAlarmHistoriesResponse(SdkResponse):
    ...
    def __init__(self, alarm_histories=None, count=None):
        ...
        :type alarm_histories: list[:class:`g42cloudsdkces.v2.AlarmHistoryItemV2`]
        :param count: The param of the ListAlarmHistoriesResponse
        :type count: int
        """
    ...
    def alarm_histories(self):
        ...
        :rtype: list[:class:`g42cloudsdkces.v2.AlarmHistoryItemV2`]
        """
