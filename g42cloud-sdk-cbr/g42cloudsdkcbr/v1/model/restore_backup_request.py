...
class RestoreBackupRequest:
    ...
    def __init__(self, backup_id=None, body=None):
        ...
        :param backup_id: The param of the RestoreBackupRequest
        :type backup_id: str
        :param body: The param of the RestoreBackupRequest
        :type body: :class:`g42cloudsdkcbr.v1.BackupRestoreReq`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkcbr.v1.BackupRestoreReq`
        """
        return self._body
