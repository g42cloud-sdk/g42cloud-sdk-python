...
class ListProtectableRequest:
    ...
    def __init__(self, limit=None, marker=None, name=None, offset=None, protectable_type=None, status=None, id=None, server_id=None):
        ...
        :param limit: The param of the ListProtectableRequest
        :type limit: int
        :param marker: The param of the ListProtectableRequest
        :type marker: str
        :param name: The param of the ListProtectableRequest
        :type name: str
        :param offset: The param of the ListProtectableRequest
        :type offset: int
        :param protectable_type: The param of the ListProtectableRequest
        :type protectable_type: str
        :param status: The param of the ListProtectableRequest
        :type status: str
        :param id: The param of the ListProtectableRequest
        :type id: str
        :param server_id: The param of the ListProtectableRequest
        :type server_id: str
        """
