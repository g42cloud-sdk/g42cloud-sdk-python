...
class UpdateVaultRequest:
    ...
    def __init__(self, vault_id=None, body=None):
        ...
        :param vault_id: The param of the UpdateVaultRequest
        :type vault_id: str
        :param body: The param of the UpdateVaultRequest
        :type body: :class:`g42cloudsdkcbr.v1.VaultUpdateReq`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkcbr.v1.VaultUpdateReq`
        """
        return self._body
