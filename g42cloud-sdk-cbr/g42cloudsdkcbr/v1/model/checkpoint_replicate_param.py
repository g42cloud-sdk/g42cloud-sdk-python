...
class CheckpointReplicateParam:
    ...
    def __init__(self, auto_trigger=None, destination_project_id=None, destination_region=None, destination_vault_id=None, enable_acceleration=None, vault_id=None):
        ...
        :param auto_trigger: The param of the CheckpointReplicateParam
        :type auto_trigger: bool
        :param destination_project_id: The param of the CheckpointReplicateParam
        :type destination_project_id: str
        :param destination_region: The param of the CheckpointReplicateParam
        :type destination_region: str
        :param destination_vault_id: The param of the CheckpointReplicateParam
        :type destination_vault_id: str
        :param enable_acceleration: The param of the CheckpointReplicateParam
        :type enable_acceleration: bool
        :param vault_id: The param of the CheckpointReplicateParam
        :type vault_id: str
        """
