...
class CheckpointReplicateReq:
    ...
    def __init__(self, replicate=None):
        ...
        :param replicate: The param of the CheckpointReplicateReq
        :type replicate: :class:`g42cloudsdkcbr.v1.CheckpointReplicateParam`
        """
    ...
    def replicate(self):
        ...
        :rtype: :class:`g42cloudsdkcbr.v1.CheckpointReplicateParam`
        """
