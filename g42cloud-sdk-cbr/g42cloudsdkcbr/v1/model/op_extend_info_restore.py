...
class OpExtendInfoRestore:
    ...
    def __init__(self, backup_id=None, backup_name=None, target_resource_id=None, target_resource_name=None):
        ...
        :param backup_id: The param of the OpExtendInfoRestore
        :type backup_id: str
        :param backup_name: The param of the OpExtendInfoRestore
        :type backup_name: str
        :param target_resource_id: The param of the OpExtendInfoRestore
        :type target_resource_id: str
        :param target_resource_name: The param of the OpExtendInfoRestore
