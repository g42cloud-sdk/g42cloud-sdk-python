...
class ImportBackupResponse(SdkResponse):
    ...
    def __init__(self, sync=None):
        ...
        :param sync: The param of the ImportBackupResponse
        :type sync: list[:class:`g42cloudsdkcbr.v1.BackupSyncRespBody`]
        """
    ...
    def sync(self):
        ...
        :rtype: list[:class:`g42cloudsdkcbr.v1.BackupSyncRespBody`]
        """
        return self._sync
