...
class ShowMembersDetailRequest:
    ...
    def __init__(self, backup_id=None, dest_project_id=None, image_id=None, status=None, vault_id=None, limit=None, marker=None, offset=None, sort=None):
        ...
        :param backup_id: The param of the ShowMembersDetailRequest
        :type backup_id: str
        :param dest_project_id: The param of the ShowMembersDetailRequest
        :type dest_project_id: str
        :param image_id: The param of the ShowMembersDetailRequest
        :type image_id: str
        :param status: The param of the ShowMembersDetailRequest
        :type status: str
        :param vault_id: The param of the ShowMembersDetailRequest
        :type vault_id: str
        :param limit: The param of the ShowMembersDetailRequest
        :type limit: int
        :param marker: The param of the ShowMembersDetailRequest
        :type marker: str
        :param offset: The param of the ShowMembersDetailRequest
        :type offset: int
        :param sort: The param of the ShowMembersDetailRequest
        :type sort: str
        """
