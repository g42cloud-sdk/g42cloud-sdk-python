...
class ListOpLogsRequest:
    ...
    def __init__(self, end_time=None, limit=None, offset=None, operation_type=None, provider_id=None, resource_id=None, resource_name=None, start_time=None, status=None, vault_id=None, vault_name=None, enterprise_project_id=None):
        ...
        :param end_time: The param of the ListOpLogsRequest
        :type end_time: str
        :param limit: The param of the ListOpLogsRequest
        :type limit: int
        :param offset: The param of the ListOpLogsRequest
        :type offset: int
        :param operation_type: The param of the ListOpLogsRequest
        :type operation_type: str
        :param provider_id: The param of the ListOpLogsRequest
        :type provider_id: str
        :param resource_id: The param of the ListOpLogsRequest
        :type resource_id: str
        :param resource_name: The param of the ListOpLogsRequest
        :type resource_name: str
        :param start_time: The param of the ListOpLogsRequest
        :type start_time: str
        :param status: The param of the ListOpLogsRequest
        :type status: str
        :param vault_id: The param of the ListOpLogsRequest
        :type vault_id: str
        :param vault_name: The param of the ListOpLogsRequest
        :type vault_name: str
        :param enterprise_project_id: The param of the ListOpLogsRequest
