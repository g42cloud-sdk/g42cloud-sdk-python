...
class VaultGet:
    ...
    def __init__(self, billing=None, description=None, id=None, name=None, project_id=None, provider_id=None, resources=None, tags=None, enterprise_project_id=None, auto_bind=None, bind_rules=None, user_id=None, created_at=None, auto_expand=None, smn_notify=None, threshold=None, updated_at=None, version=None):
        ...
        :param billing: The param of the VaultGet
        :type billing: :class:`g42cloudsdkcbr.v1.Billing`
        :param description: The param of the VaultGet
        :type description: str
        :param id: The param of the VaultGet
        :type id: str
        :param name: The param of the VaultGet
        :type name: str
        :param project_id: The param of the VaultGet
        :type project_id: str
        :param provider_id: The param of the VaultGet
        ...
        :type auto_bind: bool
        :param bind_rules: The param of the VaultGet
        :type bind_rules: :class:`g42cloudsdkcbr.v1.VaultBindRules`
        :param user_id: The param of the VaultGet
        :type user_id: str
        :param created_at: The param of the VaultGet
        :type created_at: str
        :param auto_expand: The param of the VaultGet
        :type auto_expand: bool
        :param smn_notify: The param of the VaultGet
        :type smn_notify: bool
        :param threshold: The param of the VaultGet
        :type threshold: int
        :param updated_at: The param of the VaultGet
        :type updated_at: str
        :param version: The param of the VaultGet
        :type version: str
        """
