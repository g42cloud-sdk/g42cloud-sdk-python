...
class ListProtectableResponse(SdkResponse):
    ...
    def __init__(self, instances=None):
        ...
        :param instances: The param of the ListProtectableResponse
        :type instances: list[:class:`g42cloudsdkcbr.v1.ProtectablesResp`]
        """
    ...
    def instances(self):
        ...
        :rtype: list[:class:`g42cloudsdkcbr.v1.ProtectablesResp`]
        """
