...
class DisassociateVaultPolicyRequest:
    ...
    def __init__(self, vault_id=None, body=None):
        ...
        :param vault_id: The param of the DisassociateVaultPolicyRequest
        :type vault_id: str
        :param body: The param of the DisassociateVaultPolicyRequest
        :type body: :class:`g42cloudsdkcbr.v1.VaultDissociate`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkcbr.v1.VaultDissociate`
        """
        return self._body
