...
class UpdatePolicyRequest:
    ...
    def __init__(self, policy_id=None, body=None):
        ...
        :param policy_id: The param of the UpdatePolicyRequest
        :type policy_id: str
        :param body: The param of the UpdatePolicyRequest
        :type body: :class:`g42cloudsdkcbr.v1.PolicyUpdateReq`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkcbr.v1.PolicyUpdateReq`
        """
        return self._body
