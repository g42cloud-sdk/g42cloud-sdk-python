...
class ShowVaultResourceInstancesResponse(SdkResponse):
    ...
    def __init__(self, resources=None, total_count=None):
        ...
        :param resources: The param of the ShowVaultResourceInstancesResponse
        :type resources: list[:class:`g42cloudsdkcbr.v1.TagResource`]
        :param total_count: The param of the ShowVaultResourceInstancesResponse
    ...
    def resources(self):
        ...
        :rtype: list[:class:`g42cloudsdkcbr.v1.TagResource`]
        """
