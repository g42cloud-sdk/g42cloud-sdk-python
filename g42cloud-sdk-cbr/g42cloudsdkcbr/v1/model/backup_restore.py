...
class BackupRestore:
    ...
    def __init__(self, mappings=None, power_on=None, server_id=None, volume_id=None, resource_id=None):
        ...
        :param mappings: The param of the BackupRestore
        :type mappings: list[:class:`g42cloudsdkcbr.v1.BackupRestoreServerMapping`]
        :param power_on: The param of the BackupRestore
        :type power_on: bool
        :param server_id: The param of the BackupRestore
        :type server_id: str
        :param volume_id: The param of the BackupRestore
        :type volume_id: str
        :param resource_id: The param of the BackupRestore
    ...
    def mappings(self):
        ...
        :rtype: list[:class:`g42cloudsdkcbr.v1.BackupRestoreServerMapping`]
        """
