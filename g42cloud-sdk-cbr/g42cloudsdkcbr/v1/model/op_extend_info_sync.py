...
class OpExtendInfoSync:
    ...
    def __init__(self, sync_backup_num=None, delete_backup_num=None, err_sync_backup_num=None):
        ...
        :param sync_backup_num: The param of the OpExtendInfoSync
        :type sync_backup_num: int
        :param delete_backup_num: The param of the OpExtendInfoSync
        :type delete_backup_num: int
        :param err_sync_backup_num: The param of the OpExtendInfoSync
