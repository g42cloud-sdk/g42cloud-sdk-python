...
class CheckpointPlanCreate:
    ...
    def __init__(self, id=None, name=None, resources=None, skipped_resources=None):
        ...
        :param id: The param of the CheckpointPlanCreate
        :type id: str
        :param name: The param of the CheckpointPlanCreate
        :type name: str
        :param resources: The param of the CheckpointPlanCreate
        :type resources: list[:class:`g42cloudsdkcbr.v1.CheckpointResourceResp`]
        :param skipped_resources: The param of the CheckpointPlanCreate
        :type skipped_resources: list[:class:`g42cloudsdkcbr.v1.CheckpointCreateSkippedResource`]
        """
    ...
    def resources(self):
        ...
        :rtype: list[:class:`g42cloudsdkcbr.v1.CheckpointResourceResp`]
        """
    ...
    def skipped_resources(self):
        ...
        :rtype: list[:class:`g42cloudsdkcbr.v1.CheckpointCreateSkippedResource`]
        """
