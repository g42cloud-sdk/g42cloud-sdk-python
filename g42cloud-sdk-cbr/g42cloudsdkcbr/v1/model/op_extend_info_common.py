...
class OpExtendInfoCommon:
    ...
    def __init__(self, progress=None, request_id=None, task_id=None):
        ...
        :param progress: The param of the OpExtendInfoCommon
        :type progress: int
        :param request_id: The param of the OpExtendInfoCommon
        :type request_id: str
        :param task_id: The param of the OpExtendInfoCommon
        :type task_id: str
        """
