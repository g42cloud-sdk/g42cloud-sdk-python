...
class CheckpointExtraInfoResp:
    ...
    def __init__(self, name=None, description=None, retention_duration=None):
        ...
        :param name: The param of the CheckpointExtraInfoResp
        :type name: str
        :param description: The param of the CheckpointExtraInfoResp
        :type description: str
        :param retention_duration: The param of the CheckpointExtraInfoResp
