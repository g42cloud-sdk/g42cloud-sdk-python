...
class OpExtendInfoReplication:
    ...
    def __init__(self, destination_backup_id=None, destination_checkpoint_id=None, destination_project_id=None, destination_region=None, source_backup_id=None, source_checkpoint_id=None, source_project_id=None, source_region=None, source_backup_name=None, destination_backup_name=None):
        ...
        :param destination_backup_id: The param of the OpExtendInfoReplication
        :type destination_backup_id: str
        :param destination_checkpoint_id: The param of the OpExtendInfoReplication
        :type destination_checkpoint_id: str
        :param destination_project_id: The param of the OpExtendInfoReplication
        :type destination_project_id: str
        :param destination_region: The param of the OpExtendInfoReplication
        :type destination_region: str
        :param source_backup_id: The param of the OpExtendInfoReplication
        :type source_backup_id: str
        :param source_checkpoint_id: The param of the OpExtendInfoReplication
        :type source_checkpoint_id: str
        :param source_project_id: The param of the OpExtendInfoReplication
        :type source_project_id: str
        :param source_region: The param of the OpExtendInfoReplication
        :type source_region: str
        :param source_backup_name: The param of the OpExtendInfoReplication
        :type source_backup_name: str
        :param destination_backup_name: The param of the OpExtendInfoReplication
