...
class BackupReplicateReqBody:
    ...
    def __init__(self, description=None, destination_project_id=None, destination_region=None, destination_vault_id=None, enable_acceleration=None, name=None):
        ...
        :param description: The param of the BackupReplicateReqBody
        :type description: str
        :param destination_project_id: The param of the BackupReplicateReqBody
        :type destination_project_id: str
        :param destination_region: The param of the BackupReplicateReqBody
        :type destination_region: str
        :param destination_vault_id: The param of the BackupReplicateReqBody
        :type destination_vault_id: str
        :param enable_acceleration: The param of the BackupReplicateReqBody
        :type enable_acceleration: bool
        :param name: The param of the BackupReplicateReqBody
        :type name: str
        """
