...
class AssociateVaultPolicyRequest:
    ...
    def __init__(self, vault_id=None, body=None):
        ...
        :param vault_id: The param of the AssociateVaultPolicyRequest
        :type vault_id: str
        :param body: The param of the AssociateVaultPolicyRequest
        :type body: :class:`g42cloudsdkcbr.v1.VaultAssociate`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkcbr.v1.VaultAssociate`
        """
        return self._body
