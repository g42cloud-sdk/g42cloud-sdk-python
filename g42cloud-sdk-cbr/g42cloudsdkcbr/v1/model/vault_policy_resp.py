...
class VaultPolicyResp:
    ...
    def __init__(self, destination_vault_id=None, policy_id=None, vault_id=None):
        ...
        :param destination_vault_id: The param of the VaultPolicyResp
        :type destination_vault_id: str
        :param policy_id: The param of the VaultPolicyResp
        :type policy_id: str
        :param vault_id: The param of the VaultPolicyResp
        :type vault_id: str
        """
