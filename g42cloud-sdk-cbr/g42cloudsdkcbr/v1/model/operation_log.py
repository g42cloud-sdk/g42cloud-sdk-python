...
class OperationLog:
    ...
    def __init__(self, checkpoint_id=None, created_at=None, ended_at=None, error_info=None, extra_info=None, id=None, operation_type=None, policy_id=None, project_id=None, provider_id=None, started_at=None, status=None, updated_at=None, vault_id=None, vault_name=None):
        ...
        :param checkpoint_id: The param of the OperationLog
        :type checkpoint_id: str
        :param created_at: The param of the OperationLog
        :type created_at: str
        :param ended_at: The param of the OperationLog
        :type ended_at: str
        :param error_info: The param of the OperationLog
        :type error_info: :class:`g42cloudsdkcbr.v1.OpErrorInfo`
        :param extra_info: The param of the OperationLog
        :type extra_info: :class:`g42cloudsdkcbr.v1.OpExtraInfo`
        :param id: The param of the OperationLog
        :type id: str
        :param operation_type: The param of the OperationLog
        :type operation_type: str
        :param policy_id: The param of the OperationLog
        :type policy_id: str
        :param project_id: The param of the OperationLog
        :type project_id: str
        :param provider_id: The param of the OperationLog
        :type provider_id: str
        :param started_at: The param of the OperationLog
        :type started_at: str
        :param status: The param of the OperationLog
        :type status: str
        :param updated_at: The param of the OperationLog
        :type updated_at: str
        :param vault_id: The param of the OperationLog
        :type vault_id: str
        :param vault_name: The param of the OperationLog
        :type vault_name: str
        """
    ...
    def error_info(self):
        ...
        :rtype: :class:`g42cloudsdkcbr.v1.OpErrorInfo`
        """
    ...
    def extra_info(self):
        ...
        :rtype: :class:`g42cloudsdkcbr.v1.OpExtraInfo`
        """
