...
class BackupReplicateRespBody:
    ...
    def __init__(self, backup_id=None, destination_project_id=None, destination_region=None, destination_vault_id=None, project_id=None, provider_id=None, replication_record_id=None, source_region=None):
        ...
        :param backup_id: The param of the BackupReplicateRespBody
        :type backup_id: str
        :param destination_project_id: The param of the BackupReplicateRespBody
        :type destination_project_id: str
        :param destination_region: The param of the BackupReplicateRespBody
        :type destination_region: str
        :param destination_vault_id: The param of the BackupReplicateRespBody
        :type destination_vault_id: str
        :param project_id: The param of the BackupReplicateRespBody
        :type project_id: str
        :param provider_id: The param of the BackupReplicateRespBody
        :type provider_id: str
        :param replication_record_id: The param of the BackupReplicateRespBody
        :type replication_record_id: str
        :param source_region: The param of the BackupReplicateRespBody
