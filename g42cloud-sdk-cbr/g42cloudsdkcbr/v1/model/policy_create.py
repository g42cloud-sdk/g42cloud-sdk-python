...
class PolicyCreate:
    ...
    def __init__(self, enabled=None, name=None, operation_definition=None, operation_type=None, trigger=None):
        ...
        :param enabled: The param of the PolicyCreate
        :type enabled: bool
        :param name: The param of the PolicyCreate
        :type name: str
        :param operation_definition: The param of the PolicyCreate
        :type operation_definition: :class:`g42cloudsdkcbr.v1.PolicyoODCreate`
        :param operation_type: The param of the PolicyCreate
        :type operation_type: str
        :param trigger: The param of the PolicyCreate
        :type trigger: :class:`g42cloudsdkcbr.v1.PolicyTriggerReq`
        """
    ...
    def trigger(self):
        ...
        :rtype: :class:`g42cloudsdkcbr.v1.PolicyTriggerReq`
        """
