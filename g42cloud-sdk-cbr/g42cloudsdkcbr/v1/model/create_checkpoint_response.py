...
class CreateCheckpointResponse(SdkResponse):
    ...
    def __init__(self, checkpoint=None):
        ...
        :param checkpoint: The param of the CreateCheckpointResponse
        :type checkpoint: :class:`g42cloudsdkcbr.v1.CheckpointCreate`
        """
        
        super(CreateCheckpointResponse, self).__init__()
    ...
    def checkpoint(self):
        ...
        :rtype: :class:`g42cloudsdkcbr.v1.CheckpointCreate`
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateCheckpointResponse):
            return False
