...
class BatchCreateAndDeleteVaultTagsRequest:
    ...
    def __init__(self, vault_id=None, body=None):
        ...
        :param vault_id: The param of the BatchCreateAndDeleteVaultTagsRequest
        :type vault_id: str
        :param body: The param of the BatchCreateAndDeleteVaultTagsRequest
        :type body: :class:`g42cloudsdkcbr.v1.BulkCreateAndDeleteVaultTagsReq`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkcbr.v1.BulkCreateAndDeleteVaultTagsReq`
        """
        return self._body
