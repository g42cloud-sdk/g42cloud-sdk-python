...
class Policy:
    ...
    def __init__(self, enabled=None, id=None, name=None, operation_definition=None, operation_type=None, trigger=None, associated_vaults=None):
        ...
        :param enabled: The param of the Policy
        :type enabled: bool
        :param id: The param of the Policy
        :type id: str
        :param name: The param of the Policy
        :type name: str
        :param operation_definition: The param of the Policy
        :type operation_definition: :class:`g42cloudsdkcbr.v1.PolicyoODCreate`
        :param operation_type: The param of the Policy
        :type operation_type: str
        :param trigger: The param of the Policy
        :type trigger: :class:`g42cloudsdkcbr.v1.PolicyTriggerResp`
        :param associated_vaults: The param of the Policy
        :type associated_vaults: list[:class:`g42cloudsdkcbr.v1.PolicyAssociateVault`]
        """
    ...
    def operation_definition(self):
        ...
        :rtype: :class:`g42cloudsdkcbr.v1.PolicyoODCreate`
        """
    ...
    def trigger(self):
        ...
        :rtype: :class:`g42cloudsdkcbr.v1.PolicyTriggerResp`
        """
    ...
    def associated_vaults(self):
        ...
        :rtype: list[:class:`g42cloudsdkcbr.v1.PolicyAssociateVault`]
        """
