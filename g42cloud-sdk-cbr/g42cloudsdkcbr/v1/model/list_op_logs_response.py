...
class ListOpLogsResponse(SdkResponse):
    ...
    def __init__(self, operation_logs=None, count=None, limit=None, offset=None):
        ...
        :param operation_logs: The param of the ListOpLogsResponse
        :type operation_logs: list[:class:`g42cloudsdkcbr.v1.OperationLog`]
        :param count: The param of the ListOpLogsResponse
        :type count: int
        :param limit: The param of the ListOpLogsResponse
        :type limit: int
        :param offset: The param of the ListOpLogsResponse
        :type offset: int
        """
    ...
    def operation_logs(self):
        ...
        :rtype: list[:class:`g42cloudsdkcbr.v1.OperationLog`]
        """
