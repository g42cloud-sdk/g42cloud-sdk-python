...
class BackupSync:
    ...
    def __init__(self, backup_id=None, backup_name=None, bucket_name=None, image_path=None, resource_id=None, resource_name=None, resource_type=None, created_at=None):
        ...
        :param backup_id: The param of the BackupSync
        :type backup_id: str
        :param backup_name: The param of the BackupSync
        :type backup_name: str
        :param bucket_name: The param of the BackupSync
        :type bucket_name: str
        :param image_path: The param of the BackupSync
        :type image_path: str
        :param resource_id: The param of the BackupSync
        :type resource_id: str
        :param resource_name: The param of the BackupSync
        :type resource_name: str
        :param resource_type: The param of the BackupSync
        :type resource_type: str
        :param created_at: The param of the BackupSync
        :type created_at: int
        """
