...
class OpExtendInfoRemoveResources:
    ...
    def __init__(self, fail_count=None, total_count=None, resources=None):
        ...
        :param fail_count: The param of the OpExtendInfoRemoveResources
        :type fail_count: int
        :param total_count: The param of the OpExtendInfoRemoveResources
        :type total_count: int
        :param resources: The param of the OpExtendInfoRemoveResources
        :type resources: list[:class:`g42cloudsdkcbr.v1.Resource`]
        """
