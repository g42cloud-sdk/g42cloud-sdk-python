...
class ReplicationRecordGet:
    ...
    def __init__(self, created_at=None, destination_backup_id=None, destination_checkpoint_id=None, destination_project_id=None, destination_region=None, destination_vault_id=None, extra_info=None, id=None, source_backup_id=None, source_checkpoint_id=None, source_project_id=None, source_region=None, status=None, vault_id=None):
        ...
        :param created_at: The param of the ReplicationRecordGet
        :type created_at: str
        :param destination_backup_id: The param of the ReplicationRecordGet
        :type destination_backup_id: str
        :param destination_checkpoint_id: The param of the ReplicationRecordGet
        :type destination_checkpoint_id: str
        :param destination_project_id: The param of the ReplicationRecordGet
        :type destination_project_id: str
        :param destination_region: The param of the ReplicationRecordGet
        :type destination_region: str
        :param destination_vault_id: The param of the ReplicationRecordGet
        :type destination_vault_id: str
        :param extra_info: The param of the ReplicationRecordGet
        :type extra_info: :class:`g42cloudsdkcbr.v1.ReplicationRecordsExtraInfo`
        :param id: The param of the ReplicationRecordGet
        :type id: str
        :param source_backup_id: The param of the ReplicationRecordGet
        :type source_backup_id: str
        :param source_checkpoint_id: The param of the ReplicationRecordGet
        :type source_checkpoint_id: str
        :param source_project_id: The param of the ReplicationRecordGet
        :type source_project_id: str
        :param source_region: The param of the ReplicationRecordGet
        :type source_region: str
        :param status: The param of the ReplicationRecordGet
        :type status: str
        :param vault_id: The param of the ReplicationRecordGet
        :type vault_id: str
        """
    ...
    def extra_info(self):
        ...
        :rtype: :class:`g42cloudsdkcbr.v1.ReplicationRecordsExtraInfo`
        """
