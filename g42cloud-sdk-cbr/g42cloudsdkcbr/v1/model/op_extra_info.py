...
class OpExtraInfo:
    ...
    def __init__(self, backup=None, common=None, delete=None, sync=None, remove_resources=None, replication=None, resource=None, restore=None, vault_delete=None):
        ...
        :param backup: The param of the OpExtraInfo
        :type backup: :class:`g42cloudsdkcbr.v1.OpExtendInfoBckup`
        :param common: The param of the OpExtraInfo
        :type common: :class:`g42cloudsdkcbr.v1.OpExtendInfoCommon`
        :param delete: The param of the OpExtraInfo
        :type delete: :class:`g42cloudsdkcbr.v1.OpExtendInfoDelete`
        :param sync: The param of the OpExtraInfo
        :type sync: :class:`g42cloudsdkcbr.v1.OpExtendInfoSync`
        :param remove_resources: The param of the OpExtraInfo
        :type remove_resources: :class:`g42cloudsdkcbr.v1.OpExtendInfoRemoveResources`
        :param replication: The param of the OpExtraInfo
        :type replication: :class:`g42cloudsdkcbr.v1.OpExtendInfoReplication`
        :param resource: The param of the OpExtraInfo
        :type resource: :class:`g42cloudsdkcbr.v1.Resource`
        :param restore: The param of the OpExtraInfo
        :type restore: :class:`g42cloudsdkcbr.v1.OpExtendInfoRestore`
        :param vault_delete: The param of the OpExtraInfo
        :type vault_delete: :class:`g42cloudsdkcbr.v1.OpExtendInfoVaultDelete`
        """
    ...
    def backup(self):
        ...
        :rtype: :class:`g42cloudsdkcbr.v1.OpExtendInfoBckup`
        """
        return self._backup
    ...
    def common(self):
        ...
        :rtype: :class:`g42cloudsdkcbr.v1.OpExtendInfoCommon`
        """
        return self._common
    ...
    def delete(self):
        ...
        :rtype: :class:`g42cloudsdkcbr.v1.OpExtendInfoDelete`
        """
        return self._delete
    ...
    def sync(self):
        ...
        :rtype: :class:`g42cloudsdkcbr.v1.OpExtendInfoSync`
        """
        return self._sync
    ...
    def remove_resources(self):
        ...
        :rtype: :class:`g42cloudsdkcbr.v1.OpExtendInfoRemoveResources`
        """
    ...
    def replication(self):
        ...
        :rtype: :class:`g42cloudsdkcbr.v1.OpExtendInfoReplication`
        """
    ...
    def resource(self):
        ...
        :rtype: :class:`g42cloudsdkcbr.v1.Resource`
        """
    ...
    def restore(self):
        ...
        :rtype: :class:`g42cloudsdkcbr.v1.OpExtendInfoRestore`
        """
    ...
    def vault_delete(self):
        ...
        :rtype: :class:`g42cloudsdkcbr.v1.OpExtendInfoVaultDelete`
        """
