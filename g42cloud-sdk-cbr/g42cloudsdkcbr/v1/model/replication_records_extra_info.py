...
class ReplicationRecordsExtraInfo:
    ...
    def __init__(self, progress=None, fail_code=None, fail_reason=None, auto_trigger=None, destinatio_vault_id=None):
        ...
        :param progress: The param of the ReplicationRecordsExtraInfo
        :type progress: int
        :param fail_code: The param of the ReplicationRecordsExtraInfo
        :type fail_code: str
        :param fail_reason: The param of the ReplicationRecordsExtraInfo
        :type fail_reason: str
        :param auto_trigger: The param of the ReplicationRecordsExtraInfo
        :type auto_trigger: bool
        :param destinatio_vault_id: The param of the ReplicationRecordsExtraInfo
