...
class VaultUpdate:
    ...
    def __init__(self, billing=None, name=None, auto_bind=None, bind_rules=None, auto_expand=None, smn_notify=None, threshold=None):
        ...
        :param billing: The param of the VaultUpdate
        :type billing: :class:`g42cloudsdkcbr.v1.BillingUpdate`
        :param name: The param of the VaultUpdate
        :type name: str
        :param auto_bind: The param of the VaultUpdate
        :type auto_bind: bool
        :param bind_rules: The param of the VaultUpdate
        :type bind_rules: :class:`g42cloudsdkcbr.v1.VaultBindRules`
        :param auto_expand: The param of the VaultUpdate
        :type auto_expand: bool
        :param smn_notify: The param of the VaultUpdate
        :type smn_notify: bool
        :param threshold: The param of the VaultUpdate
        :type threshold: int
        """
    ...
    def billing(self):
        ...
        :rtype: :class:`g42cloudsdkcbr.v1.BillingUpdate`
        """
