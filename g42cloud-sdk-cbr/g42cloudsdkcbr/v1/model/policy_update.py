...
class PolicyUpdate:
    ...
    def __init__(self, enabled=None, name=None, operation_definition=None, trigger=None):
        ...
        :param enabled: The param of the PolicyUpdate
        :type enabled: bool
        :param name: The param of the PolicyUpdate
        :type name: str
        :param operation_definition: The param of the PolicyUpdate
        :type operation_definition: :class:`g42cloudsdkcbr.v1.PolicyoODCreate`
        :param trigger: The param of the PolicyUpdate
