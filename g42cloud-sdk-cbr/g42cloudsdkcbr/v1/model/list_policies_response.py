...
class ListPoliciesResponse(SdkResponse):
    ...
    def __init__(self, policies=None, count=None):
        ...
        :param policies: The param of the ListPoliciesResponse
        :type policies: list[:class:`g42cloudsdkcbr.v1.Policy`]
        :param count: The param of the ListPoliciesResponse
        :type count: int
        """
    ...
    def policies(self):
        ...
        :rtype: list[:class:`g42cloudsdkcbr.v1.Policy`]
        """
