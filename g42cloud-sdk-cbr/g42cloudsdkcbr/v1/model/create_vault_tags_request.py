...
class CreateVaultTagsRequest:
    ...
    def __init__(self, vault_id=None, body=None):
        ...
        :param vault_id: The param of the CreateVaultTagsRequest
        :type vault_id: str
        :param body: The param of the CreateVaultTagsRequest
        :type body: :class:`g42cloudsdkcbr.v1.VaultTagsCreateReq`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkcbr.v1.VaultTagsCreateReq`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateVaultTagsRequest):
            return False
