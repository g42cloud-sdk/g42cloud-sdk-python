...
class ProtectableResult:
    ...
    def __init__(self, code=None, reason=None, result=None, vault=None, message=None):
        ...
        :param code: The param of the ProtectableResult
        :type code: str
        :param reason: The param of the ProtectableResult
        :type reason: str
        :param result: The param of the ProtectableResult
        :type result: bool
        :param vault: The param of the ProtectableResult
        :type vault: :class:`g42cloudsdkcbr.v1.VaultGet`
        :param message: The param of the ProtectableResult
        :type message: str
        """
    ...
    def vault(self):
        ...
        :rtype: :class:`g42cloudsdkcbr.v1.VaultGet`
        """
        return self._vault
