...
class DisassociateVaultPolicyResponse(SdkResponse):
    ...
    def __init__(self, dissociate_policy=None):
        ...
        :param dissociate_policy: The param of the DisassociateVaultPolicyResponse
        :type dissociate_policy: :class:`g42cloudsdkcbr.v1.VaultPolicyResp`
        """
    ...
    def dissociate_policy(self):
        ...
        :rtype: :class:`g42cloudsdkcbr.v1.VaultPolicyResp`
        """
