...
class UpdateApplicationEndpointRequest:
    ...
    def __init__(self, endpoint_urn=None, body=None):
        ...
        :param endpoint_urn: The param of the UpdateApplicationEndpointRequest
        :type endpoint_urn: str
        :param body: The param of the UpdateApplicationEndpointRequest
        :type body: :class:`g42cloudsdksmn.v2.UpdateApplicationEndpointRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdksmn.v2.UpdateApplicationEndpointRequestBody`
        """
        return self._body
