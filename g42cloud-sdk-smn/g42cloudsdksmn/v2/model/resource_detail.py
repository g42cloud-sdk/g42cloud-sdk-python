...
class ResourceDetail:
    ...
    def __init__(self, enterprise_project_id=None, detail_id=None, topic_urn=None, display_name=None):
        ...
        :param enterprise_project_id: The param of the ResourceDetail
        :type enterprise_project_id: str
        :param detail_id: The param of the ResourceDetail
        :type detail_id: str
        :param topic_urn: The param of the ResourceDetail
        :type topic_urn: str
        :param display_name: The param of the ResourceDetail
