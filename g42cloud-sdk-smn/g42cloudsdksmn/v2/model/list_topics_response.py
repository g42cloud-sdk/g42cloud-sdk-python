...
class ListTopicsResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, topic_count=None, topics=None):
        ...
        :param request_id: The param of the ListTopicsResponse
        :type request_id: str
        :param topic_count: The param of the ListTopicsResponse
        :type topic_count: int
        :param topics: The param of the ListTopicsResponse
        :type topics: list[:class:`g42cloudsdksmn.v2.ListTopicsItem`]
        """
    ...
    def topics(self):
        ...
        :rtype: list[:class:`g42cloudsdksmn.v2.ListTopicsItem`]
        """
        return self._topics
