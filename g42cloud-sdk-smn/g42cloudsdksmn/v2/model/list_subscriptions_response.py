...
class ListSubscriptionsResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, subscription_count=None, subscriptions=None):
        ...
        :param request_id: The param of the ListSubscriptionsResponse
        :type request_id: str
        :param subscription_count: The param of the ListSubscriptionsResponse
        :type subscription_count: int
        :param subscriptions: The param of the ListSubscriptionsResponse
