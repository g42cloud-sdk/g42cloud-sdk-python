...
class ListApplicationsRequest:
    ...
    def __init__(self, offset=None, limit=None, name=None, platform=None):
        ...
        :param offset: The param of the ListApplicationsRequest
        :type offset: int
        :param limit: The param of the ListApplicationsRequest
        :type limit: int
        :param name: The param of the ListApplicationsRequest
        :type name: str
        :param platform: The param of the ListApplicationsRequest
        :type platform: str
        """
