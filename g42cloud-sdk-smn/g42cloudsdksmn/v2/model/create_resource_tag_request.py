...
class CreateResourceTagRequest:
    ...
    def __init__(self, resource_type=None, resource_id=None, body=None):
        ...
        :param resource_type: The param of the CreateResourceTagRequest
        :type resource_type: str
        :param resource_id: The param of the CreateResourceTagRequest
        :type resource_id: str
        :param body: The param of the CreateResourceTagRequest
        :type body: :class:`g42cloudsdksmn.v2.CreateResourceTagRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdksmn.v2.CreateResourceTagRequestBody`
        """
        return self._body
