...
class ListMessageTemplatesResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, message_template_count=None, message_templates=None):
        ...
        :param request_id: The param of the ListMessageTemplatesResponse
        :type request_id: str
        :param message_template_count: The param of the ListMessageTemplatesResponse
        :type message_template_count: int
        :param message_templates: The param of the ListMessageTemplatesResponse
        :type message_templates: list[:class:`g42cloudsdksmn.v2.MessageTemplate`]
        """
    ...
    def message_templates(self):
        ...
        :rtype: list[:class:`g42cloudsdksmn.v2.MessageTemplate`]
        """
