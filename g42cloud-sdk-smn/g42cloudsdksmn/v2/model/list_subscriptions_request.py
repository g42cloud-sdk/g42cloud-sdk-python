...
class ListSubscriptionsRequest:
    ...
    def __init__(self, offset=None, limit=None, protocol=None, status=None, endpoint=None):
        ...
        :param offset: The param of the ListSubscriptionsRequest
        :type offset: int
        :param limit: The param of the ListSubscriptionsRequest
        :type limit: int
        :param protocol: The param of the ListSubscriptionsRequest
        :type protocol: str
        :param status: The param of the ListSubscriptionsRequest
        :type status: int
        :param endpoint: The param of the ListSubscriptionsRequest
        :type endpoint: str
        """
