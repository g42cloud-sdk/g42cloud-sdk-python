...
class ListMessageTemplatesRequest:
    ...
    def __init__(self, offset=None, limit=None, message_template_name=None, protocol=None):
        ...
        :param offset: The param of the ListMessageTemplatesRequest
        :type offset: int
        :param limit: The param of the ListMessageTemplatesRequest
        :type limit: int
        :param message_template_name: The param of the ListMessageTemplatesRequest
        :type message_template_name: str
        :param protocol: The param of the ListMessageTemplatesRequest
        :type protocol: str
        """
