...
class ListApplicationAttributesResponseBodyAttributes:
    ...
    def __init__(self, enabled=None, apple_certificate_expiration_date=None):
        ...
        :param enabled: The param of the ListApplicationAttributesResponseBodyAttributes
        :type enabled: str
        :param apple_certificate_expiration_date: The param of the ListApplicationAttributesResponseBodyAttributes
