...
class PublishAppMessageRequest:
    ...
    def __init__(self, endpoint_urn=None, body=None):
        ...
        :param endpoint_urn: The param of the PublishAppMessageRequest
        :type endpoint_urn: str
        :param body: The param of the PublishAppMessageRequest
        :type body: :class:`g42cloudsdksmn.v2.PublishAppMessageRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdksmn.v2.PublishAppMessageRequestBody`
        """
        return self._body
