...
class CreateApplicationRequestBody:
    ...
    def __init__(self, name=None, platform=None, platform_principal=None, platform_credential=None):
        ...
        :param name: The param of the CreateApplicationRequestBody
        :type name: str
        :param platform: The param of the CreateApplicationRequestBody
        :type platform: str
        :param platform_principal: The param of the CreateApplicationRequestBody
        :type platform_principal: str
        :param platform_credential: The param of the CreateApplicationRequestBody
