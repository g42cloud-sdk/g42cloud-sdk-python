...
class ApplicationItem:
    ...
    def __init__(self, name=None, platform=None, create_time=None, application_urn=None, application_id=None, enabled=None, apple_certificate_expiration_date=None):
        ...
        :param name: The param of the ApplicationItem
        :type name: str
        :param platform: The param of the ApplicationItem
        :type platform: str
        :param create_time: The param of the ApplicationItem
        :type create_time: str
        :param application_urn: The param of the ApplicationItem
        :type application_urn: str
        :param application_id: The param of the ApplicationItem
        :type application_id: str
        :param enabled: The param of the ApplicationItem
        :type enabled: str
        :param apple_certificate_expiration_date: The param of the ApplicationItem
