...
class UpdateApplicationRequest:
    ...
    def __init__(self, application_urn=None, body=None):
        ...
        :param application_urn: The param of the UpdateApplicationRequest
        :type application_urn: str
        :param body: The param of the UpdateApplicationRequest
        :type body: :class:`g42cloudsdksmn.v2.UpdateApplicationRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdksmn.v2.UpdateApplicationRequestBody`
        """
        return self._body
