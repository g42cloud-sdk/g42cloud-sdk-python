...
class ListSubscriptionsByTopicResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, subscription_count=None, subscriptions=None):
        ...
        :param request_id: The param of the ListSubscriptionsByTopicResponse
        :type request_id: str
        :param subscription_count: The param of the ListSubscriptionsByTopicResponse
        :type subscription_count: int
        :param subscriptions: The param of the ListSubscriptionsByTopicResponse
        :type subscriptions: list[:class:`g42cloudsdksmn.v2.ListSubscriptionsItem`]
        """
    ...
    def subscriptions(self):
        ...
        :rtype: list[:class:`g42cloudsdksmn.v2.ListSubscriptionsItem`]
        """
