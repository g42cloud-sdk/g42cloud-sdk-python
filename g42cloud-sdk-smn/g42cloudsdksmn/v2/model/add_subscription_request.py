...
class AddSubscriptionRequest:
    ...
    def __init__(self, topic_urn=None, body=None):
        ...
        :param topic_urn: The param of the AddSubscriptionRequest
        :type topic_urn: str
        :param body: The param of the AddSubscriptionRequest
        :type body: :class:`g42cloudsdksmn.v2.AddSubscriptionRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdksmn.v2.AddSubscriptionRequestBody`
        """
        return self._body
