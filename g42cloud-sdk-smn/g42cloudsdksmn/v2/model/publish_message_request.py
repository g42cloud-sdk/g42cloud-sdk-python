...
class PublishMessageRequest:
    ...
    def __init__(self, topic_urn=None, body=None):
        ...
        :param topic_urn: The param of the PublishMessageRequest
        :type topic_urn: str
        :param body: The param of the PublishMessageRequest
        :type body: :class:`g42cloudsdksmn.v2.PublishMessageRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdksmn.v2.PublishMessageRequestBody`
        """
        return self._body
