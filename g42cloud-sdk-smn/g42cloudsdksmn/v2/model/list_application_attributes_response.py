...
class ListApplicationAttributesResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, application_id=None, attributes=None):
        ...
        :param request_id: The param of the ListApplicationAttributesResponse
        :type request_id: str
        :param application_id: The param of the ListApplicationAttributesResponse
        :type application_id: str
        :param attributes: The param of the ListApplicationAttributesResponse
        :type attributes: :class:`g42cloudsdksmn.v2.ListApplicationAttributesResponseBodyAttributes`
        """
    ...
    def attributes(self):
        ...
        :rtype: :class:`g42cloudsdksmn.v2.ListApplicationAttributesResponseBodyAttributes`
        """
