...
class UpdateMessageTemplateRequest:
    ...
    def __init__(self, message_template_id=None, body=None):
        ...
        :param message_template_id: The param of the UpdateMessageTemplateRequest
        :type message_template_id: str
        :param body: The param of the UpdateMessageTemplateRequest
        :type body: :class:`g42cloudsdksmn.v2.UpdateMessageTemplateRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdksmn.v2.UpdateMessageTemplateRequestBody`
        """
        return self._body
