...
class CreateApplicationEndpointRequest:
    ...
    def __init__(self, application_urn=None, body=None):
        ...
        :param application_urn: The param of the CreateApplicationEndpointRequest
        :type application_urn: str
        :param body: The param of the CreateApplicationEndpointRequest
        :type body: :class:`g42cloudsdksmn.v2.CreateApplicationEndpointRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdksmn.v2.CreateApplicationEndpointRequestBody`
        """
        return self._body
