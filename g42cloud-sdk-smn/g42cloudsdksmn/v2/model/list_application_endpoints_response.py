...
class ListApplicationEndpointsResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, next_page_flag=None, endpoints=None):
        ...
        :param request_id: The param of the ListApplicationEndpointsResponse
        :type request_id: str
        :param next_page_flag: The param of the ListApplicationEndpointsResponse
        :type next_page_flag: bool
        :param endpoints: The param of the ListApplicationEndpointsResponse
        :type endpoints: list[:class:`g42cloudsdksmn.v2.ApplicationEndpoint`]
        """
    ...
    def endpoints(self):
        ...
        :rtype: list[:class:`g42cloudsdksmn.v2.ApplicationEndpoint`]
        """
