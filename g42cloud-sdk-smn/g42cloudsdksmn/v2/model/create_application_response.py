...
class CreateApplicationResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, application_urn=None, application_id=None):
        ...
        :param request_id: The param of the CreateApplicationResponse
        :type request_id: str
        :param application_urn: The param of the CreateApplicationResponse
        :type application_urn: str
        :param application_id: The param of the CreateApplicationResponse
