...
class ListResourceInstancesResponse(SdkResponse):
    ...
    def __init__(self, resources=None, total_count=None):
        ...
        :param resources: The param of the ListResourceInstancesResponse
        :type resources: list[:class:`g42cloudsdksmn.v2.TagResource`]
        :param total_count: The param of the ListResourceInstancesResponse
    ...
    def resources(self):
        ...
        :rtype: list[:class:`g42cloudsdksmn.v2.TagResource`]
        """
