...
class ListApplicationEndpointsRequest:
    ...
    def __init__(self, application_urn=None, offset=None, limit=None, enabled=None, token=None, user_data=None):
        ...
        :param application_urn: The param of the ListApplicationEndpointsRequest
        :type application_urn: str
        :param offset: The param of the ListApplicationEndpointsRequest
        :type offset: int
        :param limit: The param of the ListApplicationEndpointsRequest
        :type limit: int
        :param enabled: The param of the ListApplicationEndpointsRequest
        :type enabled: str
        :param token: The param of the ListApplicationEndpointsRequest
        :type token: str
        :param user_data: The param of the ListApplicationEndpointsRequest
        :type user_data: str
        """
