...
class CreateTopicRequestBody:
    ...
    def __init__(self, name=None, display_name=None, enterprise_project_id=None):
        ...
        :param name: The param of the CreateTopicRequestBody
        :type name: str
        :param display_name: The param of the CreateTopicRequestBody
        :type display_name: str
        :param enterprise_project_id: The param of the CreateTopicRequestBody
