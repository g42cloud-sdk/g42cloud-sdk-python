...
class BatchCreateOrDeleteResourceTagsRequestBody:
    ...
    def __init__(self, tags=None, action=None):
        ...
        :param tags: The param of the BatchCreateOrDeleteResourceTagsRequestBody
        :type tags: list[:class:`g42cloudsdksmn.v2.ResourceTag`]
        :param action: The param of the BatchCreateOrDeleteResourceTagsRequestBody
        :type action: str
        """
    ...
    def tags(self):
        ...
        :rtype: list[:class:`g42cloudsdksmn.v2.ResourceTag`]
        """
        return self._tags
