...
class ListResourceInstancesRequest:
    ...
    def __init__(self, resource_type=None, body=None):
        ...
        :param resource_type: The param of the ListResourceInstancesRequest
        :type resource_type: str
        :param body: The param of the ListResourceInstancesRequest
        :type body: :class:`g42cloudsdksmn.v2.ListInstanceRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdksmn.v2.ListInstanceRequestBody`
        """
        return self._body
