...
class ListApplicationEndpointAttributesResponseBodyAttributes:
    ...
    def __init__(self, enabled=None, token=None, user_data=None):
        ...
        :param enabled: The param of the ListApplicationEndpointAttributesResponseBodyAttributes
        :type enabled: str
        :param token: The param of the ListApplicationEndpointAttributesResponseBodyAttributes
        :type token: str
        :param user_data: The param of the ListApplicationEndpointAttributesResponseBodyAttributes
        :type user_data: str
        """
