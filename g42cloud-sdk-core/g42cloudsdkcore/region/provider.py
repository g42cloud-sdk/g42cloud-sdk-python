...
from g42cloudsdkcore.region.cache import ProfileRegionCache, EnvRegionCache
from g42cloudsdkcore.region.region import Region

from g42cloudsdkcore.utils import six_utils
...
class EnvRegionProvider(RegionProvider):
    _REGION_ENV_PREFIX = "G42CLOUD_SDK_REGION"
