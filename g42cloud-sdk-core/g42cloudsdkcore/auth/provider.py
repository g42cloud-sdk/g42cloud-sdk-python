...
from g42cloudsdkcore.utils import six_utils, filepath_utils
from g42cloudsdkcore.auth.credentials import BasicCredentials, GlobalCredentials
from g42cloudsdkcore.exceptions.exceptions import ApiTypeError, ApiValueError, SdkException
...
class EnvCredentialProvider(CredentialProvider):
    _AK_ENV_NAME = "G42CLOUD_SDK_AK"
    _SK_ENV_NAME = "G42CLOUD_SDK_SK"
    _PROJECT_ID_ENV_NAME = "G42CLOUD_SDK_PROJECT_ID"
    _DOMAIN_ID_ENV_NAME = "G42CLOUD_SDK_DOMAIN_ID"
    _SECURITY_TOKEN_ENV_NAME = "G42CLOUD_SDK_SECURITY_TOKEN"
    _IDP_ID_ENV_NAME = "G42CLOUD_SDK_IDP_ID"
    _ID_TOKEN_FILE_ENV_NAME = "G42CLOUD_SDK_ID_TOKEN_FILE"
...
class ProfileCredentialProvider(CredentialProvider):
    _CREDENTIALS_FILE_ENV_NAME = "G42CLOUD_SDK_CREDENTIALS_FILE"
    _DEFAULT_CREDENTIALS_FILE_DIR = ".g42cloud"
