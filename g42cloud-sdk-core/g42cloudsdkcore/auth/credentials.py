...
from g42cloudsdkcore.exceptions.exceptions import ApiValueError, ServiceResponseException
from g42cloudsdkcore.signer.signer import Signer, DerivationAKSKSigner
...
class DerivedCredentials(six_utils.get_abstract_meta_class()):
    _DEFAULT_ENDPOINT_REG = "^[a-z][a-z0-9-]+(\\.[a-z]{2,}-[a-z]+-\\d{1,2})?\\.(my)?(g42cloud|myhwclouds).(com|cn)"
...
class GlobalCredentials(Credentials):
    ...
    def __init__(self, ak=None, sk=None, domain_id=None):
        ...
        :param ak: The access key ID for your account
        :param sk: The secret access key for your account
        :param domain_id: The account ID of G42 Cloud
        """
