...
from g42cloudsdkcore.auth import provider
from g42cloudsdkcore.utils import path_utils
from g42cloudsdkcore.auth.credentials import BasicCredentials, GlobalCredentials
from g42cloudsdkcore.exceptions.exceptions import ApiValueError
...
def _clear_envs():
    keys = (key for key in os.environ.keys() if key.startswith("G42CLOUD_SDK"))
    for key in keys:
        os.environ.pop(key)
...
class TestEnvCredentialProvider:
    ...
    def test_ak_auth_with_basic_type(self):
        p = provider.EnvCredentialProvider.get_basic_credential_env_provider()
        os.environ["G42CLOUD_SDK_AK"] = AK
        os.environ["G42CLOUD_SDK_SK"] = SK
        os.environ["G42CLOUD_SDK_PROJECT_ID"] = PROJECT_ID
        os.environ["G42CLOUD_SDK_SECURITY_TOKEN"] = SECURITY_TOKEN
    ...
    def test_id_token_auth_with_basic_type(self):
        p = provider.EnvCredentialProvider.get_basic_credential_env_provider()
        os.environ["G42CLOUD_SDK_IDP_ID"] = IDP_ID
        os.environ["G42CLOUD_SDK_ID_TOKEN_FILE"] = ID_TOKEN_FILE
        os.environ["G42CLOUD_SDK_PROJECT_ID"] = PROJECT_ID
        actual = p.get_credentials()
    ...
    def test_ak_auth_with_global_type(self):
        ...
        os.environ["G42CLOUD_SDK_AK"] = AK
        os.environ["G42CLOUD_SDK_SK"] = SK
        os.environ["G42CLOUD_SDK_DOMAIN_ID"] = DOMAIN_ID
        os.environ["G42CLOUD_SDK_SECURITY_TOKEN"] = SECURITY_TOKEN
        actual = p.get_credentials()
...
class TestProfileCredentialProvider:
    CREDENTIALS_FILE_ENV_NAME = "G42CLOUD_SDK_CREDENTIALS_FILE"
    ...
    def test_file_not_exist(self):
        ...
        try:
            ...
            os.environ["G42CLOUD_SDK_CREDENTIALS_FILE"] = self.TEST_CREDENTIALS_FILE
...
class TestCredentialProviderChain:
    ...
    def test_custom_providers(self):
        ...
        os.environ["G42CLOUD_SDK_CREDENTIALS_FILE"] = path
