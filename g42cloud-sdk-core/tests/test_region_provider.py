...
from g42cloudsdkcore.region.cache import EnvRegionCache, ProfileRegionCache
from g42cloudsdkcore.region.provider import EnvRegionProvider, ProfileRegionProvider, RegionProviderChain
...
ENDPOINT = "https://{}.{}.myg42cloud.com".format(SERVICE_NAME.lower(), REGION_ID)
REGION_STR = """SERVICE:
  - id: region-id-1
    endpoint: 'https://service.region-id-1.myg42cloud.com'
"""
...
def test_env_region_provider():
    ...
    # test found
    env_name = "G42CLOUD_SDK_REGION_{}_{}".format(SERVICE_NAME.upper(), REGION_ID.replace("-", "_").upper())
...
def test_profile_region_provider():
    ...
    os.environ["G42CLOUD_SDK_REGIONS_FILE"] = path
