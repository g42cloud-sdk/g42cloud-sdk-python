...
class MbTaskParameter:
    ...
    def __init__(self, status_description=None, output_filename=None, metadata=None):
        ...
        :param status_description: The param of the MbTaskParameter
        :type status_description: str
        :param output_filename: The param of the MbTaskParameter
        :type output_filename: str
        :param metadata: The param of the MbTaskParameter
