...
class CreateTranscodingReq:
    ...
    def __init__(self, input=None, output=None, trans_template_id=None, av_parameters=None, output_filenames=None, user_data=None, watermarks=None, thumbnail=None, priority=None, subtitle=None, encryption=None, crop=None, audio_track=None, multi_audio=None, video_process=None, audio_process=None):
        ...
        :param input: The param of the CreateTranscodingReq
        :type input: :class:`g42cloudsdkmpc.v1.ObsObjInfo`
        :param output: The param of the CreateTranscodingReq
        :type output: :class:`g42cloudsdkmpc.v1.ObsObjInfo`
        :param trans_template_id: The param of the CreateTranscodingReq
        :type trans_template_id: list[int]
        :param av_parameters: The param of the CreateTranscodingReq
        :type av_parameters: list[:class:`g42cloudsdkmpc.v1.AvParameters`]
        :param output_filenames: The param of the CreateTranscodingReq
        :type output_filenames: list[str]
        :param user_data: The param of the CreateTranscodingReq
        :type user_data: str
        :param watermarks: The param of the CreateTranscodingReq
        :type watermarks: list[:class:`g42cloudsdkmpc.v1.WatermarkRequest`]
        :param thumbnail: The param of the CreateTranscodingReq
        :type thumbnail: :class:`g42cloudsdkmpc.v1.Thumbnail`
        :param priority: The param of the CreateTranscodingReq
        :type priority: int
        :param subtitle: The param of the CreateTranscodingReq
        :type subtitle: :class:`g42cloudsdkmpc.v1.Subtitle`
        :param encryption: The param of the CreateTranscodingReq
        :type encryption: :class:`g42cloudsdkmpc.v1.Encryption`
        :param crop: The param of the CreateTranscodingReq
        :type crop: :class:`g42cloudsdkmpc.v1.Crop`
        :param audio_track: The param of the CreateTranscodingReq
        :type audio_track: :class:`g42cloudsdkmpc.v1.AudioTrack`
        :param multi_audio: The param of the CreateTranscodingReq
        :type multi_audio: :class:`g42cloudsdkmpc.v1.MultiAudio`
        :param video_process: The param of the CreateTranscodingReq
        :type video_process: :class:`g42cloudsdkmpc.v1.VideoProcess`
        :param audio_process: The param of the CreateTranscodingReq
        :type audio_process: :class:`g42cloudsdkmpc.v1.AudioProcess`
        """
    ...
    def watermarks(self):
        ...
        :rtype: list[:class:`g42cloudsdkmpc.v1.WatermarkRequest`]
        """
    ...
    def thumbnail(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.Thumbnail`
        """
    ...
    def subtitle(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.Subtitle`
        """
    ...
    def encryption(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.Encryption`
        """
    ...
    def crop(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.Crop`
        """
        return self._crop
    ...
    def audio_track(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.AudioTrack`
        """
    ...
    def multi_audio(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.MultiAudio`
        """
    ...
    def video_process(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.VideoProcess`
        """
    ...
    def audio_process(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.AudioProcess`
        """
