...
class EditingJob:
    ...
    def __init__(self, task_id=None, status=None, create_time=None, start_time=None, end_time=None, error_code=None, description=None, user_data=None, job_id=None, edit_type=None, output=None, edit_task_req=None, output_file_info=None):
        ...
        :param task_id: The param of the EditingJob
        :type task_id: str
        :param status: The param of the EditingJob
        :type status: str
        :param create_time: The param of the EditingJob
        :type create_time: str
        :param start_time: The param of the EditingJob
        :type start_time: str
        :param end_time: The param of the EditingJob
        :type end_time: str
        :param error_code: The param of the EditingJob
        :type error_code: str
        :param description: The param of the EditingJob
        :type description: str
        :param user_data: The param of the EditingJob
        :type user_data: str
        :param job_id: The param of the EditingJob
        :type job_id: str
        :param edit_type: The param of the EditingJob
        :type edit_type: list[str]
        :param output: The param of the EditingJob
        :type output: :class:`g42cloudsdkmpc.v1.ObsObjInfo`
        :param edit_task_req: The param of the EditingJob
        :type edit_task_req: :class:`g42cloudsdkmpc.v1.CreateEditingJobReq`
        :param output_file_info: The param of the EditingJob
        :type output_file_info: list[:class:`g42cloudsdkmpc.v1.OutputFileInfo`]
        """
    ...
    def edit_task_req(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.CreateEditingJobReq`
        """
    ...
    def output_file_info(self):
        ...
        :rtype: list[:class:`g42cloudsdkmpc.v1.OutputFileInfo`]
        """
