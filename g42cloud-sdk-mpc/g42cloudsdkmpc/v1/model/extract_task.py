...
class ExtractTask:
    ...
    def __init__(self, task_id=None, status=None, create_time=None, start_time=None, end_time=None, error_code=None, description=None, user_data=None, input=None, output=None, metadata=None):
        ...
        :param task_id: The param of the ExtractTask
        :type task_id: str
        :param status: The param of the ExtractTask
        :type status: str
        :param create_time: The param of the ExtractTask
        :type create_time: str
        :param start_time: The param of the ExtractTask
        :type start_time: str
        :param end_time: The param of the ExtractTask
        :type end_time: str
        :param error_code: The param of the ExtractTask
        :type error_code: str
        :param description: The param of the ExtractTask
        :type description: str
        :param user_data: The param of the ExtractTask
        :type user_data: str
        :param input: The param of the ExtractTask
        :type input: :class:`g42cloudsdkmpc.v1.ObsObjInfo`
        :param output: The param of the ExtractTask
        :type output: :class:`g42cloudsdkmpc.v1.ObsObjInfo`
        :param metadata: The param of the ExtractTask
