...
class OutputFileInfo:
    ...
    def __init__(self, output_file_name=None, exec_description=None, meta_data=None):
        ...
        :param output_file_name: The param of the OutputFileInfo
        :type output_file_name: str
        :param exec_description: The param of the OutputFileInfo
        :type exec_description: str
        :param meta_data: The param of the OutputFileInfo
        :type meta_data: :class:`g42cloudsdkmpc.v1.SourceInfo`
        """
