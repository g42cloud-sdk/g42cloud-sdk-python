...
class MpeCallBackReq:
    ...
    def __init__(self, task_type=None, task_id=None, status=None, complete_ratio=None, description=None, meta_data=None):
        ...
        :param task_type: The param of the MpeCallBackReq
        :type task_type: str
        :param task_id: The param of the MpeCallBackReq
        :type task_id: str
        :param status: The param of the MpeCallBackReq
        :type status: str
        :param complete_ratio: The param of the MpeCallBackReq
        :type complete_ratio: int
        :param description: The param of the MpeCallBackReq
        :type description: str
        :param meta_data: The param of the MpeCallBackReq
        :type meta_data: :class:`g42cloudsdkmpc.v1.MpeMetaData`
        """
    ...
    def meta_data(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.MpeMetaData`
        """
