...
class CreateMergeChannelsReq:
    ...
    def __init__(self, multi_audio=None):
        ...
        :param multi_audio: The param of the CreateMergeChannelsReq
        :type multi_audio: :class:`g42cloudsdkmpc.v1.MpcMultiAudio`
        """
    ...
    def multi_audio(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.MpcMultiAudio`
        """
