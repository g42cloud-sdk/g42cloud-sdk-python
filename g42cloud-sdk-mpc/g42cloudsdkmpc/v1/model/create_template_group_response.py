...
class CreateTemplateGroupResponse(SdkResponse):
    ...
    def __init__(self, template_group=None):
        ...
        :param template_group: The param of the CreateTemplateGroupResponse
        :type template_group: :class:`g42cloudsdkmpc.v1.TemplateGroup`
        """
    ...
    def template_group(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.TemplateGroup`
        """
