...
class ListTemplateGroupResponse(SdkResponse):
    ...
    def __init__(self, template_group_list=None, total=None):
        ...
        :param template_group_list: The param of the ListTemplateGroupResponse
        :type template_group_list: list[:class:`g42cloudsdkmpc.v1.TemplateGroup`]
        :param total: The param of the ListTemplateGroupResponse
        :type total: int
        """
    ...
    def template_group_list(self):
        ...
        :rtype: list[:class:`g42cloudsdkmpc.v1.TemplateGroup`]
        """
