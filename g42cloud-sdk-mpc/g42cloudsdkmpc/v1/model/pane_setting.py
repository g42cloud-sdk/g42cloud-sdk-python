...
class PaneSetting:
    ...
    def __init__(self, pane_id=None, x=None, y=None, width=None, height=None):
        ...
        :param pane_id: The param of the PaneSetting
        :type pane_id: str
        :param x: The param of the PaneSetting
        :type x: str
        :param y: The param of the PaneSetting
        :type y: str
        :param width: The param of the PaneSetting
        :type width: str
        :param height: The param of the PaneSetting
        :type height: str
        """
