...
class QualityEnhanceTemplateInfo:
    ...
    def __init__(self, template_id=None, template=None, error=None):
        ...
        :param template_id: The param of the QualityEnhanceTemplateInfo
        :type template_id: int
        :param template: The param of the QualityEnhanceTemplateInfo
        :type template: :class:`g42cloudsdkmpc.v1.QualityEnhanceTemplate`
        :param error: The param of the QualityEnhanceTemplateInfo
    ...
    def template(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.QualityEnhanceTemplate`
        """
