...
class Notification:
    ...
    def __init__(self, event_name=None, status=None, topic=None, msg_type=None):
        ...
        :param event_name: The param of the Notification
        :type event_name: str
        :param status: The param of the Notification
        :type status: str
        :param topic: The param of the Notification
        :type topic: str
        :param msg_type: The param of the Notification
        :type msg_type: int
        """
