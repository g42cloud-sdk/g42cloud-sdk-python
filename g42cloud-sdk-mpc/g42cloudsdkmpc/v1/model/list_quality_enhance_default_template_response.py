...
class ListQualityEnhanceDefaultTemplateResponse(SdkResponse):
    ...
    def __init__(self, task_array=None, total=None):
        ...
        :param task_array: The param of the ListQualityEnhanceDefaultTemplateResponse
        :type task_array: list[:class:`g42cloudsdkmpc.v1.QualityEnhanceTemplateInfo`]
        :param total: The param of the ListQualityEnhanceDefaultTemplateResponse
        :type total: int
        """
    ...
    def task_array(self):
        ...
        :rtype: list[:class:`g42cloudsdkmpc.v1.QualityEnhanceTemplateInfo`]
        """
