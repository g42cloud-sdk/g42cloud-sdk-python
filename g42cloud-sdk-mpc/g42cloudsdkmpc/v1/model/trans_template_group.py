...
class TransTemplateGroup:
    ...
    def __init__(self, name=None, videos=None, audio=None, video_common=None, common=None):
        ...
        :param name: The param of the TransTemplateGroup
        :type name: str
        :param videos: The param of the TransTemplateGroup
        :type videos: list[:class:`g42cloudsdkmpc.v1.VideoObj`]
        :param audio: The param of the TransTemplateGroup
        :type audio: :class:`g42cloudsdkmpc.v1.Audio`
        :param video_common: The param of the TransTemplateGroup
        :type video_common: :class:`g42cloudsdkmpc.v1.VideoCommon`
        :param common: The param of the TransTemplateGroup
