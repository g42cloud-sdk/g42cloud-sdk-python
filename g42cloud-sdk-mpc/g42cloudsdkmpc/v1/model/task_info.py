...
class TaskInfo:
    ...
    def __init__(self, task_id=None, status=None, create_time=None, end_time=None, output=None, description=None, output_file_name=None, input=None):
        ...
        :param task_id: The param of the TaskInfo
        :type task_id: str
        :param status: The param of the TaskInfo
        :type status: str
        :param create_time: The param of the TaskInfo
        :type create_time: str
        :param end_time: The param of the TaskInfo
        :type end_time: str
        :param output: The param of the TaskInfo
        :type output: :class:`g42cloudsdkmpc.v1.ObsObjInfo`
        :param description: The param of the TaskInfo
        :type description: str
        :param output_file_name: The param of the TaskInfo
        :type output_file_name: list[str]
        :param input: The param of the TaskInfo
