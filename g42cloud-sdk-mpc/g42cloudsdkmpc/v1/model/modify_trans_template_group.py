...
class ModifyTransTemplateGroup:
    ...
    def __init__(self, group_id=None, name=None, videos=None, audio=None, video_common=None, common=None):
        ...
        :param group_id: The param of the ModifyTransTemplateGroup
        :type group_id: str
        :param name: The param of the ModifyTransTemplateGroup
        :type name: str
        :param videos: The param of the ModifyTransTemplateGroup
        :type videos: list[:class:`g42cloudsdkmpc.v1.VideoObj`]
        :param audio: The param of the ModifyTransTemplateGroup
        :type audio: :class:`g42cloudsdkmpc.v1.Audio`
        :param video_common: The param of the ModifyTransTemplateGroup
        :type video_common: :class:`g42cloudsdkmpc.v1.VideoCommon`
        :param common: The param of the ModifyTransTemplateGroup
    ...
    def videos(self):
        ...
        :rtype: list[:class:`g42cloudsdkmpc.v1.VideoObj`]
        """
        return self._videos
    ...
    def video_common(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.VideoCommon`
        """
