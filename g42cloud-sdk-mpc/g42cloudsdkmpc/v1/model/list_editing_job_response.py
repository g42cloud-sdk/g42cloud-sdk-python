...
class ListEditingJobResponse(SdkResponse):
    ...
    def __init__(self, total=None, jobs=None):
        ...
        :param total: The param of the ListEditingJobResponse
        :type total: int
        :param jobs: The param of the ListEditingJobResponse
        :type jobs: list[:class:`g42cloudsdkmpc.v1.EditingJob`]
        """
    ...
    def jobs(self):
        ...
        :rtype: list[:class:`g42cloudsdkmpc.v1.EditingJob`]
        """
        return self._jobs
