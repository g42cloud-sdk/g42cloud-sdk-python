...
class ListTranscodeDetailResponse(SdkResponse):
    ...
    def __init__(self, task_array=None):
        ...
        :param task_array: The param of the ListTranscodeDetailResponse
        :type task_array: list[:class:`g42cloudsdkmpc.v1.TaskDetailInfo`]
        """
    ...
    def task_array(self):
        ...
        :rtype: list[:class:`g42cloudsdkmpc.v1.TaskDetailInfo`]
        """
