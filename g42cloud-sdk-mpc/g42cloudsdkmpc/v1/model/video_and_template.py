...
class VideoAndTemplate:
    ...
    def __init__(self, template_id=None, width=None, height=None, bitrate=None):
        ...
        :param template_id: The param of the VideoAndTemplate
        :type template_id: int
        :param width: The param of the VideoAndTemplate
        :type width: int
        :param height: The param of the VideoAndTemplate
        :type height: int
        :param bitrate: The param of the VideoAndTemplate
        :type bitrate: int
        """
