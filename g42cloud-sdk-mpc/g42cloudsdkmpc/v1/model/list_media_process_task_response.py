...
class ListMediaProcessTaskResponse(SdkResponse):
    ...
    def __init__(self, task_array=None, is_truncated=None, total=None):
        ...
        :param task_array: The param of the ListMediaProcessTaskResponse
        :type task_array: list[:class:`g42cloudsdkmpc.v1.MediaProcessTaskInfo`]
        :param is_truncated: The param of the ListMediaProcessTaskResponse
        :type is_truncated: int
        :param total: The param of the ListMediaProcessTaskResponse
        :type total: int
        """
    ...
    def task_array(self):
        ...
        :rtype: list[:class:`g42cloudsdkmpc.v1.MediaProcessTaskInfo`]
        """
