...
class RemuxOutputParam:
    ...
    def __init__(self, format=None, segment_duration=None, remove_meta=None):
        ...
        :param format: The param of the RemuxOutputParam
        :type format: str
        :param segment_duration: The param of the RemuxOutputParam
        :type segment_duration: int
        :param remove_meta: The param of the RemuxOutputParam
