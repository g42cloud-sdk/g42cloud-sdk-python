...
class ModifyTransTemplateReq:
    ...
    def __init__(self, template_id=None, template_name=None, video=None, audio=None, common=None):
        ...
        :param template_id: The param of the ModifyTransTemplateReq
        :type template_id: int
        :param template_name: The param of the ModifyTransTemplateReq
        :type template_name: str
        :param video: The param of the ModifyTransTemplateReq
        :type video: :class:`g42cloudsdkmpc.v1.Video`
        :param audio: The param of the ModifyTransTemplateReq
        :type audio: :class:`g42cloudsdkmpc.v1.Audio`
        :param common: The param of the ModifyTransTemplateReq
