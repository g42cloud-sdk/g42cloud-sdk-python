...
class AnimatedGraphicsTask:
    ...
    def __init__(self, task_id=None, status=None, create_time=None, start_time=None, end_time=None, error_code=None, description=None, user_data=None, input=None, output=None, output_param=None):
        ...
        :param task_id: The param of the AnimatedGraphicsTask
        :type task_id: str
        :param status: The param of the AnimatedGraphicsTask
        :type status: str
        :param create_time: The param of the AnimatedGraphicsTask
        :type create_time: str
        :param start_time: The param of the AnimatedGraphicsTask
        :type start_time: str
        :param end_time: The param of the AnimatedGraphicsTask
        :type end_time: str
        :param error_code: The param of the AnimatedGraphicsTask
        :type error_code: str
        :param description: The param of the AnimatedGraphicsTask
        :type description: str
        :param user_data: The param of the AnimatedGraphicsTask
        :type user_data: str
        :param input: The param of the AnimatedGraphicsTask
        :type input: :class:`g42cloudsdkmpc.v1.ObsObjInfo`
        :param output: The param of the AnimatedGraphicsTask
        :type output: :class:`g42cloudsdkmpc.v1.ObsObjInfo`
        :param output_param: The param of the AnimatedGraphicsTask
        :type output_param: :class:`g42cloudsdkmpc.v1.AnimatedGraphicsOutputParam`
        """
    ...
    def output_param(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.AnimatedGraphicsOutputParam`
        """
