...
class ListAnimatedGraphicsTaskRequest:
    ...
    def __init__(self, authorization=None, x_project_id=None, x_sdk_date=None, x_language=None, task_id=None, status=None, start_time=None, end_time=None, page=None, size=None):
        ...
        :param status: The param of the ListAnimatedGraphicsTaskRequest
        :type status: str
        :param start_time: The param of the ListAnimatedGraphicsTaskRequest
        :type start_time: str
        :param end_time: The param of the ListAnimatedGraphicsTaskRequest
        :type end_time: str
        :param page: The param of the ListAnimatedGraphicsTaskRequest
        :type page: int
        :param size: The param of the ListAnimatedGraphicsTaskRequest
        :type size: int
        """
