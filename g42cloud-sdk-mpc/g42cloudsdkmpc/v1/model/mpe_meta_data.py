...
class MpeMetaData:
    ...
    def __init__(self, pack_type=None, duration=None, video_size=None, width=None, height=None, bit_rate=None, audio_bit_rate=None, frame_rate=None, codec_name=None, audio_codec_name=None, channels=None, sample=None, is_audio=None):
        ...
        :param pack_type: The param of the MpeMetaData
        :type pack_type: str
        :param duration: The param of the MpeMetaData
        :type duration: float
        :param video_size: The param of the MpeMetaData
        :type video_size: int
        :param width: The param of the MpeMetaData
        :type width: int
        :param height: The param of the MpeMetaData
        :type height: int
        :param bit_rate: The param of the MpeMetaData
        :type bit_rate: int
        :param audio_bit_rate: The param of the MpeMetaData
        :type audio_bit_rate: int
        :param frame_rate: The param of the MpeMetaData
        :type frame_rate: int
        :param codec_name: The param of the MpeMetaData
        :type codec_name: str
        :param audio_codec_name: The param of the MpeMetaData
        :type audio_codec_name: str
        :param channels: The param of the MpeMetaData
        :type channels: int
        :param sample: The param of the MpeMetaData
        :type sample: int
        :param is_audio: The param of the MpeMetaData
        :type is_audio: bool
        """
