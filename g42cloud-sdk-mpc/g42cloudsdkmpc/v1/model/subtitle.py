...
class Subtitle:
    ...
    def __init__(self, input=None, inputs=None, subtitle_type=None):
        ...
        :param input: The param of the Subtitle
        :type input: :class:`g42cloudsdkmpc.v1.ObsObjInfo`
        :param inputs: The param of the Subtitle
        :type inputs: list[:class:`g42cloudsdkmpc.v1.MulInputFileInfo`]
        :param subtitle_type: The param of the Subtitle
    ...
    def inputs(self):
        ...
        :rtype: list[:class:`g42cloudsdkmpc.v1.MulInputFileInfo`]
        """
        return self._inputs
