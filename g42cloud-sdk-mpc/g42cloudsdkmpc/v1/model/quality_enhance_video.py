...
class QualityEnhanceVideo:
    ...
    def __init__(self, video_denoise=None, video_sharp=None, video_contrast=None, video_superresolution=None, video_deblock=None, video_saturation=None):
        ...
        :param video_denoise: The param of the QualityEnhanceVideo
        :type video_denoise: :class:`g42cloudsdkmpc.v1.VideoDenoise`
        :param video_sharp: The param of the QualityEnhanceVideo
        :type video_sharp: :class:`g42cloudsdkmpc.v1.VideoSharp`
        :param video_contrast: The param of the QualityEnhanceVideo
        :type video_contrast: :class:`g42cloudsdkmpc.v1.VideoContrast`
        :param video_superresolution: The param of the QualityEnhanceVideo
        :type video_superresolution: :class:`g42cloudsdkmpc.v1.VideoSuperresolution`
        :param video_deblock: The param of the QualityEnhanceVideo
        :type video_deblock: :class:`g42cloudsdkmpc.v1.VideoDeblock`
        :param video_saturation: The param of the QualityEnhanceVideo
        :type video_saturation: :class:`g42cloudsdkmpc.v1.VideoSaturation`
        """
    ...
    def video_denoise(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.VideoDenoise`
        """
    ...
    def video_sharp(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.VideoSharp`
        """
    ...
    def video_contrast(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.VideoContrast`
        """
    ...
    def video_superresolution(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.VideoSuperresolution`
        """
    ...
    def video_deblock(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.VideoDeblock`
        """
    ...
    def video_saturation(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.VideoSaturation`
        """
