...
class CreateAnimatedGraphicsTaskReq:
    ...
    def __init__(self, input=None, output=None, user_data=None, output_param=None):
        ...
        :param input: The param of the CreateAnimatedGraphicsTaskReq
        :type input: :class:`g42cloudsdkmpc.v1.ObsObjInfo`
        :param output: The param of the CreateAnimatedGraphicsTaskReq
        :type output: :class:`g42cloudsdkmpc.v1.ObsObjInfo`
        :param user_data: The param of the CreateAnimatedGraphicsTaskReq
        :type user_data: str
        :param output_param: The param of the CreateAnimatedGraphicsTaskReq
