...
class CreateExtractTaskReq:
    ...
    def __init__(self, input=None, output=None, user_data=None, sync=None):
        ...
        :param input: The param of the CreateExtractTaskReq
        :type input: :class:`g42cloudsdkmpc.v1.ObsObjInfo`
        :param output: The param of the CreateExtractTaskReq
        :type output: :class:`g42cloudsdkmpc.v1.ObsObjInfo`
        :param user_data: The param of the CreateExtractTaskReq
        :type user_data: str
        :param sync: The param of the CreateExtractTaskReq
        :type sync: int
        """
