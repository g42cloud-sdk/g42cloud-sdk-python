...
class VideoSuperresolution:
    ...
    def __init__(self, name=None, execution_order=None, scale=None):
        ...
        :param name: The param of the VideoSuperresolution
        :type name: str
        :param execution_order: The param of the VideoSuperresolution
        :type execution_order: int
        :param scale: The param of the VideoSuperresolution
        :type scale: str
        """
