...
class ListWatermarkTemplateResponse(SdkResponse):
    ...
    def __init__(self, total=None, templates=None):
        ...
        :param total: The param of the ListWatermarkTemplateResponse
        :type total: int
        :param templates: The param of the ListWatermarkTemplateResponse
        :type templates: list[:class:`g42cloudsdkmpc.v1.WatermarkTemplate`]
        """
    ...
    def templates(self):
        ...
        :rtype: list[:class:`g42cloudsdkmpc.v1.WatermarkTemplate`]
        """
