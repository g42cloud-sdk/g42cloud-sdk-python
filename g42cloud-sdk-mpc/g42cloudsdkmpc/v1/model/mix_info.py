...
class MixInfo:
    ...
    def __init__(self, inputs=None, layout=None):
        ...
        :param inputs: The param of the MixInfo
        :type inputs: list[:class:`g42cloudsdkmpc.v1.InputSetting`]
        :param layout: The param of the MixInfo
        :type layout: :class:`g42cloudsdkmpc.v1.MixInfoLayout`
        """
    ...
    def inputs(self):
        ...
        :rtype: list[:class:`g42cloudsdkmpc.v1.InputSetting`]
        """
        return self._inputs
    ...
    def layout(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.MixInfoLayout`
        """
        return self._layout
