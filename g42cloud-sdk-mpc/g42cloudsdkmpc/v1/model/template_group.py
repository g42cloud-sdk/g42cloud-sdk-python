...
class TemplateGroup:
    ...
    def __init__(self, group_id=None, name=None, template_ids=None, videos=None, audio=None, video_common=None, common=None):
        ...
        :param group_id: The param of the TemplateGroup
        :type group_id: str
        :param name: The param of the TemplateGroup
        :type name: str
        :param template_ids: The param of the TemplateGroup
        :type template_ids: list[int]
        :param videos: The param of the TemplateGroup
        :type videos: list[:class:`g42cloudsdkmpc.v1.VideoAndTemplate`]
        :param audio: The param of the TemplateGroup
        :type audio: :class:`g42cloudsdkmpc.v1.Audio`
        :param video_common: The param of the TemplateGroup
        :type video_common: :class:`g42cloudsdkmpc.v1.VideoCommon`
        :param common: The param of the TemplateGroup
    ...
    def videos(self):
        ...
        :rtype: list[:class:`g42cloudsdkmpc.v1.VideoAndTemplate`]
        """
        return self._videos
