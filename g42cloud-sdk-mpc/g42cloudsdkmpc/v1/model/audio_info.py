...
class AudioInfo:
    ...
    def __init__(self, codec=None, sample=None, channels=None, bitrate=None, bitrate_bps=None):
        ...
        :param codec: The param of the AudioInfo
        :type codec: str
        :param sample: The param of the AudioInfo
        :type sample: int
        :param channels: The param of the AudioInfo
        :type channels: int
        :param bitrate: The param of the AudioInfo
        :type bitrate: int
        :param bitrate_bps: The param of the AudioInfo
