...
class ListRemuxTaskResponse(SdkResponse):
    ...
    def __init__(self, total=None, tasks=None):
        ...
        :param total: The param of the ListRemuxTaskResponse
        :type total: int
        :param tasks: The param of the ListRemuxTaskResponse
        :type tasks: list[:class:`g42cloudsdkmpc.v1.RemuxTask`]
        """
    ...
    def tasks(self):
        ...
        :rtype: list[:class:`g42cloudsdkmpc.v1.RemuxTask`]
        """
        return self._tasks
