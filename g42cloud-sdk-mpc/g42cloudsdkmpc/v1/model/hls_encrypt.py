...
class HlsEncrypt:
    ...
    def __init__(self, key=None, url=None, iv=None, algorithm=None):
        ...
        :param key: The param of the HlsEncrypt
        :type key: str
        :param url: The param of the HlsEncrypt
        :type url: str
        :param iv: The param of the HlsEncrypt
        :type iv: str
        :param algorithm: The param of the HlsEncrypt
        :type algorithm: str
        """
