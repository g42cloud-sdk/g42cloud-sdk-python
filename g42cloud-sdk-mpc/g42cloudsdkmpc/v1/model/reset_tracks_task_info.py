...
class ResetTracksTaskInfo:
    ...
    def __init__(self, task_id=None, status=None, create_time=None, end_time=None, output=None, description=None, output_filename=None, tracks_info=None, input=None):
        ...
        :param task_id: The param of the ResetTracksTaskInfo
        :type task_id: str
        :param status: The param of the ResetTracksTaskInfo
        :type status: str
        :param create_time: The param of the ResetTracksTaskInfo
        :type create_time: str
        :param end_time: The param of the ResetTracksTaskInfo
        :type end_time: str
        :param output: The param of the ResetTracksTaskInfo
        :type output: :class:`g42cloudsdkmpc.v1.ObsObjInfo`
        :param description: The param of the ResetTracksTaskInfo
        :type description: str
        :param output_filename: The param of the ResetTracksTaskInfo
        :type output_filename: str
        :param tracks_info: The param of the ResetTracksTaskInfo
        :type tracks_info: list[:class:`g42cloudsdkmpc.v1.TracksInfo`]
        :param input: The param of the ResetTracksTaskInfo
    ...
    def tracks_info(self):
        ...
        :rtype: list[:class:`g42cloudsdkmpc.v1.TracksInfo`]
        """
