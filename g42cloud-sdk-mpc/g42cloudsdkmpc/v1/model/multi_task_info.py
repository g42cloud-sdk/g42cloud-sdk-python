...
class MultiTaskInfo:
    ...
    def __init__(self, template_id=None, error=None, output_file=None):
        ...
        :param template_id: The param of the MultiTaskInfo
        :type template_id: int
        :param error: The param of the MultiTaskInfo
        :type error: :class:`g42cloudsdkmpc.v1.ErrorResponse`
        :param output_file: The param of the MultiTaskInfo
        :type output_file: :class:`g42cloudsdkmpc.v1.SourceInfo`
        """
    ...
    def output_file(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.SourceInfo`
        """
