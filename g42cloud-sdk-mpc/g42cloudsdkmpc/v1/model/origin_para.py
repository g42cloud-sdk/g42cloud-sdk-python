...
class OriginPara:
    ...
    def __init__(self, duration=None, duration_ms=None, file_format=None, video=None, audio=None):
        ...
        :param duration: The param of the OriginPara
        :type duration: int
        :param duration_ms: The param of the OriginPara
        :type duration_ms: int
        :param file_format: The param of the OriginPara
        :type file_format: str
        :param video: The param of the OriginPara
        :type video: :class:`g42cloudsdkmpc.v1.VideoInfo`
        :param audio: The param of the OriginPara
