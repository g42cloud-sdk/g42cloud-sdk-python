...
class Thumbnail:
    ...
    def __init__(self, tar=None, out=None, params=None):
        ...
        :param tar: The param of the Thumbnail
        :type tar: int
        :param out: The param of the Thumbnail
        :type out: :class:`g42cloudsdkmpc.v1.ObsObjInfo`
        :param params: The param of the Thumbnail
        :type params: :class:`g42cloudsdkmpc.v1.ThumbnailPara`
        """
