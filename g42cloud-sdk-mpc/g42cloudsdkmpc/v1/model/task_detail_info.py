...
class TaskDetailInfo:
    ...
    def __init__(self, task_id=None, status=None, create_time=None, start_time=None, end_time=None, input=None, output=None, user_data=None, error_code=None, description=None, media_detail=None, xcode_error=None):
        ...
        :param task_id: The param of the TaskDetailInfo
        :type task_id: str
        :param status: The param of the TaskDetailInfo
        :type status: str
        :param create_time: The param of the TaskDetailInfo
        :type create_time: str
        :param start_time: The param of the TaskDetailInfo
        :type start_time: str
        :param end_time: The param of the TaskDetailInfo
        :type end_time: str
        :param input: The param of the TaskDetailInfo
        :type input: :class:`g42cloudsdkmpc.v1.ObsObjInfo`
        :param output: The param of the TaskDetailInfo
        :type output: :class:`g42cloudsdkmpc.v1.ObsObjInfo`
        :param user_data: The param of the TaskDetailInfo
        :type user_data: str
        :param error_code: The param of the TaskDetailInfo
        :type error_code: str
        :param description: The param of the TaskDetailInfo
        :type description: str
        :param media_detail: The param of the TaskDetailInfo
        :type media_detail: :class:`g42cloudsdkmpc.v1.MediaDetail`
        :param xcode_error: The param of the TaskDetailInfo
        :type xcode_error: :class:`g42cloudsdkmpc.v1.ErrorResponse`
        """
    ...
    def media_detail(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.MediaDetail`
        """
    ...
    def xcode_error(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.ErrorResponse`
        """
