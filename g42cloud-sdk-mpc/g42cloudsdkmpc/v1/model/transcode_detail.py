...
class TranscodeDetail:
    ...
    def __init__(self, multitask_info=None, input_file=None):
        ...
        :param multitask_info: The param of the TranscodeDetail
        :type multitask_info: list[:class:`g42cloudsdkmpc.v1.MultiTaskInfo`]
        :param input_file: The param of the TranscodeDetail
        :type input_file: :class:`g42cloudsdkmpc.v1.SourceInfo`
        """
    ...
    def multitask_info(self):
        ...
        :rtype: list[:class:`g42cloudsdkmpc.v1.MultiTaskInfo`]
        """
