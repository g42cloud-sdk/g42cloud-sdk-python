...
class AvParameters:
    ...
    def __init__(self, video=None, audio=None, common=None):
        ...
        :param video: The param of the AvParameters
        :type video: :class:`g42cloudsdkmpc.v1.VideoParameters`
        :param audio: The param of the AvParameters
        :type audio: :class:`g42cloudsdkmpc.v1.Audio`
        :param common: The param of the AvParameters
    ...
    def video(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.VideoParameters`
        """
        return self._video
