...
class CreateEncryptReq:
    ...
    def __init__(self, input=None, output=None, encryption=None, user_data=None):
        ...
        :param input: The param of the CreateEncryptReq
        :type input: :class:`g42cloudsdkmpc.v1.ObsObjInfo`
        :param output: The param of the CreateEncryptReq
        :type output: :class:`g42cloudsdkmpc.v1.ObsObjInfo`
        :param encryption: The param of the CreateEncryptReq
        :type encryption: :class:`g42cloudsdkmpc.v1.Encryption`
        :param user_data: The param of the CreateEncryptReq
        :type user_data: str
        """
