...
class EditAudioInfo:
    ...
    def __init__(self, codec=None, bitrate=None, sample=None, channels=None):
        ...
        :param codec: The param of the EditAudioInfo
        :type codec: str
        :param bitrate: The param of the EditAudioInfo
        :type bitrate: int
        :param sample: The param of the EditAudioInfo
        :type sample: int
        :param channels: The param of the EditAudioInfo
        :type channels: str
        """
