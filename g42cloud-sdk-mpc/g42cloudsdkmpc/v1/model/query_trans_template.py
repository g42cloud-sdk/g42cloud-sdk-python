...
class QueryTransTemplate:
    ...
    def __init__(self, template_name=None, video=None, audio=None, common=None):
        ...
        :param template_name: The param of the QueryTransTemplate
        :type template_name: str
        :param video: The param of the QueryTransTemplate
        :type video: :class:`g42cloudsdkmpc.v1.Video`
        :param audio: The param of the QueryTransTemplate
        :type audio: :class:`g42cloudsdkmpc.v1.Audio`
        :param common: The param of the QueryTransTemplate
