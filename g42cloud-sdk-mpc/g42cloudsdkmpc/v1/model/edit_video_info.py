...
class EditVideoInfo:
    ...
    def __init__(self, reference=None, width=None, height=None, codec=None, bitrate=None, frame_rate=None):
        ...
        :param reference: The param of the EditVideoInfo
        :type reference: str
        :param width: The param of the EditVideoInfo
        :type width: int
        :param height: The param of the EditVideoInfo
        :type height: int
        :param codec: The param of the EditVideoInfo
        :type codec: str
        :param bitrate: The param of the EditVideoInfo
        :type bitrate: int
        :param frame_rate: The param of the EditVideoInfo
        :type frame_rate: int
        """
