...
class OutputSetting:
    ...
    def __init__(self, format=None, video=None, audio=None, hls=None, output=None):
        ...
        :param format: The param of the OutputSetting
        :type format: str
        :param video: The param of the OutputSetting
        :type video: :class:`g42cloudsdkmpc.v1.EditVideoInfo`
        :param audio: The param of the OutputSetting
        :type audio: :class:`g42cloudsdkmpc.v1.EditAudioInfo`
        :param hls: The param of the OutputSetting
        :type hls: :class:`g42cloudsdkmpc.v1.EditHlsInfo`
        :param output: The param of the OutputSetting
    ...
    def video(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.EditVideoInfo`
        """
        return self._video
    ...
    def audio(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.EditAudioInfo`
        """
        return self._audio
    ...
    def hls(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.EditHlsInfo`
        """
        return self._hls
