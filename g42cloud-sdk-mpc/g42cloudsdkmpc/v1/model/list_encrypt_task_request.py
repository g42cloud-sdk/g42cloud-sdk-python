...
class ListEncryptTaskRequest:
    ...
    def __init__(self, authorization=None, x_project_id=None, x_sdk_date=None, task_id=None, status=None, start_time=None, end_time=None, page=None, size=None):
        ...
        :param authorization: The param of the ListEncryptTaskRequest
        :type authorization: str
        :param x_project_id: The param of the ListEncryptTaskRequest
        :type x_project_id: str
        :param x_sdk_date: The param of the ListEncryptTaskRequest
        :type x_sdk_date: str
        :param task_id: The param of the ListEncryptTaskRequest
        :type task_id: list[str]
        :param status: The param of the ListEncryptTaskRequest
        :type status: str
        :param start_time: The param of the ListEncryptTaskRequest
        :type start_time: str
        :param end_time: The param of the ListEncryptTaskRequest
        :type end_time: str
        :param page: The param of the ListEncryptTaskRequest
        :type page: int
        :param size: The param of the ListEncryptTaskRequest
        :type size: int
        """
    ...
    def authorization(self):
        """Gets the authorization of this ListEncryptTaskRequest.

        :return: The authorization of this ListEncryptTaskRequest.
        :rtype: str
        """
    ...
    def authorization(self, authorization):
        """Sets the authorization of this ListEncryptTaskRequest.

        :param authorization: The authorization of this ListEncryptTaskRequest.
        :type authorization: str
        """
    ...
    def x_project_id(self):
        """Gets the x_project_id of this ListEncryptTaskRequest.

        :return: The x_project_id of this ListEncryptTaskRequest.
        :rtype: str
        """
    ...
    def x_project_id(self, x_project_id):
        """Sets the x_project_id of this ListEncryptTaskRequest.

        :param x_project_id: The x_project_id of this ListEncryptTaskRequest.
        :type x_project_id: str
        """
    ...
    @property
    def x_sdk_date(self):
        """Gets the x_sdk_date of this ListEncryptTaskRequest.

        :return: The x_sdk_date of this ListEncryptTaskRequest.
        :rtype: str
        """
    ...
    def x_sdk_date(self, x_sdk_date):
        """Sets the x_sdk_date of this ListEncryptTaskRequest.

        :param x_sdk_date: The x_sdk_date of this ListEncryptTaskRequest.
        :type x_sdk_date: str
        """
