...
class CreateMpeCallBackRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the CreateMpeCallBackRequest
        :type body: :class:`g42cloudsdkmpc.v1.MpeCallBackReq`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.MpeCallBackReq`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateMpeCallBackRequest):
            return False
