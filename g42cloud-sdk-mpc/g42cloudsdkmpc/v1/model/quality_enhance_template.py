...
class QualityEnhanceTemplate:
    ...
    def __init__(self, template_name=None, template_description=None, video=None):
        ...
        :param template_name: The param of the QualityEnhanceTemplate
        :type template_name: str
        :param template_description: The param of the QualityEnhanceTemplate
        :type template_description: str
        :param video: The param of the QualityEnhanceTemplate
        :type video: :class:`g42cloudsdkmpc.v1.QualityEnhanceVideo`
        """
    ...
    def video(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.QualityEnhanceVideo`
        """
        return self._video
