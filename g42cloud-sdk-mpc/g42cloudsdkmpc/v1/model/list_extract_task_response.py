...
class ListExtractTaskResponse(SdkResponse):
    ...
    def __init__(self, total=None, tasks=None):
        ...
        :param total: The param of the ListExtractTaskResponse
        :type total: int
        :param tasks: The param of the ListExtractTaskResponse
        :type tasks: list[:class:`g42cloudsdkmpc.v1.ExtractTask`]
        """
    ...
    def tasks(self):
        ...
        :rtype: list[:class:`g42cloudsdkmpc.v1.ExtractTask`]
        """
        return self._tasks
