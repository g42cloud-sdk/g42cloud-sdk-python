...
class SubAudioFile:
    ...
    def __init__(self, tracks_info=None, input=None, output=None, output_filename=None):
        ...
        :param tracks_info: The param of the SubAudioFile
        :type tracks_info: list[:class:`g42cloudsdkmpc.v1.TracksInfo`]
        :param input: The param of the SubAudioFile
        :type input: :class:`g42cloudsdkmpc.v1.ObsObjInfo`
        :param output: The param of the SubAudioFile
        :type output: :class:`g42cloudsdkmpc.v1.ObsObjInfo`
        :param output_filename: The param of the SubAudioFile
