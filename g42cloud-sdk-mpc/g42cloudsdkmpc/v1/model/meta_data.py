...
class MetaData:
    ...
    def __init__(self, size=None, duration_ms=None, duration=None, format=None, bitrate=None, video=None, audio=None):
        ...
        :param size: The param of the MetaData
        :type size: int
        :param duration_ms: The param of the MetaData
        :type duration_ms: float
        :param duration: The param of the MetaData
        :type duration: int
        :param format: The param of the MetaData
        :type format: str
        :param bitrate: The param of the MetaData
        :type bitrate: int
        :param video: The param of the MetaData
        :type video: list[:class:`g42cloudsdkmpc.v1.VideoInfo`]
        :param audio: The param of the MetaData
        :type audio: list[:class:`g42cloudsdkmpc.v1.AudioInfo`]
        """
    ...
    def video(self):
        ...
        :rtype: list[:class:`g42cloudsdkmpc.v1.VideoInfo`]
        """
        return self._video
