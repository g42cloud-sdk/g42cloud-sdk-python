...
class QueryTranscodingsTaskResponse:
    ...
    def __init__(self, task_id=None, status=None, create_time=None, end_time=None, trans_template_id=None, input=None, output=None, output_file_name=None, user_data=None, error_code=None, description=None, tips=None, transcode_detail=None, thumbnail_output=None, thumbnail_outputname=None, pic_info=None, av_parameters=None):
        ...
        :param task_id: The param of the QueryTranscodingsTaskResponse
        :type task_id: str
        :param status: The param of the QueryTranscodingsTaskResponse
        :type status: str
        :param create_time: The param of the QueryTranscodingsTaskResponse
        :type create_time: str
        :param end_time: The param of the QueryTranscodingsTaskResponse
        :type end_time: str
        :param trans_template_id: The param of the QueryTranscodingsTaskResponse
        :type trans_template_id: list[int]
        :param input: The param of the QueryTranscodingsTaskResponse
        :type input: :class:`g42cloudsdkmpc.v1.ObsObjInfo`
        :param output: The param of the QueryTranscodingsTaskResponse
        :type output: :class:`g42cloudsdkmpc.v1.ObsObjInfo`
        :param output_file_name: The param of the QueryTranscodingsTaskResponse
        :type output_file_name: list[str]
        :param user_data: The param of the QueryTranscodingsTaskResponse
        :type user_data: str
        :param error_code: The param of the QueryTranscodingsTaskResponse
        :type error_code: str
        :param description: The param of the QueryTranscodingsTaskResponse
        :type description: str
        :param tips: The param of the QueryTranscodingsTaskResponse
        :type tips: str
        :param transcode_detail: The param of the QueryTranscodingsTaskResponse
        :type transcode_detail: :class:`g42cloudsdkmpc.v1.TranscodeDetail`
        :param thumbnail_output: The param of the QueryTranscodingsTaskResponse
        :type thumbnail_output: :class:`g42cloudsdkmpc.v1.ObsObjInfo`
        :param thumbnail_outputname: The param of the QueryTranscodingsTaskResponse
        :type thumbnail_outputname: str
        :param pic_info: The param of the QueryTranscodingsTaskResponse
        :type pic_info: list[:class:`g42cloudsdkmpc.v1.PicInfo`]
        :param av_parameters: The param of the QueryTranscodingsTaskResponse
    ...
    def transcode_detail(self):
        ...
        :rtype: :class:`g42cloudsdkmpc.v1.TranscodeDetail`
        """
