...
class ListEditingJobRequest:
    ...
    def __init__(self, x_language=None, job_id=None, status=None, start_time=None, end_time=None, page=None, size=None):
        ...
        :param x_language: The param of the ListEditingJobRequest
        :type x_language: str
        :param job_id: The param of the ListEditingJobRequest
        :type job_id: list[str]
        :param status: The param of the ListEditingJobRequest
        :type status: str
        :param start_time: The param of the ListEditingJobRequest
        :type start_time: str
        :param end_time: The param of the ListEditingJobRequest
        :type end_time: str
        :param page: The param of the ListEditingJobRequest
        :type page: int
        :param size: The param of the ListEditingJobRequest
        :type size: int
        """
