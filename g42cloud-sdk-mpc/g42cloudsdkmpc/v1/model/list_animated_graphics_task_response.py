...
class ListAnimatedGraphicsTaskResponse(SdkResponse):
    ...
    def __init__(self, total=None, tasks=None):
        ...
        :param total: The param of the ListAnimatedGraphicsTaskResponse
        :type total: int
        :param tasks: The param of the ListAnimatedGraphicsTaskResponse
        :type tasks: list[:class:`g42cloudsdkmpc.v1.AnimatedGraphicsTask`]
        """
    ...
    def tasks(self):
        ...
        :rtype: list[:class:`g42cloudsdkmpc.v1.AnimatedGraphicsTask`]
        """
        return self._tasks
