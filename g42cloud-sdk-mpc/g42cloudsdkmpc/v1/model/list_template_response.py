...
class ListTemplateResponse(SdkResponse):
    ...
    def __init__(self, template_array=None, total=None):
        ...
        :param template_array: The param of the ListTemplateResponse
        :type template_array: list[:class:`g42cloudsdkmpc.v1.TemplateInfo`]
        :param total: The param of the ListTemplateResponse
        :type total: int
        """
    ...
    def template_array(self):
        ...
        :rtype: list[:class:`g42cloudsdkmpc.v1.TemplateInfo`]
        """
