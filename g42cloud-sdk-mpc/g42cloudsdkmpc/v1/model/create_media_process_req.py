...
class CreateMediaProcessReq:
    ...
    def __init__(self, input=None, output=None, template_id=None):
        ...
        :param input: The param of the CreateMediaProcessReq
        :type input: :class:`g42cloudsdkmpc.v1.ObsObjInfo`
        :param output: The param of the CreateMediaProcessReq
        :type output: :class:`g42cloudsdkmpc.v1.ObsObjInfo`
        :param template_id: The param of the CreateMediaProcessReq
