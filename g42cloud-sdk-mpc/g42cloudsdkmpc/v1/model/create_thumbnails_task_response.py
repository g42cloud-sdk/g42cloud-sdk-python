...
class CreateThumbnailsTaskResponse(SdkResponse):
    ...
    def __init__(self, task_id=None, status=None, create_time=None, output=None, output_file_name=None, thumbnail_time=None, description=None):
        ...
        :param task_id: The param of the CreateThumbnailsTaskResponse
        :type task_id: str
        :param status: The param of the CreateThumbnailsTaskResponse
        :type status: str
        :param create_time: The param of the CreateThumbnailsTaskResponse
        :type create_time: str
        :param output: The param of the CreateThumbnailsTaskResponse
        :type output: :class:`g42cloudsdkmpc.v1.ObsObjInfo`
        :param output_file_name: The param of the CreateThumbnailsTaskResponse
        :type output_file_name: str
        :param thumbnail_time: The param of the CreateThumbnailsTaskResponse
        :type thumbnail_time: str
        :param description: The param of the CreateThumbnailsTaskResponse
