...
class NovaListServersDetailsResponse(SdkResponse):
    ...
    def __init__(self, servers=None, servers_links=None):
        ...
        :type servers: list[:class:`g42cloudsdkecs.v2.NovaServer`]
        :param servers_links: The param of the NovaListServersDetailsResponse
        :type servers_links: list[:class:`g42cloudsdkecs.v2.PageLink`]
        """
    ...
    def servers(self):
        ...
        :rtype: list[:class:`g42cloudsdkecs.v2.NovaServer`]
        """
    ...
    def servers_links(self):
        ...
        :rtype: list[:class:`g42cloudsdkecs.v2.PageLink`]
        """
