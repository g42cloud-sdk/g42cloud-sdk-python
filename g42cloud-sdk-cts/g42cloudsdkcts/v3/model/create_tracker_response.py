...
class CreateTrackerResponse(SdkResponse):
    ...
    def __init__(self, id=None, create_time=None, kms_id=None, is_support_validate=None, lts=None, tracker_type=None, domain_id=None, project_id=None, tracker_name=None, status=None, detail=None, is_support_trace_files_encryption=None, obs_info=None, data_bucket=None):
        ...
        :param id: The param of the CreateTrackerResponse
        :type id: str
        :param create_time: The param of the CreateTrackerResponse
        :type create_time: int
        :param kms_id: The param of the CreateTrackerResponse
        :type kms_id: str
        :param is_support_validate: The param of the CreateTrackerResponse
        :type is_support_validate: bool
        :param lts: The param of the CreateTrackerResponse
        :type lts: :class:`g42cloudsdkcts.v3.Lts`
        :param tracker_type: The param of the CreateTrackerResponse
        :type tracker_type: str
        :param domain_id: The param of the CreateTrackerResponse
        :type domain_id: str
        :param project_id: The param of the CreateTrackerResponse
        :type project_id: str
        :param tracker_name: The param of the CreateTrackerResponse
        :type tracker_name: str
        :param status: The param of the CreateTrackerResponse
        :type status: str
        :param detail: The param of the CreateTrackerResponse
        :type detail: str
        :param is_support_trace_files_encryption: The param of the CreateTrackerResponse
        :type is_support_trace_files_encryption: bool
        :param obs_info: The param of the CreateTrackerResponse
        :type obs_info: :class:`g42cloudsdkcts.v3.ObsInfo`
        :param data_bucket: The param of the CreateTrackerResponse
