...
class ListTracesResponse(SdkResponse):
    ...
    def __init__(self, traces=None, meta_data=None):
        ...
        :param traces: The param of the ListTracesResponse
        :type traces: list[:class:`g42cloudsdkcts.v3.Traces`]
        :param meta_data: The param of the ListTracesResponse
        :type meta_data: :class:`g42cloudsdkcts.v3.MetaData`
        """
    ...
    def traces(self):
        ...
        :rtype: list[:class:`g42cloudsdkcts.v3.Traces`]
        """
        return self._traces
    ...
    def meta_data(self):
        ...
        :rtype: :class:`g42cloudsdkcts.v3.MetaData`
        """
