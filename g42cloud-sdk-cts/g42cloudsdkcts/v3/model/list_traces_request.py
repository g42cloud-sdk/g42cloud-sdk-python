...
class ListTracesRequest:
    ...
    def __init__(self, trace_type=None, limit=None, _from=None, next=None, to=None, tracker_name=None, service_type=None, user=None, resource_id=None, resource_name=None, resource_type=None, trace_id=None, trace_name=None, trace_rating=None):
        ...
        :param trace_type: The param of the ListTracesRequest
        :type trace_type: str
        :param limit: The param of the ListTracesRequest
        :type limit: int
        :param _from: The param of the ListTracesRequest
        :type _from: int
        :param next: The param of the ListTracesRequest
        :type next: str
        :param to: The param of the ListTracesRequest
        :type to: int
        :param tracker_name: The param of the ListTracesRequest
        :type tracker_name: str
        :param service_type: The param of the ListTracesRequest
        :type service_type: str
        :param user: The param of the ListTracesRequest
        :type user: str
        :param resource_id: The param of the ListTracesRequest
        :type resource_id: str
        :param resource_name: The param of the ListTracesRequest
        :type resource_name: str
        :param resource_type: The param of the ListTracesRequest
        :type resource_type: str
        :param trace_id: The param of the ListTracesRequest
        :type trace_id: str
        :param trace_name: The param of the ListTracesRequest
        :type trace_name: str
        :param trace_rating: The param of the ListTracesRequest
