...
class ListTrackersResponse(SdkResponse):
    ...
    def __init__(self, trackers=None):
        ...
        :param trackers: The param of the ListTrackersResponse
        :type trackers: list[:class:`g42cloudsdkcts.v3.TrackerResponseBody`]
        """
    ...
    def trackers(self):
        ...
        :rtype: list[:class:`g42cloudsdkcts.v3.TrackerResponseBody`]
        """
