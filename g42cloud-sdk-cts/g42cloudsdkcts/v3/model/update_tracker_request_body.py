...
class UpdateTrackerRequestBody:
    ...
    def __init__(self, tracker_type=None, tracker_name=None, status=None, is_lts_enabled=None, obs_info=None, is_support_trace_files_encryption=None, kms_id=None, is_support_validate=None, data_bucket=None):
        ...
        :param tracker_type: The param of the UpdateTrackerRequestBody
        :type tracker_type: str
        :param tracker_name: The param of the UpdateTrackerRequestBody
        :type tracker_name: str
        :param status: The param of the UpdateTrackerRequestBody
        :type status: str
        :param is_lts_enabled: The param of the UpdateTrackerRequestBody
        :type is_lts_enabled: bool
        :param obs_info: The param of the UpdateTrackerRequestBody
        :type obs_info: :class:`g42cloudsdkcts.v3.TrackerObsInfo`
        :param is_support_trace_files_encryption: The param of the UpdateTrackerRequestBody
        :type is_support_trace_files_encryption: bool
        :param kms_id: The param of the UpdateTrackerRequestBody
        :type kms_id: str
        :param is_support_validate: The param of the UpdateTrackerRequestBody
        :type is_support_validate: bool
        :param data_bucket: The param of the UpdateTrackerRequestBody
