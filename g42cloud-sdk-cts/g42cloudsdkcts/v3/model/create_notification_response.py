...
class CreateNotificationResponse(SdkResponse):
    ...
    def __init__(self, notification_name=None, operation_type=None, operations=None, notify_user_list=None, status=None, topic_id=None, notification_id=None, notification_type=None, project_id=None, create_time=None, filter=None):
        ...
        :param notification_name: The param of the CreateNotificationResponse
        :type notification_name: str
        :param operation_type: The param of the CreateNotificationResponse
        :type operation_type: str
        :param operations: The param of the CreateNotificationResponse
        :type operations: list[:class:`g42cloudsdkcts.v3.Operations`]
        :param notify_user_list: The param of the CreateNotificationResponse
        :type notify_user_list: list[:class:`g42cloudsdkcts.v3.NotificationUsers`]
        :param status: The param of the CreateNotificationResponse
        :type status: str
        :param topic_id: The param of the CreateNotificationResponse
        :type topic_id: str
        :param notification_id: The param of the CreateNotificationResponse
        :type notification_id: str
        :param notification_type: The param of the CreateNotificationResponse
        :type notification_type: str
        :param project_id: The param of the CreateNotificationResponse
        :type project_id: str
        :param create_time: The param of the CreateNotificationResponse
        :type create_time: int
        :param filter: The param of the CreateNotificationResponse
