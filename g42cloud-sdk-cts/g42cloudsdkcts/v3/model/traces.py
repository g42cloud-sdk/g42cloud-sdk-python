...
class Traces:
    ...
    def __init__(self, resource_id=None, trace_name=None, trace_rating=None, trace_type=None, request=None, response=None, code=None, api_version=None, message=None, record_time=None, trace_id=None, time=None, user=None, service_type=None, resource_type=None, source_ip=None, resource_name=None, request_id=None, location_info=None, endpoint=None, resource_url=None):
        ...
        :param resource_id: The param of the Traces
        :type resource_id: str
        :param trace_name: The param of the Traces
        :type trace_name: str
        :param trace_rating: The param of the Traces
        :type trace_rating: str
        :param trace_type: The param of the Traces
        :type trace_type: str
        :param request: The param of the Traces
        :type request: str
        :param response: The param of the Traces
        :type response: str
        :param code: The param of the Traces
        :type code: str
        :param api_version: The param of the Traces
        :type api_version: str
        :param message: The param of the Traces
        :type message: str
        :param record_time: The param of the Traces
        :type record_time: int
        :param trace_id: The param of the Traces
        :type trace_id: str
        :param time: The param of the Traces
        :type time: int
        :param user: The param of the Traces
        :type user: :class:`g42cloudsdkcts.v3.UserInfo`
        :param service_type: The param of the Traces
        :type service_type: str
        :param resource_type: The param of the Traces
        :type resource_type: str
        :param source_ip: The param of the Traces
        :type source_ip: str
        :param resource_name: The param of the Traces
        :type resource_name: str
        :param request_id: The param of the Traces
        :type request_id: str
        :param location_info: The param of the Traces
        :type location_info: str
        :param endpoint: The param of the Traces
        :type endpoint: str
        :param resource_url: The param of the Traces
    ...
    def user(self):
        ...
        :rtype: :class:`g42cloudsdkcts.v3.UserInfo`
        """
        return self._user
