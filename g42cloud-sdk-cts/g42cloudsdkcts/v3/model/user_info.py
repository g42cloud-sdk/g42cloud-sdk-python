...
class UserInfo:
    ...
    def __init__(self, id=None, name=None, domain=None):
        ...
        :param id: The param of the UserInfo
        :type id: str
        :param name: The param of the UserInfo
        :type name: str
        :param domain: The param of the UserInfo
        :type domain: :class:`g42cloudsdkcts.v3.BaseUser`
        """
    ...
    def domain(self):
        ...
        :rtype: :class:`g42cloudsdkcts.v3.BaseUser`
        """
        return self._domain
