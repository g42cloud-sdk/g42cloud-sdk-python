...
class EnableConfigurationRequest:
    ...
    def __init__(self, x_language=None, config_id=None, body=None):
        ...
        :param x_language: The param of the EnableConfigurationRequest
        :type x_language: str
        :param config_id: The param of the EnableConfigurationRequest
        :type config_id: str
        :param body: The param of the EnableConfigurationRequest
