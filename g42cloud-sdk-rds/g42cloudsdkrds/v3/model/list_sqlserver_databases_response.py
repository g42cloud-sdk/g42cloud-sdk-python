...
class ListSqlserverDatabasesResponse(SdkResponse):
    ...
    def __init__(self, databases=None, total_count=None):
        ...
        :param databases: The param of the ListSqlserverDatabasesResponse
        :type databases: list[:class:`g42cloudsdkrds.v3.SqlserverDatabaseForDetail`]
        :param total_count: The param of the ListSqlserverDatabasesResponse
    ...
    def databases(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.SqlserverDatabaseForDetail`]
        """
