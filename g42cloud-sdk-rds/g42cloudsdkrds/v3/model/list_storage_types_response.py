...
class ListStorageTypesResponse(SdkResponse):
    ...
    def __init__(self, storage_type=None, dsspool_info=None):
        ...
        :param storage_type: The param of the ListStorageTypesResponse
        :type storage_type: list[:class:`g42cloudsdkrds.v3.Storage`]
        :param dsspool_info: The param of the ListStorageTypesResponse
        :type dsspool_info: list[:class:`g42cloudsdkrds.v3.DssPoolInfo`]
        """
    ...
    def storage_type(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.Storage`]
        """
    ...
    def dsspool_info(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.DssPoolInfo`]
        """
