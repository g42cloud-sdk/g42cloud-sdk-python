...
class ListSqlserverDbUsersRequest:
    ...
    def __init__(self, x_language=None, instance_id=None, page=None, limit=None):
        ...
        :param x_language: The param of the ListSqlserverDbUsersRequest
        :type x_language: str
        :param instance_id: The param of the ListSqlserverDbUsersRequest
        :type instance_id: str
        :param page: The param of the ListSqlserverDbUsersRequest
        :type page: int
        :param limit: The param of the ListSqlserverDbUsersRequest
        :type limit: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListSqlserverDbUsersRequest):
            return False
