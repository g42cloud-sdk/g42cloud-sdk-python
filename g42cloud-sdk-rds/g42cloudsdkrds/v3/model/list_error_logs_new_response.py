...
class ListErrorLogsNewResponse(SdkResponse):
    ...
    def __init__(self, error_log_list=None, total_record=None):
        ...
        :param error_log_list: The param of the ListErrorLogsNewResponse
        :type error_log_list: list[:class:`g42cloudsdkrds.v3.ErrorLog`]
        :param total_record: The param of the ListErrorLogsNewResponse
    ...
    def error_log_list(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.ErrorLog`]
        """
    ...
    def total_record(self):
        """Gets the total_record of this ListErrorLogsNewResponse.
    ...
    def total_record(self, total_record):
        """Sets the total_record of this ListErrorLogsNewResponse.
