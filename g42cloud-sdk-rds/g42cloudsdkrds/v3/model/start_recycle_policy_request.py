...
class StartRecyclePolicyRequest:
    ...
    def __init__(self, x_language=None, body=None):
        ...
        :param x_language: The param of the StartRecyclePolicyRequest
        :type x_language: str
        :param body: The param of the StartRecyclePolicyRequest
        :type body: :class:`g42cloudsdkrds.v3.RecyclePolicyRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkrds.v3.RecyclePolicyRequestBody`
        """
        return self._body
