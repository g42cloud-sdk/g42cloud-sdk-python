...
class CreateInstanceRequest:
    ...
    def __init__(self, x_language=None, body=None):
        ...
        :param x_language: The param of the CreateInstanceRequest
        :type x_language: str
        :param body: The param of the CreateInstanceRequest
        :type body: :class:`g42cloudsdkrds.v3.InstanceRequest`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkrds.v3.InstanceRequest`
        """
        return self._body
