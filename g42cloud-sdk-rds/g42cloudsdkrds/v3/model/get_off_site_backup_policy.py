...
class GetOffSiteBackupPolicy:
    ...
    def __init__(self, backup_type=None, keep_days=None, destination_region=None, destination_project_id=None):
        ...
        :param backup_type: The param of the GetOffSiteBackupPolicy
        :type backup_type: str
        :param keep_days: The param of the GetOffSiteBackupPolicy
        :type keep_days: int
        :param destination_region: The param of the GetOffSiteBackupPolicy
        :type destination_region: str
        :param destination_project_id: The param of the GetOffSiteBackupPolicy
