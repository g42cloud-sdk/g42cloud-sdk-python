...
class PostgresqlUserForList:
    ...
    def __init__(self, name=None, attributes=None, memberof=None):
        ...
        :param name: The param of the PostgresqlUserForList
        :type name: str
        :param attributes: The param of the PostgresqlUserForList
        :type attributes: object
        :param memberof: The param of the PostgresqlUserForList
