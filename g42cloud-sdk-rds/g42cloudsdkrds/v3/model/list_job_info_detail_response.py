...
class ListJobInfoDetailResponse(SdkResponse):
    ...
    def __init__(self, jobs=None, count=None):
        ...
        :param jobs: The param of the ListJobInfoDetailResponse
        :type jobs: :class:`g42cloudsdkrds.v3.GetTaskDetailListRspJobs`
        :param count: The param of the ListJobInfoDetailResponse
        :type count: int
        """
    ...
    def jobs(self):
        ...
        :rtype: :class:`g42cloudsdkrds.v3.GetTaskDetailListRspJobs`
        """
        return self._jobs
