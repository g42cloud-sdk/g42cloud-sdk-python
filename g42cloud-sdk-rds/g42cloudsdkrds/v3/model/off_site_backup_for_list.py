...
class OffSiteBackupForList:
    ...
    def __init__(self, id=None, instance_id=None, name=None, databases=None, begin_time=None, end_time=None, status=None, type=None, size=None, datastore=None, associated_with_ddm=None):
        ...
        :param id: The param of the OffSiteBackupForList
        :type id: str
        :param instance_id: The param of the OffSiteBackupForList
        :type instance_id: str
        :param name: The param of the OffSiteBackupForList
        :type name: str
        :param databases: The param of the OffSiteBackupForList
        :type databases: list[:class:`g42cloudsdkrds.v3.BackupDatabase`]
        :param begin_time: The param of the OffSiteBackupForList
        :type begin_time: str
        :param end_time: The param of the OffSiteBackupForList
        :type end_time: str
        :param status: The param of the OffSiteBackupForList
        :type status: str
        :param type: The param of the OffSiteBackupForList
        :type type: str
        :param size: The param of the OffSiteBackupForList
        :type size: int
        :param datastore: The param of the OffSiteBackupForList
        :type datastore: :class:`g42cloudsdkrds.v3.ParaGroupDatastore`
        :param associated_with_ddm: The param of the OffSiteBackupForList
