...
class Auditlog:
    ...
    def __init__(self, id=None, name=None, size=None, begin_time=None, end_time=None):
        ...
        :param id: The param of the Auditlog
        :type id: str
        :param name: The param of the Auditlog
        :type name: str
        :param size: The param of the Auditlog
        :type size: int
        :param begin_time: The param of the Auditlog
        :type begin_time: str
        :param end_time: The param of the Auditlog
        :type end_time: str
        """
