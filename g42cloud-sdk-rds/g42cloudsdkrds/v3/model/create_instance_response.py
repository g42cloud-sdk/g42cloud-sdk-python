...
class CreateInstanceResponse(SdkResponse):
    ...
    def __init__(self, instance=None, job_id=None, order_id=None):
        ...
        :param instance: The param of the CreateInstanceResponse
        :type instance: :class:`g42cloudsdkrds.v3.CreateInstanceRespItem`
        :param job_id: The param of the CreateInstanceResponse
        :type job_id: str
        :param order_id: The param of the CreateInstanceResponse
        :type order_id: str
        """
