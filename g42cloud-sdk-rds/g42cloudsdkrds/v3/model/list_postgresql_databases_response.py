...
class ListPostgresqlDatabasesResponse(SdkResponse):
    ...
    def __init__(self, databases=None, total_count=None):
        ...
        :param databases: The param of the ListPostgresqlDatabasesResponse
        :type databases: list[:class:`g42cloudsdkrds.v3.PostgresqlListDatabase`]
        :param total_count: The param of the ListPostgresqlDatabasesResponse
    ...
    def databases(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.PostgresqlListDatabase`]
        """
