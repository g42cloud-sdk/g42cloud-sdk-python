...
class ListJobInfoDetailRequest:
    ...
    def __init__(self, x_language=None, instance_id=None, start_time=None, end_time=None):
        ...
        :param x_language: The param of the ListJobInfoDetailRequest
        :type x_language: str
        :param instance_id: The param of the ListJobInfoDetailRequest
        :type instance_id: str
        :param start_time: The param of the ListJobInfoDetailRequest
        :type start_time: str
        :param end_time: The param of the ListJobInfoDetailRequest
        :type end_time: str
        """
