...
class SwitchSslRequest:
    ...
    def __init__(self, x_language=None, instance_id=None, body=None):
        ...
        :param x_language: The param of the SwitchSslRequest
        :type x_language: str
        :param instance_id: The param of the SwitchSslRequest
        :type instance_id: str
        :param body: The param of the SwitchSslRequest
        :type body: :class:`g42cloudsdkrds.v3.SslOptionRequest`
        """
    ...
    @property
    def x_language(self):
        """Gets the x_language of this SwitchSslRequest.

        :return: The x_language of this SwitchSslRequest.
        :rtype: str
        """
    ...
    def x_language(self, x_language):
        """Sets the x_language of this SwitchSslRequest.

        :param x_language: The x_language of this SwitchSslRequest.
        :type x_language: str
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkrds.v3.SslOptionRequest`
        """
        return self._body
