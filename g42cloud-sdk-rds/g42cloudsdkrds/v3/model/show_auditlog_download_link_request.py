...
class ShowAuditlogDownloadLinkRequest:
    ...
    def __init__(self, x_language=None, instance_id=None, body=None):
        ...
        :param x_language: The param of the ShowAuditlogDownloadLinkRequest
        :type x_language: str
        :param instance_id: The param of the ShowAuditlogDownloadLinkRequest
        :type instance_id: str
        :param body: The param of the ShowAuditlogDownloadLinkRequest
        :type body: :class:`g42cloudsdkrds.v3.GenerateAuditlogDownloadLinkRequest`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkrds.v3.GenerateAuditlogDownloadLinkRequest`
        """
        return self._body
