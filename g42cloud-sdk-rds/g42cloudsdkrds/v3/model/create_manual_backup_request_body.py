...
class CreateManualBackupRequestBody:
    ...
    def __init__(self, instance_id=None, name=None, description=None, databases=None):
        ...
        :param instance_id: The param of the CreateManualBackupRequestBody
        :type instance_id: str
        :param name: The param of the CreateManualBackupRequestBody
        :type name: str
        :param description: The param of the CreateManualBackupRequestBody
        :type description: str
        :param databases: The param of the CreateManualBackupRequestBody
