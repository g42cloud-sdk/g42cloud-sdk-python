...
class RestoreTablesRequestBody:
    ...
    def __init__(self, restore_time=None, restore_tables=None):
        ...
        :param restore_time: The param of the RestoreTablesRequestBody
        :type restore_time: int
        :param restore_tables: The param of the RestoreTablesRequestBody
        :type restore_tables: list[:class:`g42cloudsdkrds.v3.RestoreDatabasesInfo`]
        """
    ...
    def restore_tables(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.RestoreDatabasesInfo`]
        """
