...
class SqlserverRevokeRequest:
    ...
    def __init__(self, db_name=None, users=None):
        ...
        :param db_name: The param of the SqlserverRevokeRequest
        :type db_name: str
        :param users: The param of the SqlserverRevokeRequest
        :type users: list[:class:`g42cloudsdkrds.v3.SqlserverUserWithPrivilege`]
        """
    ...
    def users(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.SqlserverUserWithPrivilege`]
        """
        return self._users
