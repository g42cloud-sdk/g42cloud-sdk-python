...
class ListSlowLogsNewResponse(SdkResponse):
    ...
    def __init__(self, slow_log_list=None, total_record=None):
        ...
        :param slow_log_list: The param of the ListSlowLogsNewResponse
        :type slow_log_list: list[:class:`g42cloudsdkrds.v3.SlowLog`]
        :param total_record: The param of the ListSlowLogsNewResponse
    ...
    def slow_log_list(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.SlowLog`]
        """
