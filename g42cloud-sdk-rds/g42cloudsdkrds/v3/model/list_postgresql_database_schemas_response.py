...
class ListPostgresqlDatabaseSchemasResponse(SdkResponse):
    ...
    def __init__(self, database_schemas=None, total_count=None):
        ...
        :param database_schemas: The param of the ListPostgresqlDatabaseSchemasResponse
        :type database_schemas: list[:class:`g42cloudsdkrds.v3.PostgresqlDatabaseForListSchema`]
        :param total_count: The param of the ListPostgresqlDatabaseSchemasResponse
    ...
    def database_schemas(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.PostgresqlDatabaseForListSchema`]
        """
