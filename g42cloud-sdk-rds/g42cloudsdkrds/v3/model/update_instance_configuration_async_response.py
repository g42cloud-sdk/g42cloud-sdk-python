...
class UpdateInstanceConfigurationAsyncResponse(SdkResponse):
    ...
    def __init__(self, job_id=None, restart_required=None):
        ...
        :param job_id: The param of the UpdateInstanceConfigurationAsyncResponse
        :type job_id: str
        :param restart_required: The param of the UpdateInstanceConfigurationAsyncResponse
