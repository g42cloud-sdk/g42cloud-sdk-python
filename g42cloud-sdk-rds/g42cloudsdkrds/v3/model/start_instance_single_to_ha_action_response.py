...
class StartInstanceSingleToHaActionResponse(SdkResponse):
    ...
    def __init__(self, job_id=None):
        ...
        :param job_id: The param of the StartInstanceSingleToHaActionResponse
        :type job_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StartInstanceSingleToHaActionResponse):
            return False
