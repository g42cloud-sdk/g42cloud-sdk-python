...
class SetOffSiteBackupPolicyRequestBody:
    ...
    def __init__(self, policy_para=None):
        ...
        :param policy_para: The param of the SetOffSiteBackupPolicyRequestBody
        :type policy_para: list[:class:`g42cloudsdkrds.v3.OffSiteBackupPolicy`]
        """
    ...
    def policy_para(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.OffSiteBackupPolicy`]
        """
