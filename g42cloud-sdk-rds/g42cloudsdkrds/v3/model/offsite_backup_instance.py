...
class OffsiteBackupInstance:
    ...
    def __init__(self, id=None, name=None, source_region=None, source_project_id=None, datastore=None, destination_region=None, destination_project_id=None, keep_days=None):
        ...
        :param id: The param of the OffsiteBackupInstance
        :type id: str
        :param name: The param of the OffsiteBackupInstance
        :type name: str
        :param source_region: The param of the OffsiteBackupInstance
        :type source_region: str
        :param source_project_id: The param of the OffsiteBackupInstance
        :type source_project_id: str
        :param datastore: The param of the OffsiteBackupInstance
        :type datastore: :class:`g42cloudsdkrds.v3.ParaGroupDatastore`
        :param destination_region: The param of the OffsiteBackupInstance
        :type destination_region: str
        :param destination_project_id: The param of the OffsiteBackupInstance
        :type destination_project_id: str
        :param keep_days: The param of the OffsiteBackupInstance
        :type keep_days: int
        """
