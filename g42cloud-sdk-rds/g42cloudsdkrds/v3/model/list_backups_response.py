...
class ListBackupsResponse(SdkResponse):
    ...
    def __init__(self, backups=None, total_count=None):
        ...
        :type backups: list[:class:`g42cloudsdkrds.v3.BackupForList`]
        :param total_count: The param of the ListBackupsResponse
    ...
    def backups(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.BackupForList`]
        """
