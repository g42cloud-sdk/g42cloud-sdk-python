...
class ListAuthorizedDatabasesResponse(SdkResponse):
    ...
    def __init__(self, databases=None, total_count=None):
        ...
        :param databases: The param of the ListAuthorizedDatabasesResponse
        :type databases: list[:class:`g42cloudsdkrds.v3.DatabaseWithPrivilege`]
        :param total_count: The param of the ListAuthorizedDatabasesResponse
    ...
    def databases(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.DatabaseWithPrivilege`]
        """
