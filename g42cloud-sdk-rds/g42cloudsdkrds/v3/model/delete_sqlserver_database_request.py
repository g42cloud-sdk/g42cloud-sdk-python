...
class DeleteSqlserverDatabaseRequest:
    ...
    def __init__(self, x_language=None, instance_id=None, db_name=None, body=None):
        ...
        :param x_language: The param of the DeleteSqlserverDatabaseRequest
        :type x_language: str
        :param instance_id: The param of the DeleteSqlserverDatabaseRequest
        :type instance_id: str
        :param db_name: The param of the DeleteSqlserverDatabaseRequest
        :type db_name: str
        :param body: The param of the DeleteSqlserverDatabaseRequest
