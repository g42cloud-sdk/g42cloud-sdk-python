...
class GenerateAuditlogDownloadLinkRequest:
    ...
    def __init__(self, ids=None):
        ...
        :param ids: The param of the GenerateAuditlogDownloadLinkRequest
        :type ids: list[str]
        """
    ...
    def ids(self):
        ...
        :return: The ids of this GenerateAuditlogDownloadLinkRequest.
        :rtype: list[str]
        """
        return self._ids
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GenerateAuditlogDownloadLinkRequest):
            return False
