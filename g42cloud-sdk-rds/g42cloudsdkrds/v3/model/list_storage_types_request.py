...
class ListStorageTypesRequest:
    ...
    def __init__(self, x_language=None, database_name=None, version_name=None, ha_mode=None):
        ...
        :param x_language: The param of the ListStorageTypesRequest
        :type x_language: str
        :param database_name: The param of the ListStorageTypesRequest
        :type database_name: str
        :param version_name: The param of the ListStorageTypesRequest
        :type version_name: str
        :param ha_mode: The param of the ListStorageTypesRequest
        :type ha_mode: str
        """
