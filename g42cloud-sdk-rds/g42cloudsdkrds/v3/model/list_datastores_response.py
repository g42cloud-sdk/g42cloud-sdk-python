...
class ListDatastoresResponse(SdkResponse):
    ...
    def __init__(self, data_stores=None):
        ...
        :param data_stores: The param of the ListDatastoresResponse
        :type data_stores: list[:class:`g42cloudsdkrds.v3.LDatastore`]
        """
    ...
    def data_stores(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.LDatastore`]
        """
