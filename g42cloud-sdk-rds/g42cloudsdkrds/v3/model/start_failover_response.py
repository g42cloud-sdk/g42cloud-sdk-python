...
class StartFailoverResponse(SdkResponse):
    ...
    def __init__(self, instance_id=None, node_id=None, workflow_id=None):
        ...
        :param instance_id: The param of the StartFailoverResponse
        :type instance_id: str
        :param node_id: The param of the StartFailoverResponse
        :type node_id: str
        :param workflow_id: The param of the StartFailoverResponse
