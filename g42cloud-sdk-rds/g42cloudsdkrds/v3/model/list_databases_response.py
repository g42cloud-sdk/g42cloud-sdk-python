...
class ListDatabasesResponse(SdkResponse):
    ...
    def __init__(self, databases=None, total_count=None):
        ...
        :param databases: The param of the ListDatabasesResponse
        :type databases: list[:class:`g42cloudsdkrds.v3.DatabaseForCreation`]
        :param total_count: The param of the ListDatabasesResponse
    ...
    def databases(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.DatabaseForCreation`]
        """
