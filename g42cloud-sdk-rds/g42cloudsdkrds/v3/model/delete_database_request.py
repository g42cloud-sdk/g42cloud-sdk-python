...
class DeleteDatabaseRequest:
    ...
    def __init__(self, x_language=None, instance_id=None, db_name=None):
        ...
        :param x_language: The param of the DeleteDatabaseRequest
        :type x_language: str
        :param instance_id: The param of the DeleteDatabaseRequest
        :type instance_id: str
        :param db_name: The param of the DeleteDatabaseRequest
        :type db_name: str
        """
