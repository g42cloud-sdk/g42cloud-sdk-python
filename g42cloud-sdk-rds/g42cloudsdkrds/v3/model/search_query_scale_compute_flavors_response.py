...
class SearchQueryScaleComputeFlavorsResponse(SdkResponse):
    ...
    def __init__(self, compute_flavor_groups=None):
        ...
        :param compute_flavor_groups: The param of the SearchQueryScaleComputeFlavorsResponse
        :type compute_flavor_groups: list[:class:`g42cloudsdkrds.v3.Computes`]
        """
    ...
    def compute_flavor_groups(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.Computes`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SearchQueryScaleComputeFlavorsResponse):
            return False
