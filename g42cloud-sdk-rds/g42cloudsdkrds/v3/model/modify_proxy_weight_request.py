...
class ModifyProxyWeightRequest:
    ...
    def __init__(self, master_weight=None, readonly_instances=None):
        ...
        :param master_weight: The param of the ModifyProxyWeightRequest
        :type master_weight: str
        :param readonly_instances: The param of the ModifyProxyWeightRequest
        :type readonly_instances: list[:class:`g42cloudsdkrds.v3.ProxyReadonlyInstances`]
        """
    ...
    def readonly_instances(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.ProxyReadonlyInstances`]
        """
