...
class ListErrorLogsRequest:
    ...
    def __init__(self, x_language=None, instance_id=None, start_date=None, end_date=None, offset=None, limit=None, level=None):
        ...
        :param x_language: The param of the ListErrorLogsRequest
        :type x_language: str
        :param instance_id: The param of the ListErrorLogsRequest
        :type instance_id: str
        :param start_date: The param of the ListErrorLogsRequest
        :type start_date: str
        :param end_date: The param of the ListErrorLogsRequest
        :type end_date: str
        :param offset: The param of the ListErrorLogsRequest
        :type offset: int
        :param limit: The param of the ListErrorLogsRequest
        :type limit: int
        :param level: The param of the ListErrorLogsRequest
        :type level: str
        """
