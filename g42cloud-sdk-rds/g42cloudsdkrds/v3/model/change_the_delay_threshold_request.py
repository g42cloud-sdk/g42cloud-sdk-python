...
class ChangeTheDelayThresholdRequest:
    ...
    def __init__(self, x_language=None, instance_id=None, body=None):
        ...
        :param x_language: The param of the ChangeTheDelayThresholdRequest
        :type x_language: str
        :param instance_id: The param of the ChangeTheDelayThresholdRequest
        :type instance_id: str
        :param body: The param of the ChangeTheDelayThresholdRequest
        :type body: :class:`g42cloudsdkrds.v3.ChangingTheDelayThresholdRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkrds.v3.ChangingTheDelayThresholdRequestBody`
        """
        return self._body
