...
class ShowOffSiteBackupPolicyResponse(SdkResponse):
    ...
    def __init__(self, policy_para=None):
        ...
        :param policy_para: The param of the ShowOffSiteBackupPolicyResponse
        :type policy_para: list[:class:`g42cloudsdkrds.v3.GetOffSiteBackupPolicy`]
        """
    ...
    def policy_para(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.GetOffSiteBackupPolicy`]
        """
