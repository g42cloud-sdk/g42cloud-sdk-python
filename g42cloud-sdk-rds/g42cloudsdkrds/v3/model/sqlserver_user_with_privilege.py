...
class SqlserverUserWithPrivilege:
    ...
    def __init__(self, name=None, readonly=None):
        ...
        :param name: The param of the SqlserverUserWithPrivilege
        :type name: str
        :param readonly: The param of the SqlserverUserWithPrivilege
        :type readonly: bool
        """
    ...
    def name(self):
        ...
        :return: The name of this SqlserverUserWithPrivilege.
        :rtype: str
        """
        return self._name
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SqlserverUserWithPrivilege):
            return False
