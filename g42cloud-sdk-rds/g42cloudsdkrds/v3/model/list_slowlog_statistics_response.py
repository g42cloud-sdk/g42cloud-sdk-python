...
class ListSlowlogStatisticsResponse(SdkResponse):
    ...
    def __init__(self, page_number=None, page_record=None, slow_log_list=None, total_record=None, start_time=None, end_time=None):
        ...
        :param page_number: The param of the ListSlowlogStatisticsResponse
        :type page_number: int
        :param page_record: The param of the ListSlowlogStatisticsResponse
        :type page_record: int
        :param slow_log_list: The param of the ListSlowlogStatisticsResponse
        :type slow_log_list: list[:class:`g42cloudsdkrds.v3.SlowLogStatistics`]
        :param total_record: The param of the ListSlowlogStatisticsResponse
        :type total_record: int
        :param start_time: The param of the ListSlowlogStatisticsResponse
        :type start_time: int
        :param end_time: The param of the ListSlowlogStatisticsResponse
        :type end_time: int
        """
    ...
    def slow_log_list(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.SlowLogStatistics`]
        """
