...
class BatchTagActionDelRequestBody:
    ...
    def __init__(self, action=None, tags=None):
        ...
        :param action: The param of the BatchTagActionDelRequestBody
        :type action: str
        :param tags: The param of the BatchTagActionDelRequestBody
        :type tags: list[:class:`g42cloudsdkrds.v3.TagDelWithKeyValue`]
        """
    ...
    def tags(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.TagDelWithKeyValue`]
        """
        return self._tags
