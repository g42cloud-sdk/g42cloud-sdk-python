...
class ListOffSiteInstancesResponse(SdkResponse):
    ...
    def __init__(self, offsite_backup_instances=None, total_count=None):
        ...
        :param offsite_backup_instances: The param of the ListOffSiteInstancesResponse
        :type offsite_backup_instances: list[:class:`g42cloudsdkrds.v3.OffsiteBackupInstance`]
        :param total_count: The param of the ListOffSiteInstancesResponse
    ...
    def offsite_backup_instances(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.OffsiteBackupInstance`]
        """
