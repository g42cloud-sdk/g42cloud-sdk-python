...
class DeleteDbUserRequest:
    ...
    def __init__(self, x_language=None, instance_id=None, user_name=None):
        ...
        :param x_language: The param of the DeleteDbUserRequest
        :type x_language: str
        :param instance_id: The param of the DeleteDbUserRequest
        :type instance_id: str
        :param user_name: The param of the DeleteDbUserRequest
        :type user_name: str
        """
