...
class ApplyConfigurationResponseApplyResults:
    ...
    def __init__(self, instance_id=None, instance_name=None, restart_required=None, success=None):
        ...
        :param instance_id: The param of the ApplyConfigurationResponseApplyResults
        :type instance_id: str
        :param instance_name: The param of the ApplyConfigurationResponseApplyResults
        :type instance_name: str
        :param restart_required: The param of the ApplyConfigurationResponseApplyResults
        :type restart_required: bool
        :param success: The param of the ApplyConfigurationResponseApplyResults
        :type success: bool
        """
