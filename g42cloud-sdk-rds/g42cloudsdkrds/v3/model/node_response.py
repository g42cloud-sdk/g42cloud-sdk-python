...
class NodeResponse:
    ...
    def __init__(self, id=None, name=None, role=None, status=None, availability_zone=None):
        ...
        :param id: The param of the NodeResponse
        :type id: str
        :param name: The param of the NodeResponse
        :type name: str
        :param role: The param of the NodeResponse
        :type role: str
        :param status: The param of the NodeResponse
        :type status: str
        :param availability_zone: The param of the NodeResponse
