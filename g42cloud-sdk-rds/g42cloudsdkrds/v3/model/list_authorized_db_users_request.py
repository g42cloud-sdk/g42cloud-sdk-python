...
class ListAuthorizedDbUsersRequest:
    ...
    def __init__(self, x_language=None, instance_id=None, db_name=None, page=None, limit=None):
        ...
        :param x_language: The param of the ListAuthorizedDbUsersRequest
        :type x_language: str
        :param instance_id: The param of the ListAuthorizedDbUsersRequest
        :type instance_id: str
        :param db_name: The param of the ListAuthorizedDbUsersRequest
        :type db_name: str
        :param page: The param of the ListAuthorizedDbUsersRequest
        :type page: int
        :param limit: The param of the ListAuthorizedDbUsersRequest
        :type limit: int
        """
