...
class ListDbUsersRequest:
    ...
    def __init__(self, x_language=None, instance_id=None, page=None, limit=None):
        ...
        :param x_language: The param of the ListDbUsersRequest
        :type x_language: str
        :param instance_id: The param of the ListDbUsersRequest
        :type instance_id: str
        :param page: The param of the ListDbUsersRequest
        :type page: int
        :param limit: The param of the ListDbUsersRequest
        :type limit: int
        """
