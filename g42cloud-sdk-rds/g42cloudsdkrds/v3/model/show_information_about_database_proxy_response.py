...
class ShowInformationAboutDatabaseProxyResponse(SdkResponse):
    ...
    def __init__(self, proxy=None, master_instance=None, readonly_instances=None):
        ...
        :param proxy: The param of the ShowInformationAboutDatabaseProxyResponse
        :type proxy: :class:`g42cloudsdkrds.v3.Proxy`
        :param master_instance: The param of the ShowInformationAboutDatabaseProxyResponse
        :type master_instance: :class:`g42cloudsdkrds.v3.MasterInstance`
        :param readonly_instances: The param of the ShowInformationAboutDatabaseProxyResponse
        :type readonly_instances: list[:class:`g42cloudsdkrds.v3.ReadonlyInstances`]
        """
    ...
    def proxy(self):
        ...
        :rtype: :class:`g42cloudsdkrds.v3.Proxy`
        """
        return self._proxy
    ...
    def master_instance(self):
        ...
        :rtype: :class:`g42cloudsdkrds.v3.MasterInstance`
        """
    ...
    def readonly_instances(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.ReadonlyInstances`]
        """
