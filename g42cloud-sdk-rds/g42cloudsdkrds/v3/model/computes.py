...
class Computes:
    ...
    def __init__(self, group_type=None, compute_flavors=None):
        ...
        :param group_type: The param of the Computes
        :type group_type: str
        :param compute_flavors: The param of the Computes
        :type compute_flavors: list[:class:`g42cloudsdkrds.v3.ScaleFlavors`]
        """
    ...
    def compute_flavors(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.ScaleFlavors`]
        """
