...
class ListOffSiteBackupsResponse(SdkResponse):
    ...
    def __init__(self, backups=None, total_count=None):
        ...
        :param backups: The param of the ListOffSiteBackupsResponse
        :type backups: list[:class:`g42cloudsdkrds.v3.OffSiteBackupForList`]
        :param total_count: The param of the ListOffSiteBackupsResponse
    ...
    def backups(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.OffSiteBackupForList`]
        """
