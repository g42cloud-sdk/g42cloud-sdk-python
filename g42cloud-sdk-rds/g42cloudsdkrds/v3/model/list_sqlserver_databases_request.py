...
class ListSqlserverDatabasesRequest:
    ...
    def __init__(self, x_language=None, instance_id=None, page=None, limit=None, db_name=None):
        ...
        :param x_language: The param of the ListSqlserverDatabasesRequest
        :type x_language: str
        :param instance_id: The param of the ListSqlserverDatabasesRequest
        :type instance_id: str
        :param page: The param of the ListSqlserverDatabasesRequest
        :type page: int
        :param limit: The param of the ListSqlserverDatabasesRequest
        :type limit: int
        :param db_name: The param of the ListSqlserverDatabasesRequest
        :type db_name: str
        """
