...
class ListAuthorizedDatabasesRequest:
    ...
    def __init__(self, x_language=None, instance_id=None, user_name=None, page=None, limit=None):
        ...
        :param x_language: The param of the ListAuthorizedDatabasesRequest
        :type x_language: str
        :param instance_id: The param of the ListAuthorizedDatabasesRequest
        :type instance_id: str
        :param user_name: The param of the ListAuthorizedDatabasesRequest
        :type user_name: str
        :param page: The param of the ListAuthorizedDatabasesRequest
        :type page: int
        :param limit: The param of the ListAuthorizedDatabasesRequest
        :type limit: int
        """
