...
class SqlserverDatabaseForDetail:
    ...
    def __init__(self, name=None, character_set=None, state=None):
        ...
        :param name: The param of the SqlserverDatabaseForDetail
        :type name: str
        :param character_set: The param of the SqlserverDatabaseForDetail
        :type character_set: str
        :param state: The param of the SqlserverDatabaseForDetail
        :type state: str
        """
