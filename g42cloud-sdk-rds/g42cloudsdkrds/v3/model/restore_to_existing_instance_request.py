...
class RestoreToExistingInstanceRequest:
    ...
    def __init__(self, x_language=None, body=None):
        ...
        :param x_language: The param of the RestoreToExistingInstanceRequest
        :type x_language: str
        :param body: The param of the RestoreToExistingInstanceRequest
        :type body: :class:`g42cloudsdkrds.v3.RestoreToExistingInstanceRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkrds.v3.RestoreToExistingInstanceRequestBody`
        """
        return self._body
