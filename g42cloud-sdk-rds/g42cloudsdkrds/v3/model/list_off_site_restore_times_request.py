...
class ListOffSiteRestoreTimesRequest:
    ...
    def __init__(self, x_language=None, instance_id=None, date=None):
        ...
        :param x_language: The param of the ListOffSiteRestoreTimesRequest
        :type x_language: str
        :param instance_id: The param of the ListOffSiteRestoreTimesRequest
        :type instance_id: str
        :param date: The param of the ListOffSiteRestoreTimesRequest
        :type date: str
        """
