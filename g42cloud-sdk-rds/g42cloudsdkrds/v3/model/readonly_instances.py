...
class ReadonlyInstances:
    ...
    def __init__(self, id=None, status=None, name=None, weight=None, available_zones=None, cpu_num=None):
        ...
        :param id: The param of the ReadonlyInstances
        :type id: str
        :param status: The param of the ReadonlyInstances
        :type status: str
        :param name: The param of the ReadonlyInstances
        :type name: str
        :param weight: The param of the ReadonlyInstances
        :type weight: int
        :param available_zones: The param of the ReadonlyInstances
        :type available_zones: list[:class:`g42cloudsdkrds.v3.AvailableZone`]
        :param cpu_num: The param of the ReadonlyInstances
        :type cpu_num: int
        """
    ...
    def id(self):
        ...
        :return: The id of this ReadonlyInstances.
        :rtype: str
        """
        return self._id
    ...
    def status(self):
        ...
        :return: The status of this ReadonlyInstances.
        :rtype: str
        """
        return self._status
    ...
    def name(self):
        ...
        :return: The name of this ReadonlyInstances.
        :rtype: str
        """
        return self._name
    ...
    def weight(self):
        ...
        :return: The weight of this ReadonlyInstances.
        :rtype: int
        """
        return self._weight
    ...
    def cpu_num(self):
        ...
        :return: The cpu_num of this ReadonlyInstances.
        :rtype: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReadonlyInstances):
            return False
