...
class ChangeFailoverModeResponse(SdkResponse):
    ...
    def __init__(self, instance_id=None, replication_mode=None, workflow_id=None):
        ...
        :param instance_id: The param of the ChangeFailoverModeResponse
        :type instance_id: str
        :param replication_mode: The param of the ChangeFailoverModeResponse
        :type replication_mode: str
        :param workflow_id: The param of the ChangeFailoverModeResponse
