...
class ListFlavorsRequest:
    ...
    def __init__(self, x_language=None, database_name=None, version_name=None, spec_code=None):
        ...
        :param x_language: The param of the ListFlavorsRequest
        :type x_language: str
        :param database_name: The param of the ListFlavorsRequest
        :type database_name: str
        :param version_name: The param of the ListFlavorsRequest
        :type version_name: str
        :param spec_code: The param of the ListFlavorsRequest
        :type spec_code: str
        """
