...
class RevokeRequestBody:
    ...
    def __init__(self, db_name=None, users=None):
        ...
        :param db_name: The param of the RevokeRequestBody
        :type db_name: str
        :param users: The param of the RevokeRequestBody
        :type users: list[:class:`g42cloudsdkrds.v3.RevokeRequestBodyUsers`]
        """
    ...
    def users(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.RevokeRequestBodyUsers`]
        """
        return self._users
