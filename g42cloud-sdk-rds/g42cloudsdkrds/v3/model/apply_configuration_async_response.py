...
class ApplyConfigurationAsyncResponse(SdkResponse):
    ...
    def __init__(self, configuration_id=None, configuration_name=None, success=None, job_id=None):
        ...
        :param configuration_id: The param of the ApplyConfigurationAsyncResponse
        :type configuration_id: str
        :param configuration_name: The param of the ApplyConfigurationAsyncResponse
        :type configuration_name: str
        :param success: The param of the ApplyConfigurationAsyncResponse
        :type success: bool
        :param job_id: The param of the ApplyConfigurationAsyncResponse
        :type job_id: str
        """
