...
class PwdResetRequest:
    ...
    def __init__(self, db_user_pwd=None):
        ...
        :param db_user_pwd: The param of the PwdResetRequest
        :type db_user_pwd: str
        """
        
        

        self._db_user_pwd = None
    ...
    def db_user_pwd(self):
        ...
        :return: The db_user_pwd of this PwdResetRequest.
        :rtype: str
        """
        return self._db_user_pwd

    @db_user_pwd.setter
    def db_user_pwd(self, db_user_pwd):
        """Sets the db_user_pwd of this PwdResetRequest.

        :param db_user_pwd: The db_user_pwd of this PwdResetRequest.
        :type db_user_pwd: str
        """
        self._db_user_pwd = db_user_pwd
