...
class ListPostgresqlDbUserPaginatedResponse(SdkResponse):
    ...
    def __init__(self, users=None, total_count=None):
        ...
        :param users: The param of the ListPostgresqlDbUserPaginatedResponse
        :type users: list[:class:`g42cloudsdkrds.v3.PostgresqlUserForList`]
        :param total_count: The param of the ListPostgresqlDbUserPaginatedResponse
    ...
    def users(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.PostgresqlUserForList`]
        """
        return self._users
