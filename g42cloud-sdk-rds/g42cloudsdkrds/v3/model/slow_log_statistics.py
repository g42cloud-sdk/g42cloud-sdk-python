...
class SlowLogStatistics:
    ...
    def __init__(self, count=None, time=None, lock_time=None, rows_sent=None, rows_examined=None, database=None, users=None, query_sample=None, type=None, client_ip=None):
        ...
        :param count: The param of the SlowLogStatistics
        :type count: str
        :param time: The param of the SlowLogStatistics
        :type time: str
        :param lock_time: The param of the SlowLogStatistics
        :type lock_time: str
        :param rows_sent: The param of the SlowLogStatistics
        :type rows_sent: int
        :param rows_examined: The param of the SlowLogStatistics
        :type rows_examined: int
        :param database: The param of the SlowLogStatistics
        :type database: str
        :param users: The param of the SlowLogStatistics
        :type users: str
        :param query_sample: The param of the SlowLogStatistics
        :type query_sample: str
        :param type: The param of the SlowLogStatistics
        :type type: str
        :param client_ip: The param of the SlowLogStatistics
        :type client_ip: str
        """
