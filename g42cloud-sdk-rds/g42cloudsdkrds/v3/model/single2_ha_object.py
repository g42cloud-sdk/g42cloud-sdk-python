...
class Single2HaObject:
    ...
    def __init__(self, az_code_new_node=None, dsspool_id=None, is_auto_pay=None, ad_domain_info=None):
        ...
        :param az_code_new_node: The param of the Single2HaObject
        :type az_code_new_node: str
        :param dsspool_id: The param of the Single2HaObject
        :type dsspool_id: str
        :param is_auto_pay: The param of the Single2HaObject
        :type is_auto_pay: bool
        :param ad_domain_info: The param of the Single2HaObject
        :type ad_domain_info: :class:`g42cloudsdkrds.v3.ADDomainInfo`
        """
    ...
    def ad_domain_info(self):
        ...
        :rtype: :class:`g42cloudsdkrds.v3.ADDomainInfo`
        """
