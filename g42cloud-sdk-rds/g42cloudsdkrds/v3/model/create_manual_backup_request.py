...
class CreateManualBackupRequest:
    ...
    def __init__(self, x_language=None, body=None):
        ...
        :param x_language: The param of the CreateManualBackupRequest
        :type x_language: str
        :param body: The param of the CreateManualBackupRequest
        :type body: :class:`g42cloudsdkrds.v3.CreateManualBackupRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkrds.v3.CreateManualBackupRequestBody`
        """
        return self._body
