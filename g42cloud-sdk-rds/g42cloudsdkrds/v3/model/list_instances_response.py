...
class ListInstancesResponse(SdkResponse):
    ...
    def __init__(self, instances=None, total_count=None):
        ...
        :param instances: The param of the ListInstancesResponse
        :type instances: list[:class:`g42cloudsdkrds.v3.InstanceResponse`]
        :param total_count: The param of the ListInstancesResponse
    ...
    def instances(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.InstanceResponse`]
        """
