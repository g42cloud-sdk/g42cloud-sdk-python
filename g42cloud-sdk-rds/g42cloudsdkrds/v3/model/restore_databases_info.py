...
class RestoreDatabasesInfo:
    ...
    def __init__(self, database=None, tables=None):
        ...
        :param database: The param of the RestoreDatabasesInfo
        :type database: str
        :param tables: The param of the RestoreDatabasesInfo
        :type tables: list[:class:`g42cloudsdkrds.v3.RestoreTableInfo`]
        """
    ...
    def tables(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.RestoreTableInfo`]
        """
        return self._tables
