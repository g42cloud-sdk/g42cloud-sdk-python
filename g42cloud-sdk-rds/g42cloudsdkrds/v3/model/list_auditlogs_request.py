...
class ListAuditlogsRequest:
    ...
    def __init__(self, x_language=None, instance_id=None, start_time=None, end_time=None, offset=None, limit=None):
        ...
        :param x_language: The param of the ListAuditlogsRequest
        :type x_language: str
        :param instance_id: The param of the ListAuditlogsRequest
        :type instance_id: str
        :param start_time: The param of the ListAuditlogsRequest
        :type start_time: str
        :param end_time: The param of the ListAuditlogsRequest
        :type end_time: str
        :param offset: The param of the ListAuditlogsRequest
        :type offset: int
        :param limit: The param of the ListAuditlogsRequest
        :type limit: int
        """
