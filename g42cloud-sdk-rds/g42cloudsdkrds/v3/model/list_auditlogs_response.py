...
class ListAuditlogsResponse(SdkResponse):
    ...
    def __init__(self, auditlogs=None, total_record=None):
        ...
        :param auditlogs: The param of the ListAuditlogsResponse
        :type auditlogs: list[:class:`g42cloudsdkrds.v3.Auditlog`]
        :param total_record: The param of the ListAuditlogsResponse
    ...
    def auditlogs(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.Auditlog`]
        """
