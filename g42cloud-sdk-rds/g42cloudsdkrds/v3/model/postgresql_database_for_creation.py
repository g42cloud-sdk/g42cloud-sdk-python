...
class PostgresqlDatabaseForCreation:
    ...
    def __init__(self, name=None, character_set=None, owner=None, template=None, lc_collate=None, lc_ctype=None):
        ...
        :param name: The param of the PostgresqlDatabaseForCreation
        :type name: str
        :param character_set: The param of the PostgresqlDatabaseForCreation
        :type character_set: str
        :param owner: The param of the PostgresqlDatabaseForCreation
        :type owner: str
        :param template: The param of the PostgresqlDatabaseForCreation
        :type template: str
        :param lc_collate: The param of the PostgresqlDatabaseForCreation
        :type lc_collate: str
        :param lc_ctype: The param of the PostgresqlDatabaseForCreation
        :type lc_ctype: str
        """
