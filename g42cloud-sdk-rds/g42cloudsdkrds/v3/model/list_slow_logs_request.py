...
class ListSlowLogsRequest:
    ...
    def __init__(self, x_language=None, instance_id=None, start_date=None, end_date=None, offset=None, limit=None, type=None):
        ...
        :param x_language: The param of the ListSlowLogsRequest
        :type x_language: str
        :param instance_id: The param of the ListSlowLogsRequest
        :type instance_id: str
        :param start_date: The param of the ListSlowLogsRequest
        :type start_date: str
        :param end_date: The param of the ListSlowLogsRequest
        :type end_date: str
        :param offset: The param of the ListSlowLogsRequest
        :type offset: int
        :param limit: The param of the ListSlowLogsRequest
        :type limit: int
        :param type: The param of the ListSlowLogsRequest
        :type type: str
        """
