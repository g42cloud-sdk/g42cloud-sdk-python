...
class SlowlogDownloadInfo:
    ...
    def __init__(self, workflow_id=None, file_name=None, status=None, file_size=None, file_link=None, create_at=None, update_at=None):
        ...
        :param workflow_id: The param of the SlowlogDownloadInfo
        :type workflow_id: str
        :param file_name: The param of the SlowlogDownloadInfo
        :type file_name: str
        :param status: The param of the SlowlogDownloadInfo
        :type status: str
        :param file_size: The param of the SlowlogDownloadInfo
        :type file_size: str
        :param file_link: The param of the SlowlogDownloadInfo
        :type file_link: str
        :param create_at: The param of the SlowlogDownloadInfo
        :type create_at: int
        :param update_at: The param of the SlowlogDownloadInfo
        :type update_at: int
        """
