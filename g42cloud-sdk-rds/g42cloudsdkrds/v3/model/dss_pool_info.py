...
class DssPoolInfo:
    ...
    def __init__(self, az_name=None, free_capacity_gb=None, dsspool_volume_type=None, dsspool_id=None, dsspool_status=None):
        ...
        :param az_name: The param of the DssPoolInfo
        :type az_name: str
        :param free_capacity_gb: The param of the DssPoolInfo
        :type free_capacity_gb: str
        :param dsspool_volume_type: The param of the DssPoolInfo
        :type dsspool_volume_type: str
        :param dsspool_id: The param of the DssPoolInfo
        :type dsspool_id: str
        :param dsspool_status: The param of the DssPoolInfo
