...
class DownloadSlowlogResponse(SdkResponse):
    ...
    def __init__(self, list=None, status=None, count=None):
        ...
        :param list: The param of the DownloadSlowlogResponse
        :type list: list[:class:`g42cloudsdkrds.v3.SlowlogDownloadInfo`]
        :param status: The param of the DownloadSlowlogResponse
        :type status: str
        :param count: The param of the DownloadSlowlogResponse
        :type count: int
        """
    ...
    def list(self):
        ...
        :rtype: list[:class:`g42cloudsdkrds.v3.SlowlogDownloadInfo`]
        """
        return self._list
