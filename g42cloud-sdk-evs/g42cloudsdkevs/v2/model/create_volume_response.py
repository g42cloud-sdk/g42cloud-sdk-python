...
class CreateVolumeResponse(SdkResponse):
    ...
    def __init__(self, job_id=None, order_id=None, volume_ids=None):
        ...
        :param job_id: The param of the CreateVolumeResponse
        :type job_id: str
        :param order_id: The param of the CreateVolumeResponse
        :type order_id: str
        :param volume_ids: The param of the CreateVolumeResponse
