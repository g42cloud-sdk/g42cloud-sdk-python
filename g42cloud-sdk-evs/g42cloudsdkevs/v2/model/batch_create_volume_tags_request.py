...
class BatchCreateVolumeTagsRequest:
    ...
    def __init__(self, volume_id=None, body=None):
        ...
        :param volume_id: The param of the BatchCreateVolumeTagsRequest
        :type volume_id: str
        :param body: The param of the BatchCreateVolumeTagsRequest
        :type body: :class:`g42cloudsdkevs.v2.BatchCreateVolumeTagsRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkevs.v2.BatchCreateVolumeTagsRequestBody`
        """
        return self._body
