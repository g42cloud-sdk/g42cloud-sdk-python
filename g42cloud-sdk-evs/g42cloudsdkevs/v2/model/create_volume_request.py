...
class CreateVolumeRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the CreateVolumeRequest
        :type body: :class:`g42cloudsdkevs.v2.CreateVolumeRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkevs.v2.CreateVolumeRequestBody`
        """
        return self._body
