...
class VolumeTypeExtraSpecs:
    ...
    def __init__(self, reske_yavailability_zones=None, availability_zone=None, os_vendor_extendedsold_out_availability_zones=None, volume_backend_name=None, h_wavailability_zone=None):
        ...
        :param reske_yavailability_zones: The param of the VolumeTypeExtraSpecs
        :type reske_yavailability_zones: str
        :param availability_zone: The param of the VolumeTypeExtraSpecs
        :type availability_zone: str
        :param os_vendor_extendedsold_out_availability_zones: The param of the VolumeTypeExtraSpecs
        :type os_vendor_extendedsold_out_availability_zones: str
        :param volume_backend_name: The param of the VolumeTypeExtraSpecs
        :type volume_backend_name: str
        :param h_wavailability_zone: The param of the VolumeTypeExtraSpecs
