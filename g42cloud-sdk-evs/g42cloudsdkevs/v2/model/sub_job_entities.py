...
class SubJobEntities:
    ...
    def __init__(self, volume_type=None, size=None, volume_id=None, name=None):
        ...
        :param volume_type: The param of the SubJobEntities
        :type volume_type: str
        :param size: The param of the SubJobEntities
        :type size: int
        :param volume_id: The param of the SubJobEntities
        :type volume_id: str
        :param name: The param of the SubJobEntities
        :type name: str
        """
