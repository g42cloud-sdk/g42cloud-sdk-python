...
class QuotaDetailVolumesSAS:
    ...
    def __init__(self, in_use=None, limit=None, reserved=None):
        ...
        :param in_use: The param of the QuotaDetailVolumesSAS
        :type in_use: int
        :param limit: The param of the QuotaDetailVolumesSAS
        :type limit: int
        :param reserved: The param of the QuotaDetailVolumesSAS
        :type reserved: int
        """
