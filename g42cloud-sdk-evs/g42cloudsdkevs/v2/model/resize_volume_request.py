...
class ResizeVolumeRequest:
    ...
    def __init__(self, volume_id=None, body=None):
        ...
        :param volume_id: The param of the ResizeVolumeRequest
        :type volume_id: str
        :param body: The param of the ResizeVolumeRequest
        :type body: :class:`g42cloudsdkevs.v2.ResizeVolumeRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkevs.v2.ResizeVolumeRequestBody`
        """
        return self._body
