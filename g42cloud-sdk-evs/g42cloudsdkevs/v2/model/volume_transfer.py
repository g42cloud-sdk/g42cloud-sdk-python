...
class VolumeTransfer:
    ...
    def __init__(self, created_at=None, id=None, links=None, name=None, volume_id=None):
        ...
        :param created_at: The param of the VolumeTransfer
        :type created_at: str
        :param id: The param of the VolumeTransfer
        :type id: str
        :param links: The param of the VolumeTransfer
        :type links: list[:class:`g42cloudsdkevs.v2.Link`]
        :param name: The param of the VolumeTransfer
        :type name: str
        :param volume_id: The param of the VolumeTransfer
        :type volume_id: str
        """
