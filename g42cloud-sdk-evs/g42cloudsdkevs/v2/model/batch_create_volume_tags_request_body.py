...
class BatchCreateVolumeTagsRequestBody:
    ...
    def __init__(self, action=None, tags=None):
        ...
        :param action: The param of the BatchCreateVolumeTagsRequestBody
        :type action: str
        :param tags: The param of the BatchCreateVolumeTagsRequestBody
        :type tags: list[:class:`g42cloudsdkevs.v2.Tag`]
        """
    ...
    def tags(self):
        ...
        :rtype: list[:class:`g42cloudsdkevs.v2.Tag`]
        """
        return self._tags
