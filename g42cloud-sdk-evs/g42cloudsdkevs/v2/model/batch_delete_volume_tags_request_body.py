...
class BatchDeleteVolumeTagsRequestBody:
    ...
    def __init__(self, action=None, tags=None):
        ...
        :param action: The param of the BatchDeleteVolumeTagsRequestBody
        :type action: str
        :param tags: The param of the BatchDeleteVolumeTagsRequestBody
        :type tags: list[:class:`g42cloudsdkevs.v2.DeleteTagsOption`]
        """
    ...
    def tags(self):
        ...
        :rtype: list[:class:`g42cloudsdkevs.v2.DeleteTagsOption`]
        """
        return self._tags
