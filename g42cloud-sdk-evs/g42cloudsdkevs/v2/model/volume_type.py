...
class VolumeType:
    ...
    def __init__(self, id=None, name=None, extra_specs=None, description=None, qos_specs_id=None, is_public=None):
        ...
        :param id: The param of the VolumeType
        :type id: str
        :param name: The param of the VolumeType
        :type name: str
        :param extra_specs: The param of the VolumeType
        :type extra_specs: :class:`g42cloudsdkevs.v2.VolumeTypeExtraSpecs`
        :param description: The param of the VolumeType
        :type description: str
        :param qos_specs_id: The param of the VolumeType
        :type qos_specs_id: str
        :param is_public: The param of the VolumeType
        :type is_public: bool
        """
    ...
    def extra_specs(self):
        ...
        :rtype: :class:`g42cloudsdkevs.v2.VolumeTypeExtraSpecs`
        """
