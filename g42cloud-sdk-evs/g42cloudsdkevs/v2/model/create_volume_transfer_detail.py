...
class CreateVolumeTransferDetail:
    ...
    def __init__(self, auth_key=None, created_at=None, id=None, links=None, name=None, volume_id=None):
        ...
        :param auth_key: The param of the CreateVolumeTransferDetail
        :type auth_key: str
        :param created_at: The param of the CreateVolumeTransferDetail
        :type created_at: str
        :param id: The param of the CreateVolumeTransferDetail
        :type id: str
        :param links: The param of the CreateVolumeTransferDetail
        :type links: list[:class:`g42cloudsdkevs.v2.Link`]
        :param name: The param of the CreateVolumeTransferDetail
        :type name: str
        :param volume_id: The param of the CreateVolumeTransferDetail
        :type volume_id: str
        """
