...
class ListSnapshotsRequest:
    ...
    def __init__(self, offset=None, limit=None, name=None, status=None, volume_id=None, availability_zone=None, id=None, dedicated_storage_name=None, dedicated_storage_id=None, service_type=None, enterprise_project_id=None):
        ...
        :param offset: The param of the ListSnapshotsRequest
        :type offset: int
        :param limit: The param of the ListSnapshotsRequest
        :type limit: int
        :param name: The param of the ListSnapshotsRequest
        :type name: str
        :param status: The param of the ListSnapshotsRequest
        :type status: str
        :param volume_id: The param of the ListSnapshotsRequest
        :type volume_id: str
        :param availability_zone: The param of the ListSnapshotsRequest
        :type availability_zone: str
        :param id: The param of the ListSnapshotsRequest
        :type id: str
        :param dedicated_storage_name: The param of the ListSnapshotsRequest
        :type dedicated_storage_name: str
        :param dedicated_storage_id: The param of the ListSnapshotsRequest
        :type dedicated_storage_id: str
        :param service_type: The param of the ListSnapshotsRequest
        :type service_type: str
        :param enterprise_project_id: The param of the ListSnapshotsRequest
