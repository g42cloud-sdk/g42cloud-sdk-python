...
class UpdateVolumeRequest:
    ...
    def __init__(self, volume_id=None, body=None):
        ...
        :param volume_id: The param of the UpdateVolumeRequest
        :type volume_id: str
        :param body: The param of the UpdateVolumeRequest
        :type body: :class:`g42cloudsdkevs.v2.UpdateVolumeRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkevs.v2.UpdateVolumeRequestBody`
        """
        return self._body
