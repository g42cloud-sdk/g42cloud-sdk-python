...
class VolumeTransferSummary:
    ...
    def __init__(self, id=None, links=None, name=None, volume_id=None):
        ...
        :param id: The param of the VolumeTransferSummary
        :type id: str
        :param links: The param of the VolumeTransferSummary
        :type links: list[:class:`g42cloudsdkevs.v2.Link`]
        :param name: The param of the VolumeTransferSummary
        :type name: str
        :param volume_id: The param of the VolumeTransferSummary
        :type volume_id: str
        """
