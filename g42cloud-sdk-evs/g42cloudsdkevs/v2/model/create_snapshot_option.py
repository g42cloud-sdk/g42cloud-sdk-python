...
class CreateSnapshotOption:
    ...
    def __init__(self, volume_id=None, force=None, metadata=None, description=None, name=None):
        ...
        :param volume_id: The param of the CreateSnapshotOption
        :type volume_id: str
        :param force: The param of the CreateSnapshotOption
        :type force: bool
        :param metadata: The param of the CreateSnapshotOption
        :type metadata: dict(str, str)
        :param description: The param of the CreateSnapshotOption
        :type description: str
        :param name: The param of the CreateSnapshotOption
        :type name: str
        """
