...
class BssParamForCreateVolume:
    ...
    def __init__(self, charging_mode=None, is_auto_pay=None, is_auto_renew=None, period_num=None, period_type=None):
        ...
        :param charging_mode: The param of the BssParamForCreateVolume
        :type charging_mode: str
        :param is_auto_pay: The param of the BssParamForCreateVolume
        :type is_auto_pay: str
        :param is_auto_renew: The param of the BssParamForCreateVolume
        :type is_auto_renew: str
        :param period_num: The param of the BssParamForCreateVolume
        :type period_num: int
        :param period_type: The param of the BssParamForCreateVolume
