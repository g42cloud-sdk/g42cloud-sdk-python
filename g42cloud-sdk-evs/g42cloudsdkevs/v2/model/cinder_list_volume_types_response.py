...
class CinderListVolumeTypesResponse(SdkResponse):
    ...
    def __init__(self, volume_types=None):
        ...
        :param volume_types: The param of the CinderListVolumeTypesResponse
        :type volume_types: list[:class:`g42cloudsdkevs.v2.VolumeType`]
        """
    ...
    def volume_types(self):
        ...
        :rtype: list[:class:`g42cloudsdkevs.v2.VolumeType`]
        """
