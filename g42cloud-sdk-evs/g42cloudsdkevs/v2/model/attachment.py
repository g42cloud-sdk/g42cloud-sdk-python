...
class Attachment:
    ...
    def __init__(self, attached_at=None, attachment_id=None, device=None, host_name=None, id=None, server_id=None, volume_id=None):
        ...
        :param attached_at: The param of the Attachment
        :type attached_at: str
        :param attachment_id: The param of the Attachment
        :type attachment_id: str
        :param device: The param of the Attachment
        :type device: str
        :param host_name: The param of the Attachment
        :type host_name: str
        :param id: The param of the Attachment
        :type id: str
        :param server_id: The param of the Attachment
        :type server_id: str
        :param volume_id: The param of the Attachment
        :type volume_id: str
        """
