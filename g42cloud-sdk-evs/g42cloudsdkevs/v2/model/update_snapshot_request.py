...
class UpdateSnapshotRequest:
    ...
    def __init__(self, snapshot_id=None, body=None):
        ...
        :param snapshot_id: The param of the UpdateSnapshotRequest
        :type snapshot_id: str
        :param body: The param of the UpdateSnapshotRequest
        :type body: :class:`g42cloudsdkevs.v2.UpdateSnapshotRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkevs.v2.UpdateSnapshotRequestBody`
        """
        return self._body
