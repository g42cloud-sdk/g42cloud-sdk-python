...
class ListVolumesByTagsResponse(SdkResponse):
    ...
    def __init__(self, total_count=None, resources=None):
        ...
        :param total_count: The param of the ListVolumesByTagsResponse
        :type total_count: int
        :param resources: The param of the ListVolumesByTagsResponse
        :type resources: list[:class:`g42cloudsdkevs.v2.Resource`]
        """
    ...
    def resources(self):
        ...
        :rtype: list[:class:`g42cloudsdkevs.v2.Resource`]
        """
