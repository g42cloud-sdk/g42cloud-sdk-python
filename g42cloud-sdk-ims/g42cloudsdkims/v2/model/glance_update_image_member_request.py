...
class GlanceUpdateImageMemberRequest:
    ...
    def __init__(self, image_id=None, member_id=None, body=None):
        ...
        :param image_id: The param of the GlanceUpdateImageMemberRequest
        :type image_id: str
        :param member_id: The param of the GlanceUpdateImageMemberRequest
        :type member_id: str
        :param body: The param of the GlanceUpdateImageMemberRequest
        :type body: :class:`g42cloudsdkims.v2.GlanceUpdateImageMemberRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkims.v2.GlanceUpdateImageMemberRequestBody`
        """
        return self._body
