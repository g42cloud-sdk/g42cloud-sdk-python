...
class ExportImageRequest:
    ...
    def __init__(self, image_id=None, body=None):
        ...
        :param image_id: The param of the ExportImageRequest
        :type image_id: str
        :param body: The param of the ExportImageRequest
        :type body: :class:`g42cloudsdkims.v2.ExportImageRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkims.v2.ExportImageRequestBody`
        """
        return self._body
