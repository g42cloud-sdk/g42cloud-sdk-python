...
class GlanceCreateImageMetadataRequest:
    ...
    openapi_types = {
        'body': 'GlanceCreateImageMetadataRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the GlanceCreateImageMetadataRequest
        :type body: :class:`g42cloudsdkims.v2.GlanceCreateImageMetadataRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkims.v2.GlanceCreateImageMetadataRequestBody`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GlanceCreateImageMetadataRequest):
            return False
