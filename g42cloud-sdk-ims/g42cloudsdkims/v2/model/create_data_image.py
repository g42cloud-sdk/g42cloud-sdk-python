...
class CreateDataImage:
    ...
    def __init__(self, name=None, volume_id=None, description=None, tags=None):
        ...
        :param name: The param of the CreateDataImage
        :type name: str
        :param volume_id: The param of the CreateDataImage
        :type volume_id: str
        :param description: The param of the CreateDataImage
        :type description: str
        :param tags: The param of the CreateDataImage
        :type tags: list[str]
        """
