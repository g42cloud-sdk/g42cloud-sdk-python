...
class CopyImageInRegionRequest:
    ...
    def __init__(self, image_id=None, body=None):
        ...
        :param image_id: The param of the CopyImageInRegionRequest
        :type image_id: str
        :param body: The param of the CopyImageInRegionRequest
        :type body: :class:`g42cloudsdkims.v2.CopyImageInRegionRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkims.v2.CopyImageInRegionRequestBody`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CopyImageInRegionRequest):
            return False
