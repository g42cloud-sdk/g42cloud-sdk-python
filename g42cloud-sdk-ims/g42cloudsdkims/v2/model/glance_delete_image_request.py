...
class GlanceDeleteImageRequest:
    ...
    def __init__(self, image_id=None, body=None):
        ...
        :param image_id: The param of the GlanceDeleteImageRequest
        :type image_id: str
        :param body: The param of the GlanceDeleteImageRequest
        :type body: :class:`g42cloudsdkims.v2.GlanceDeleteImageRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkims.v2.GlanceDeleteImageRequestBody`
        """
        return self._body
