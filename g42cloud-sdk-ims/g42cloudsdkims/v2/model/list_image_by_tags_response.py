...
class ListImageByTagsResponse(SdkResponse):
    ...
    def __init__(self, resources=None, total_count=None):
        ...
        :param resources: The param of the ListImageByTagsResponse
        :type resources: list[:class:`g42cloudsdkims.v2.ShowImageByTagsResource`]
        :param total_count: The param of the ListImageByTagsResponse
    ...
    def resources(self):
        ...
        :rtype: list[:class:`g42cloudsdkims.v2.ShowImageByTagsResource`]
        """
