...
class AddOrUpdateTagsRequestBody:
    ...
    def __init__(self, image_id=None, tag=None, image_tag=None):
        ...
        :param image_id: The param of the AddOrUpdateTagsRequestBody
        :type image_id: str
        :param tag: The param of the AddOrUpdateTagsRequestBody
        :type tag: str
        :param image_tag: The param of the AddOrUpdateTagsRequestBody
        :type image_tag: :class:`g42cloudsdkims.v2.ResourceTag`
        """
    ...
    def image_tag(self):
        ...
        :rtype: :class:`g42cloudsdkims.v2.ResourceTag`
        """
