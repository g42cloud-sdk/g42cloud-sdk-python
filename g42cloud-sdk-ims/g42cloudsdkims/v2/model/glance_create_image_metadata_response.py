...
class GlanceCreateImageMetadataResponse(SdkResponse):
    ...
    def __init__(self, visibility=None, name=None, protected=None, container_format=None, disk_format=None, tags=None, min_ram=None, min_disk=None, status=None, created_at=None, updated_at=None, _self=None, id=None, file=None, schema=None, image_source_type=None, image_size=None, isregistered=None, os_version=None, os_type=None, platform=None, os_bit=None, imagetype=None, virtual_env_type=None, owner=None, virtual_size=None, properties=None, root_origin=None, checksum=None, size=None):
        ...
        :param visibility: The param of the GlanceCreateImageMetadataResponse
        :type visibility: str
        :param name: The param of the GlanceCreateImageMetadataResponse
        :type name: str
        :param protected: The param of the GlanceCreateImageMetadataResponse
        :type protected: bool
        :param container_format: The param of the GlanceCreateImageMetadataResponse
        :type container_format: str
        :param disk_format: The param of the GlanceCreateImageMetadataResponse
        :type disk_format: str
        :param tags: The param of the GlanceCreateImageMetadataResponse
        :type tags: list[str]
        :param min_ram: The param of the GlanceCreateImageMetadataResponse
        :type min_ram: int
        :param min_disk: The param of the GlanceCreateImageMetadataResponse
        :type min_disk: int
        :param status: The param of the GlanceCreateImageMetadataResponse
        :type status: str
        :param created_at: The param of the GlanceCreateImageMetadataResponse
        :type created_at: str
        :param updated_at: The param of the GlanceCreateImageMetadataResponse
        :type updated_at: str
        :param _self: The param of the GlanceCreateImageMetadataResponse
        :type _self: str
        :param id: The param of the GlanceCreateImageMetadataResponse
        :type id: str
        :param file: The param of the GlanceCreateImageMetadataResponse
        :type file: str
        :param schema: The param of the GlanceCreateImageMetadataResponse
        :type schema: str
        :param image_source_type: The param of the GlanceCreateImageMetadataResponse
        :type image_source_type: str
        :param image_size: The param of the GlanceCreateImageMetadataResponse
        :type image_size: str
        :param isregistered: The param of the GlanceCreateImageMetadataResponse
        :type isregistered: str
        :param os_version: The param of the GlanceCreateImageMetadataResponse
        :type os_version: str
        :param os_type: The param of the GlanceCreateImageMetadataResponse
        :type os_type: str
        :param platform: The param of the GlanceCreateImageMetadataResponse
        :type platform: str
        :param os_bit: The param of the GlanceCreateImageMetadataResponse
        :type os_bit: str
        :param imagetype: The param of the GlanceCreateImageMetadataResponse
        :type imagetype: str
        :param virtual_env_type: The param of the GlanceCreateImageMetadataResponse
        :type virtual_env_type: str
        :param owner: The param of the GlanceCreateImageMetadataResponse
        :type owner: str
        :param virtual_size: The param of the GlanceCreateImageMetadataResponse
        :type virtual_size: int
        :param properties: The param of the GlanceCreateImageMetadataResponse
        :type properties: object
        :param root_origin: The param of the GlanceCreateImageMetadataResponse
        :type root_origin: str
        :param checksum: The param of the GlanceCreateImageMetadataResponse
        :type checksum: str
        :param size: The param of the GlanceCreateImageMetadataResponse
        :type size: int
        """
