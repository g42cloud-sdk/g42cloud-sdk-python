...
class ExportImageRequestBody:
    ...
    def __init__(self, bucket_url=None, file_format=None, is_quick_export=None):
        ...
        :param bucket_url: The param of the ExportImageRequestBody
        :type bucket_url: str
        :param file_format: The param of the ExportImageRequestBody
        :type file_format: str
        :param is_quick_export: The param of the ExportImageRequestBody
