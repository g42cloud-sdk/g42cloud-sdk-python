...
class GlanceUpdateImageMemberResponse(SdkResponse):
    ...
    def __init__(self, status=None, created_at=None, updated_at=None, image_id=None, member_id=None, schema=None):
        ...
        :param status: The param of the GlanceUpdateImageMemberResponse
        :type status: str
        :param created_at: The param of the GlanceUpdateImageMemberResponse
        :type created_at: str
        :param updated_at: The param of the GlanceUpdateImageMemberResponse
        :type updated_at: str
        :param image_id: The param of the GlanceUpdateImageMemberResponse
        :type image_id: str
        :param member_id: The param of the GlanceUpdateImageMemberResponse
        :type member_id: str
        :param schema: The param of the GlanceUpdateImageMemberResponse
        :type schema: str
        """
