...
class ShowImageQuotaResponse(SdkResponse):
    ...
    def __init__(self, quotas=None):
        ...
        :param quotas: The param of the ShowImageQuotaResponse
        :type quotas: :class:`g42cloudsdkims.v2.Quota`
        """
    ...
    def quotas(self):
        ...
        :rtype: :class:`g42cloudsdkims.v2.Quota`
        """
        return self._quotas
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowImageQuotaResponse):
            return False
