...
class ListTagsRequest:
    ...
    def __init__(self, limit=None, page=None, imagetype=None, id=None, status=None, name=None, min_disk=None, platform=None, os_type=None, member_status=None, virtual_env_type=None, enterprise_project_id=None, architecture=None, created_at=None, updated_at=None):
        ...
        :param limit: The param of the ListTagsRequest
        :type limit: int
        :param page: The param of the ListTagsRequest
        :type page: int
        :param imagetype: The param of the ListTagsRequest
        :type imagetype: str
        :param id: The param of the ListTagsRequest
        :type id: str
        :param status: The param of the ListTagsRequest
        :type status: str
        :param name: The param of the ListTagsRequest
        :type name: str
        :param min_disk: The param of the ListTagsRequest
        :type min_disk: int
        :param platform: The param of the ListTagsRequest
        :type platform: str
        :param os_type: The param of the ListTagsRequest
        :type os_type: str
        :param member_status: The param of the ListTagsRequest
        :type member_status: str
        :param virtual_env_type: The param of the ListTagsRequest
        :type virtual_env_type: str
        :param enterprise_project_id: The param of the ListTagsRequest
        :type enterprise_project_id: str
        :param architecture: The param of the ListTagsRequest
        :type architecture: str
        :param created_at: The param of the ListTagsRequest
        :type created_at: str
        :param updated_at: The param of the ListTagsRequest
        :type updated_at: str
        """
