...
class BatchUpdateMembersResponse(SdkResponse):
    ...
    def __init__(self, job_id=None):
        ...
        :param job_id: The param of the BatchUpdateMembersResponse
        :type job_id: str
        """
    ...
    def job_id(self):
        ...
        :return: The job_id of this BatchUpdateMembersResponse.
        :rtype: str
        """
        return self._job_id
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchUpdateMembersResponse):
            return False
