...
class CopyImageInRegionResponse(SdkResponse):
    ...
    def __init__(self, job_id=None):
        ...
        :param job_id: The param of the CopyImageInRegionResponse
        :type job_id: str
        """
    ...
    def job_id(self):
        ...
        :return: The job_id of this CopyImageInRegionResponse.
        :rtype: str
        """
        return self._job_id
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CopyImageInRegionResponse):
            return False
