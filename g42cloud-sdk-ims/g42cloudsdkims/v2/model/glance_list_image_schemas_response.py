...
class GlanceListImageSchemasResponse(SdkResponse):
    ...
    def __init__(self, name=None, properties=None, links=None):
        ...
        :param name: The param of the GlanceListImageSchemasResponse
        :type name: str
        :param properties: The param of the GlanceListImageSchemasResponse
        :type properties: object
        :param links: The param of the GlanceListImageSchemasResponse
