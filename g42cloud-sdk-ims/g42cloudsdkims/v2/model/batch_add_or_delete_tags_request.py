...
class BatchAddOrDeleteTagsRequest:
    ...
    openapi_types = {
        'image_id': 'str',
        'body': 'BatchAddOrDeleteTagsRequestBody'
    }
    ...
    def __init__(self, image_id=None, body=None):
        ...
        :param image_id: The param of the BatchAddOrDeleteTagsRequest
        :type image_id: str
        :param body: The param of the BatchAddOrDeleteTagsRequest
        :type body: :class:`g42cloudsdkims.v2.BatchAddOrDeleteTagsRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkims.v2.BatchAddOrDeleteTagsRequestBody`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchAddOrDeleteTagsRequest):
            return False
