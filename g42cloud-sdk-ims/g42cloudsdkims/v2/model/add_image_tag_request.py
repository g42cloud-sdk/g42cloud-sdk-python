...
class AddImageTagRequest:
    ...
    def __init__(self, image_id=None, body=None):
        ...
        :param image_id: The param of the AddImageTagRequest
        :type image_id: str
        :param body: The param of the AddImageTagRequest
        :type body: :class:`g42cloudsdkims.v2.AddImageTagRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkims.v2.AddImageTagRequestBody`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddImageTagRequest):
            return False
