...
class UpdateImageResponse(SdkResponse):
    ...
    def __init__(self, backup_id=None, data_origin=None, description=None, image_size=None, image_source_type=None, imagetype=None, isregistered=None, originalimagename=None, os_bit=None, os_type=None, os_version=None, platform=None, productcode=None, support_diskintensive=None, support_highperformance=None, support_kvm=None, support_kvm_gpu_type=None, support_kvm_infiniband=None, support_largememory=None, support_xen=None, support_xen_gpu_type=None, support_xen_hana=None, system_support_market=None, checksum=None, container_format=None, created_at=None, disk_format=None, enterprise_project_id=None, file=None, id=None, min_disk=None, min_ram=None, name=None, owner=None, protected=None, schema=None, _self=None, size=None, status=None, tags=None, updated_at=None, virtual_env_type=None, virtual_size=None, visibility=None, support_fc_inject=None, hw_firmware_type=None, support_arm=None, max_ram=None, system__cmkid=None, os_feature_list=None, account_code=None, hw_vif_multiqueue_enabled=None, is_offshelved=None, lazyloading=None, root_origin=None, sequence_num=None, active_at=None, support_agent_list=None, support_amd=None):
        ...
        :param backup_id: The param of the UpdateImageResponse
        :type backup_id: str
        :param data_origin: The param of the UpdateImageResponse
        :type data_origin: str
        :param description: The param of the UpdateImageResponse
        :type description: str
        :param image_size: The param of the UpdateImageResponse
        :type image_size: str
        :param image_source_type: The param of the UpdateImageResponse
        :type image_source_type: str
        :param imagetype: The param of the UpdateImageResponse
        :type imagetype: str
        :param isregistered: The param of the UpdateImageResponse
        :type isregistered: str
        :param originalimagename: The param of the UpdateImageResponse
        :type originalimagename: str
        :param os_bit: The param of the UpdateImageResponse
        :type os_bit: str
        :param os_type: The param of the UpdateImageResponse
        :type os_type: str
        :param os_version: The param of the UpdateImageResponse
        :type os_version: str
        :param platform: The param of the UpdateImageResponse
        :type platform: str
        :param productcode: The param of the UpdateImageResponse
        :type productcode: str
        :param support_diskintensive: The param of the UpdateImageResponse
        :type support_diskintensive: str
        :param support_highperformance: The param of the UpdateImageResponse
        :type support_highperformance: str
        :param support_kvm: The param of the UpdateImageResponse
        :type support_kvm: str
        :param support_kvm_gpu_type: The param of the UpdateImageResponse
        :type support_kvm_gpu_type: str
        :param support_kvm_infiniband: The param of the UpdateImageResponse
        :type support_kvm_infiniband: str
        :param support_largememory: The param of the UpdateImageResponse
        :type support_largememory: str
        :param support_xen: The param of the UpdateImageResponse
        :type support_xen: str
        :param support_xen_gpu_type: The param of the UpdateImageResponse
        :type support_xen_gpu_type: str
        :param support_xen_hana: The param of the UpdateImageResponse
        :type support_xen_hana: str
        :param system_support_market: The param of the UpdateImageResponse
        :type system_support_market: bool
        :param checksum: The param of the UpdateImageResponse
        :type checksum: str
        :param container_format: The param of the UpdateImageResponse
        :type container_format: str
        :param created_at: The param of the UpdateImageResponse
        :type created_at: str
        :param disk_format: The param of the UpdateImageResponse
        :type disk_format: str
        :param enterprise_project_id: The param of the UpdateImageResponse
        :type enterprise_project_id: str
        :param file: The param of the UpdateImageResponse
        :type file: str
        :param id: The param of the UpdateImageResponse
        :type id: str
        :param min_disk: The param of the UpdateImageResponse
        :type min_disk: int
        :param min_ram: The param of the UpdateImageResponse
        :type min_ram: int
        :param name: The param of the UpdateImageResponse
        :type name: str
        :param owner: The param of the UpdateImageResponse
        :type owner: str
        :param protected: The param of the UpdateImageResponse
        :type protected: bool
        :param schema: The param of the UpdateImageResponse
        :type schema: str
        :param _self: The param of the UpdateImageResponse
        :type _self: str
        :param size: The param of the UpdateImageResponse
        :type size: int
        :param status: The param of the UpdateImageResponse
        :type status: str
        :param tags: The param of the UpdateImageResponse
        :type tags: list[str]
        :param updated_at: The param of the UpdateImageResponse
        :type updated_at: str
        :param virtual_env_type: The param of the UpdateImageResponse
        :type virtual_env_type: str
        :param virtual_size: The param of the UpdateImageResponse
        :type virtual_size: int
        :param visibility: The param of the UpdateImageResponse
        :type visibility: str
        :param support_fc_inject: The param of the UpdateImageResponse
        :type support_fc_inject: str
        :param hw_firmware_type: The param of the UpdateImageResponse
        :type hw_firmware_type: str
        :param support_arm: The param of the UpdateImageResponse
        :type support_arm: str
        :param max_ram: The param of the UpdateImageResponse
        :type max_ram: str
        :param system__cmkid: The param of the UpdateImageResponse
        :type system__cmkid: str
        :param os_feature_list: The param of the UpdateImageResponse
        :type os_feature_list: str
        :param account_code: The param of the UpdateImageResponse
        :type account_code: str
        :param hw_vif_multiqueue_enabled: The param of the UpdateImageResponse
        :type hw_vif_multiqueue_enabled: str
        :param is_offshelved: The param of the UpdateImageResponse
        :type is_offshelved: str
        :param lazyloading: The param of the UpdateImageResponse
        :type lazyloading: str
        :param root_origin: The param of the UpdateImageResponse
        :type root_origin: str
        :param sequence_num: The param of the UpdateImageResponse
        :type sequence_num: str
        :param active_at: The param of the UpdateImageResponse
        :type active_at: str
        :param support_agent_list: The param of the UpdateImageResponse
        :type support_agent_list: str
        :param support_amd: The param of the UpdateImageResponse
