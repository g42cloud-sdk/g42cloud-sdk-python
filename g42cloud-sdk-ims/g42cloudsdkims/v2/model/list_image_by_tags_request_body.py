...
class ListImageByTagsRequestBody:
    ...
    def __init__(self, action=None, tags=None, tags_any=None, not_tags=None, not_tags_any=None, limit=None, offset=None, matches=None, without_any_tag=None):
        ...
        :param action: The param of the ListImageByTagsRequestBody
        :type action: str
        :param tags: The param of the ListImageByTagsRequestBody
        :type tags: list[:class:`g42cloudsdkims.v2.Tags`]
        :param tags_any: The param of the ListImageByTagsRequestBody
        :type tags_any: list[:class:`g42cloudsdkims.v2.Tags`]
        :param not_tags: The param of the ListImageByTagsRequestBody
        :type not_tags: list[:class:`g42cloudsdkims.v2.Tags`]
        :param not_tags_any: The param of the ListImageByTagsRequestBody
        :type not_tags_any: list[:class:`g42cloudsdkims.v2.Tags`]
        :param limit: The param of the ListImageByTagsRequestBody
        :type limit: str
        :param offset: The param of the ListImageByTagsRequestBody
        :type offset: str
        :param matches: The param of the ListImageByTagsRequestBody
        :type matches: list[:class:`g42cloudsdkims.v2.TagKeyValue`]
        :param without_any_tag: The param of the ListImageByTagsRequestBody
    ...
    def tags(self):
        ...
        :rtype: list[:class:`g42cloudsdkims.v2.Tags`]
        """
        return self._tags
