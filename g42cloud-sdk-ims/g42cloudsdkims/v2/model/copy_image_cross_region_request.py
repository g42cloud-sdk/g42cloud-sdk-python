...
class CopyImageCrossRegionRequest:
    ...
    def __init__(self, image_id=None, body=None):
        ...
        :param image_id: The param of the CopyImageCrossRegionRequest
        :type image_id: str
        :param body: The param of the CopyImageCrossRegionRequest
        :type body: :class:`g42cloudsdkims.v2.CopyImageCrossRegionRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkims.v2.CopyImageCrossRegionRequestBody`
        """
        return self._body
