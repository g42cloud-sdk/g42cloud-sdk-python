...
class GlanceDeleteTagRequest:
    ...
    def __init__(self, image_id=None, tag=None):
        ...
        :param image_id: The param of the GlanceDeleteTagRequest
        :type image_id: str
        :param tag: The param of the GlanceDeleteTagRequest
        :type tag: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GlanceDeleteTagRequest):
            return False
