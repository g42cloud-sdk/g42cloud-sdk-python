...
class GlanceDeleteImageMemberRequest:
    ...
    def __init__(self, image_id=None, member_id=None):
        ...
        :param image_id: The param of the GlanceDeleteImageMemberRequest
        :type image_id: str
        :param member_id: The param of the GlanceDeleteImageMemberRequest
        :type member_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GlanceDeleteImageMemberRequest):
            return False
