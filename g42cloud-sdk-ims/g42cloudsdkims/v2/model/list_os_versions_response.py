...
class ListOsVersionsResponse(SdkResponse):
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the ListOsVersionsResponse
        :type body: list[:class:`g42cloudsdkims.v2.ListOsVersionsResponseBody`]
        """
    ...
    def body(self):
        ...
        :rtype: list[:class:`g42cloudsdkims.v2.ListOsVersionsResponseBody`]
        """
        return self._body
