...
class BatchAddOrDeleteTagsRequestBody:
    ...
    def __init__(self, action=None, tags=None):
        ...
        :param action: The param of the BatchAddOrDeleteTagsRequestBody
        :type action: str
        :param tags: The param of the BatchAddOrDeleteTagsRequestBody
        :type tags: list[:class:`g42cloudsdkims.v2.ResourceTag`]
        """
