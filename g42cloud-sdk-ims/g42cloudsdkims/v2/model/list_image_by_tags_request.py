...
class ListImageByTagsRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the ListImageByTagsRequest
        :type body: :class:`g42cloudsdkims.v2.ListImageByTagsRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkims.v2.ListImageByTagsRequestBody`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListImageByTagsRequest):
            return False
