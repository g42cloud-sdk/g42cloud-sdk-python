...
class ShowJobProgressResponse(SdkResponse):
    ...
    def __init__(self, status=None, job_id=None, job_type=None, begin_time=None, end_time=None, error_code=None, fail_reason=None, entities=None):
        ...
        :param status: The param of the ShowJobProgressResponse
        :type status: str
        :param job_id: The param of the ShowJobProgressResponse
        :type job_id: str
        :param job_type: The param of the ShowJobProgressResponse
        :type job_type: str
        :param begin_time: The param of the ShowJobProgressResponse
        :type begin_time: str
        :param end_time: The param of the ShowJobProgressResponse
        :type end_time: str
        :param error_code: The param of the ShowJobProgressResponse
        :type error_code: str
        :param fail_reason: The param of the ShowJobProgressResponse
        :type fail_reason: str
        :param entities: The param of the ShowJobProgressResponse
        :type entities: :class:`g42cloudsdkims.v2.JobProgressEntities`
        """
    ...
    def entities(self):
        ...
        :rtype: :class:`g42cloudsdkims.v2.JobProgressEntities`
        """
