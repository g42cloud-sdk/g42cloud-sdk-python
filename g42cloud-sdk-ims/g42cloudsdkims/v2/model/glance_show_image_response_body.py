...
class GlanceShowImageResponseBody:
    ...
    def __init__(self, backup_id=None, data_origin=None, description=None, image_size=None, image_source_type=None, imagetype=None, isregistered=None, originalimagename=None, os_bit=None, os_type=None, os_version=None, platform=None, productcode=None, support_diskintensive=None, support_highperformance=None, support_kvm=None, support_kvm_gpu_type=None, support_kvm_infiniband=None, support_largememory=None, support_xen=None, support_xen_gpu_type=None, support_xen_hana=None, checksum=None, container_format=None, created_at=None, disk_format=None, file=None, id=None, min_disk=None, min_ram=None, name=None, owner=None, protected=None, schema=None, _self=None, size=None, status=None, tags=None, updated_at=None, virtual_env_type=None, virtual_size=None, visibility=None, support_fc_inject=None, enterprise_project_id=None, hw_firmware_type=None, support_arm=None, is_offshelved=None, lazyloading=None, os_feature_list=None, root_origin=None, sequence_num=None, support_agent_list=None, system__cmkid=None, active_at=None, hw_vif_multiqueue_enabled=None, max_ram=None, image_location=None, is_config_init=None, account_code=None, support_amd=None):
        ...
        :param backup_id: The param of the GlanceShowImageResponseBody
        :type backup_id: str
        :param data_origin: The param of the GlanceShowImageResponseBody
        :type data_origin: str
        :param description: The param of the GlanceShowImageResponseBody
        :type description: str
        :param image_size: The param of the GlanceShowImageResponseBody
        :type image_size: str
        :param image_source_type: The param of the GlanceShowImageResponseBody
        :type image_source_type: str
        :param imagetype: The param of the GlanceShowImageResponseBody
        :type imagetype: str
        :param isregistered: The param of the GlanceShowImageResponseBody
        :type isregistered: str
        :param originalimagename: The param of the GlanceShowImageResponseBody
        :type originalimagename: str
        :param os_bit: The param of the GlanceShowImageResponseBody
        :type os_bit: str
        :param os_type: The param of the GlanceShowImageResponseBody
        :type os_type: str
        :param os_version: The param of the GlanceShowImageResponseBody
        :type os_version: str
        :param platform: The param of the GlanceShowImageResponseBody
        :type platform: str
        :param productcode: The param of the GlanceShowImageResponseBody
        :type productcode: str
        :param support_diskintensive: The param of the GlanceShowImageResponseBody
        :type support_diskintensive: str
        :param support_highperformance: The param of the GlanceShowImageResponseBody
        :type support_highperformance: str
        :param support_kvm: The param of the GlanceShowImageResponseBody
        :type support_kvm: str
        :param support_kvm_gpu_type: The param of the GlanceShowImageResponseBody
        :type support_kvm_gpu_type: str
        :param support_kvm_infiniband: The param of the GlanceShowImageResponseBody
        :type support_kvm_infiniband: str
        :param support_largememory: The param of the GlanceShowImageResponseBody
        :type support_largememory: str
        :param support_xen: The param of the GlanceShowImageResponseBody
        :type support_xen: str
        :param support_xen_gpu_type: The param of the GlanceShowImageResponseBody
        :type support_xen_gpu_type: str
        :param support_xen_hana: The param of the GlanceShowImageResponseBody
        :type support_xen_hana: str
        :param checksum: The param of the GlanceShowImageResponseBody
        :type checksum: str
        :param container_format: The param of the GlanceShowImageResponseBody
        :type container_format: str
        :param created_at: The param of the GlanceShowImageResponseBody
        :type created_at: str
        :param disk_format: The param of the GlanceShowImageResponseBody
        :type disk_format: str
        :param file: The param of the GlanceShowImageResponseBody
        :type file: str
        :param id: The param of the GlanceShowImageResponseBody
        :type id: str
        :param min_disk: The param of the GlanceShowImageResponseBody
        :type min_disk: int
        :param min_ram: The param of the GlanceShowImageResponseBody
        :type min_ram: int
        :param name: The param of the GlanceShowImageResponseBody
        :type name: str
        :param owner: The param of the GlanceShowImageResponseBody
        :type owner: str
        :param protected: The param of the GlanceShowImageResponseBody
        :type protected: bool
        :param schema: The param of the GlanceShowImageResponseBody
        :type schema: str
        :param _self: The param of the GlanceShowImageResponseBody
        :type _self: str
        :param size: The param of the GlanceShowImageResponseBody
        :type size: int
        :param status: The param of the GlanceShowImageResponseBody
        :type status: str
        :param tags: The param of the GlanceShowImageResponseBody
        :type tags: list[str]
        :param updated_at: The param of the GlanceShowImageResponseBody
        :type updated_at: str
        :param virtual_env_type: The param of the GlanceShowImageResponseBody
        :type virtual_env_type: str
        :param virtual_size: The param of the GlanceShowImageResponseBody
        :type virtual_size: int
        :param visibility: The param of the GlanceShowImageResponseBody
        :type visibility: str
        :param support_fc_inject: The param of the GlanceShowImageResponseBody
        :type support_fc_inject: str
        :param enterprise_project_id: The param of the GlanceShowImageResponseBody
        :type enterprise_project_id: str
        :param hw_firmware_type: The param of the GlanceShowImageResponseBody
        :type hw_firmware_type: str
        :param support_arm: The param of the GlanceShowImageResponseBody
        :type support_arm: str
        :param is_offshelved: The param of the GlanceShowImageResponseBody
        :type is_offshelved: str
        :param lazyloading: The param of the GlanceShowImageResponseBody
        :type lazyloading: str
        :param os_feature_list: The param of the GlanceShowImageResponseBody
        :type os_feature_list: str
        :param root_origin: The param of the GlanceShowImageResponseBody
        :type root_origin: str
        :param sequence_num: The param of the GlanceShowImageResponseBody
        :type sequence_num: str
        :param support_agent_list: The param of the GlanceShowImageResponseBody
        :type support_agent_list: str
        :param system__cmkid: The param of the GlanceShowImageResponseBody
        :type system__cmkid: str
        :param active_at: The param of the GlanceShowImageResponseBody
        :type active_at: str
        :param hw_vif_multiqueue_enabled: The param of the GlanceShowImageResponseBody
        :type hw_vif_multiqueue_enabled: str
        :param max_ram: The param of the GlanceShowImageResponseBody
        :type max_ram: str
        :param image_location: The param of the GlanceShowImageResponseBody
        :type image_location: str
        :param is_config_init: The param of the GlanceShowImageResponseBody
        :type is_config_init: str
        :param account_code: The param of the GlanceShowImageResponseBody
        :type account_code: str
        :param support_amd: The param of the GlanceShowImageResponseBody
