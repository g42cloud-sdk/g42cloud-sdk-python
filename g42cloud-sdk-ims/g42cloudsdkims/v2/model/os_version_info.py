...
class OsVersionInfo:
    ...
    def __init__(self, platform=None, os_version_key=None, os_version=None, os_bit=None, os_type=None):
        ...
        :param platform: The param of the OsVersionInfo
        :type platform: str
        :param os_version_key: The param of the OsVersionInfo
        :type os_version_key: str
        :param os_version: The param of the OsVersionInfo
        :type os_version: str
        :param os_bit: The param of the OsVersionInfo
        :type os_bit: int
        :param os_type: The param of the OsVersionInfo
        :type os_type: str
        """
