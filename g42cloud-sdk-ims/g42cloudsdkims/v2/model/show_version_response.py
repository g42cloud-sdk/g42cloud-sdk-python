...
class ShowVersionResponse(SdkResponse):
    ...
    def __init__(self, versions=None):
        ...
        :param versions: The param of the ShowVersionResponse
        :type versions: list[:class:`g42cloudsdkims.v2.OsVersionResponse`]
        """
    ...
    @property
    def versions(self):
        """Gets the versions of this ShowVersionResponse.

        :return: The versions of this ShowVersionResponse.
        :rtype: list[:class:`g42cloudsdkims.v2.OsVersionResponse`]
        """
        return self._versions

    @versions.setter
    def versions(self, versions):
        """Sets the versions of this ShowVersionResponse.
