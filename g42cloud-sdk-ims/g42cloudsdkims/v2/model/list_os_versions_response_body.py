...
class ListOsVersionsResponseBody:
    ...
    def __init__(self, platform=None, version_list=None):
        ...
        :param platform: The param of the ListOsVersionsResponseBody
        :type platform: str
        :param version_list: The param of the ListOsVersionsResponseBody
        :type version_list: list[:class:`g42cloudsdkims.v2.OsVersionInfo`]
        """
    ...
    def version_list(self):
        ...
        :rtype: list[:class:`g42cloudsdkims.v2.OsVersionInfo`]
        """
