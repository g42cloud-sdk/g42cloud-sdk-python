...
class GlanceUpdateImageRequest:
    ...
    def __init__(self, image_id=None, body=None):
        ...
        :param image_id: The param of the GlanceUpdateImageRequest
        :type image_id: str
        :param body: The param of the GlanceUpdateImageRequest
        :type body: list[:class:`g42cloudsdkims.v2.GlanceUpdateImageRequestBody`]
        """
    ...
    def body(self):
        ...
        :rtype: list[:class:`g42cloudsdkims.v2.GlanceUpdateImageRequestBody`]
        """
        return self._body
