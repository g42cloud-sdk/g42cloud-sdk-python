...
class UpdateImageRequest:
    ...
    def __init__(self, image_id=None, body=None):
        ...
        :param image_id: The param of the UpdateImageRequest
        :type image_id: str
        :param body: The param of the UpdateImageRequest
        :type body: list[:class:`g42cloudsdkims.v2.UpdateImageRequestBody`]
        """
    ...
    def body(self):
        ...
        :rtype: list[:class:`g42cloudsdkims.v2.UpdateImageRequestBody`]
        """
        return self._body
