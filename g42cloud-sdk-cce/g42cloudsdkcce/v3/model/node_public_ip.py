...
class NodePublicIP:
    ...
    def __init__(self, ids=None, count=None, eip=None):
        ...
        :param ids: The param of the NodePublicIP
        :type ids: list[str]
        :param count: The param of the NodePublicIP
        :type count: int
        :param eip: The param of the NodePublicIP
        :type eip: :class:`g42cloudsdkcce.v3.NodeEIPSpec`
        """
    ...
    def eip(self):
        ...
        :rtype: :class:`g42cloudsdkcce.v3.NodeEIPSpec`
        """
        return self._eip
