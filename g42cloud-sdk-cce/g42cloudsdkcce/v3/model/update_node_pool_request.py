...
class UpdateNodePoolRequest:
    ...
    def __init__(self, cluster_id=None, nodepool_id=None, body=None):
        ...
        :param cluster_id: The param of the UpdateNodePoolRequest
        :type cluster_id: str
        :param nodepool_id: The param of the UpdateNodePoolRequest
        :type nodepool_id: str
        :param body: The param of the UpdateNodePoolRequest
        :type body: :class:`g42cloudsdkcce.v3.NodePoolUpdate`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkcce.v3.NodePoolUpdate`
        """
        return self._body
