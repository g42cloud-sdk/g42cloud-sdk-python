...
class UpdateClusterResponse(SdkResponse):
    ...
    def __init__(self, kind=None, api_version=None, metadata=None, spec=None, status=None):
        ...
        :param kind: The param of the UpdateClusterResponse
        :type kind: str
        :param api_version: The param of the UpdateClusterResponse
        :type api_version: str
        :param metadata: The param of the UpdateClusterResponse
        :type metadata: :class:`g42cloudsdkcce.v3.ClusterMetadata`
        :param spec: The param of the UpdateClusterResponse
        :type spec: :class:`g42cloudsdkcce.v3.ClusterSpec`
        :param status: The param of the UpdateClusterResponse
