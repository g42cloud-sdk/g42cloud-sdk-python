...
class ListNodePoolsResponse(SdkResponse):
    ...
    def __init__(self, kind=None, api_version=None, items=None):
        ...
        :param kind: The param of the ListNodePoolsResponse
        :type kind: str
        :param api_version: The param of the ListNodePoolsResponse
        :type api_version: str
        :param items: The param of the ListNodePoolsResponse
        :type items: list[:class:`g42cloudsdkcce.v3.NodePool`]
        """
    ...
    def items(self):
        ...
        :rtype: list[:class:`g42cloudsdkcce.v3.NodePool`]
        """
        return self._items
