...
class ListNodesResponse(SdkResponse):
    ...
    def __init__(self, kind=None, api_version=None, items=None):
        ...
        :param kind: The param of the ListNodesResponse
        :type kind: str
        :param api_version: The param of the ListNodesResponse
        :type api_version: str
        :param items: The param of the ListNodesResponse
        :type items: list[:class:`g42cloudsdkcce.v3.Node`]
        """
    ...
    def items(self):
        ...
        :rtype: list[:class:`g42cloudsdkcce.v3.Node`]
        """
        return self._items
