...
class ClusterStatus:
    ...
    def __init__(self, phase=None, job_id=None, reason=None, message=None, endpoints=None, is_locked=None, lock_scene=None, lock_source=None, lock_source_id=None, delete_option=None, delete_status=None):
        ...
        :param phase: The param of the ClusterStatus
        :type phase: str
        :param job_id: The param of the ClusterStatus
        :type job_id: str
        :param reason: The param of the ClusterStatus
        :type reason: str
        :param message: The param of the ClusterStatus
        :type message: str
        :param endpoints: The param of the ClusterStatus
        :type endpoints: list[:class:`g42cloudsdkcce.v3.ClusterEndpoints`]
        :param is_locked: The param of the ClusterStatus
        :type is_locked: bool
        :param lock_scene: The param of the ClusterStatus
        :type lock_scene: str
        :param lock_source: The param of the ClusterStatus
        :type lock_source: str
        :param lock_source_id: The param of the ClusterStatus
        :type lock_source_id: str
        :param delete_option: The param of the ClusterStatus
        :type delete_option: object
        :param delete_status: The param of the ClusterStatus
    ...
    def endpoints(self):
        ...
        :rtype: list[:class:`g42cloudsdkcce.v3.ClusterEndpoints`]
        """
