...
class CreateNodeResponse(SdkResponse):
    ...
    def __init__(self, kind=None, api_version=None, metadata=None, spec=None, status=None):
        ...
        :param kind: The param of the CreateNodeResponse
        :type kind: str
        :param api_version: The param of the CreateNodeResponse
        :type api_version: str
        :param metadata: The param of the CreateNodeResponse
        :type metadata: :class:`g42cloudsdkcce.v3.NodeMetadata`
        :param spec: The param of the CreateNodeResponse
        :type spec: :class:`g42cloudsdkcce.v3.NodeSpec`
        :param status: The param of the CreateNodeResponse
