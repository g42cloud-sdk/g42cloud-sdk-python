...
class InstanceRequestSpec:
    ...
    def __init__(self, version=None, cluster_id=None, values=None, addon_template_name=None):
        ...
        :param version: The param of the InstanceRequestSpec
        :type version: str
        :param cluster_id: The param of the InstanceRequestSpec
        :type cluster_id: str
        :param values: The param of the InstanceRequestSpec
        :type values: dict(str, object)
        :param addon_template_name: The param of the InstanceRequestSpec
