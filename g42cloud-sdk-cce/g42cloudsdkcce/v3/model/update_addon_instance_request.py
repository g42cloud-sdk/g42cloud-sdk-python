...
class UpdateAddonInstanceRequest:
    ...
    def __init__(self, id=None, body=None):
        ...
        :param id: The param of the UpdateAddonInstanceRequest
        :type id: str
        :param body: The param of the UpdateAddonInstanceRequest
        :type body: :class:`g42cloudsdkcce.v3.InstanceRequest`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkcce.v3.InstanceRequest`
        """
        return self._body
