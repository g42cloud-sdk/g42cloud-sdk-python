...
class DeleteStatus:
    ...
    def __init__(self, previous_total=None, current_total=None, updated=None, added=None, deleted=None):
        ...
        :param previous_total: The param of the DeleteStatus
        :type previous_total: int
        :param current_total: The param of the DeleteStatus
        :type current_total: int
        :param updated: The param of the DeleteStatus
        :type updated: int
        :param added: The param of the DeleteStatus
        :type added: int
        :param deleted: The param of the DeleteStatus
        :type deleted: int
        """
