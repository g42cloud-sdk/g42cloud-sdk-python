...
class MigrateNodeRequest:
    ...
    def __init__(self, cluster_id=None, target_cluster_id=None, body=None):
        ...
        :param cluster_id: The param of the MigrateNodeRequest
        :type cluster_id: str
        :param target_cluster_id: The param of the MigrateNodeRequest
        :type target_cluster_id: str
        :param body: The param of the MigrateNodeRequest
        :type body: :class:`g42cloudsdkcce.v3.MigrateNodesTask`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkcce.v3.MigrateNodesTask`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MigrateNodeRequest):
            return False
