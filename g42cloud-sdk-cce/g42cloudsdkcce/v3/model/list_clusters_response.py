...
class ListClustersResponse(SdkResponse):
    ...
    def __init__(self, kind=None, api_version=None, items=None):
        ...
        :param kind: The param of the ListClustersResponse
        :type kind: str
        :param api_version: The param of the ListClustersResponse
        :type api_version: str
        :param items: The param of the ListClustersResponse
        :type items: list[:class:`g42cloudsdkcce.v3.Cluster`]
        """
    ...
    def items(self):
        ...
        :rtype: list[:class:`g42cloudsdkcce.v3.Cluster`]
        """
        return self._items
