...
class DeleteClusterRequest:
    ...
    def __init__(self, cluster_id=None, delete_efs=None, delete_eni=None, delete_evs=None, delete_net=None, delete_obs=None, delete_sfs=None, tobedeleted=None):
        ...
        :param cluster_id: The param of the DeleteClusterRequest
        :type cluster_id: str
        :param delete_efs: The param of the DeleteClusterRequest
        :type delete_efs: str
        :param delete_eni: The param of the DeleteClusterRequest
        :type delete_eni: str
        :param delete_evs: The param of the DeleteClusterRequest
        :type delete_evs: str
        :param delete_net: The param of the DeleteClusterRequest
        :type delete_net: str
        :param delete_obs: The param of the DeleteClusterRequest
        :type delete_obs: str
        :param delete_sfs: The param of the DeleteClusterRequest
        :type delete_sfs: str
        :param tobedeleted: The param of the DeleteClusterRequest
