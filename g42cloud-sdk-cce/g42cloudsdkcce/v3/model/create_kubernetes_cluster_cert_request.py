...
class CreateKubernetesClusterCertRequest:
    ...
    def __init__(self, cluster_id=None, body=None):
        ...
        :param cluster_id: The param of the CreateKubernetesClusterCertRequest
        :type cluster_id: str
        :param body: The param of the CreateKubernetesClusterCertRequest
        :type body: :class:`g42cloudsdkcce.v3.CertDuration`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkcce.v3.CertDuration`
        """
        return self._body
