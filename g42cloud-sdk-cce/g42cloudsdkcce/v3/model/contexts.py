...
class Contexts:
    ...
    def __init__(self, name=None, context=None):
        ...
        :param name: The param of the Contexts
        :type name: str
        :param context: The param of the Contexts
        :type context: :class:`g42cloudsdkcce.v3.Context`
        """
    ...
    def context(self):
        ...
        :rtype: :class:`g42cloudsdkcce.v3.Context`
        """
