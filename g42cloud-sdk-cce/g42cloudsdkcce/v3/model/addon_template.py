...
class AddonTemplate:
    ...
    def __init__(self, kind=None, api_version=None, metadata=None, spec=None):
        ...
        :param kind: The param of the AddonTemplate
        :type kind: str
        :param api_version: The param of the AddonTemplate
        :type api_version: str
        :param metadata: The param of the AddonTemplate
        :type metadata: :class:`g42cloudsdkcce.v3.Metadata`
        :param spec: The param of the AddonTemplate
        :type spec: :class:`g42cloudsdkcce.v3.Templatespec`
        """
    ...
    def spec(self):
        ...
        :rtype: :class:`g42cloudsdkcce.v3.Templatespec`
        """
        return self._spec
