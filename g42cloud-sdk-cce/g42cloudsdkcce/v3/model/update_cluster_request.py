...
class UpdateClusterRequest:
    ...
    def __init__(self, cluster_id=None, body=None):
        ...
        :param cluster_id: The param of the UpdateClusterRequest
        :type cluster_id: str
        :param body: The param of the UpdateClusterRequest
        :type body: :class:`g42cloudsdkcce.v3.ClusterInformation`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkcce.v3.ClusterInformation`
        """
        return self._body
