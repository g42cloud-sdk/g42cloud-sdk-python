...
class NodePoolSpecUpdate:
    ...
    def __init__(self, node_template=None, initial_node_count=None, autoscaling=None):
        ...
        :param node_template: The param of the NodePoolSpecUpdate
        :type node_template: :class:`g42cloudsdkcce.v3.NodeSpecUpdate`
        :param initial_node_count: The param of the NodePoolSpecUpdate
        :type initial_node_count: int
        :param autoscaling: The param of the NodePoolSpecUpdate
    ...
    def node_template(self):
        ...
        :rtype: :class:`g42cloudsdkcce.v3.NodeSpecUpdate`
        """
