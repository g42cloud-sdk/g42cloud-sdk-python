...
class DeleteNodeRequest:
    ...
    def __init__(self, cluster_id=None, node_id=None, nodepool_scale_down=None):
        ...
        :param cluster_id: The param of the DeleteNodeRequest
        :type cluster_id: str
        :param node_id: The param of the DeleteNodeRequest
        :type node_id: str
        :param nodepool_scale_down: The param of the DeleteNodeRequest
