...
class PersistentVolumeClaim:
    ...
    def __init__(self, api_version=None, kind=None, metadata=None, spec=None, status=None):
        ...
        :param api_version: The param of the PersistentVolumeClaim
        :type api_version: str
        :param kind: The param of the PersistentVolumeClaim
        :type kind: str
        :param metadata: The param of the PersistentVolumeClaim
        :type metadata: :class:`g42cloudsdkcce.v3.PersistentVolumeClaimMetadata`
        :param spec: The param of the PersistentVolumeClaim
        :type spec: :class:`g42cloudsdkcce.v3.PersistentVolumeClaimSpec`
        :param status: The param of the PersistentVolumeClaim
