...
class ListAddonTemplatesResponse(SdkResponse):
    ...
    def __init__(self, kind=None, api_version=None, items=None):
        ...
        :param kind: The param of the ListAddonTemplatesResponse
        :type kind: str
        :param api_version: The param of the ListAddonTemplatesResponse
        :type api_version: str
        :param items: The param of the ListAddonTemplatesResponse
        :type items: list[:class:`g42cloudsdkcce.v3.AddonTemplate`]
        """
    ...
    def items(self):
        ...
        :rtype: list[:class:`g42cloudsdkcce.v3.AddonTemplate`]
        """
        return self._items
