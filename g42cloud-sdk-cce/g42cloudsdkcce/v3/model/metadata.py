...
class Metadata:
    ...
    def __init__(self, uid=None, name=None, labels=None, annotations=None, update_timestamp=None, creation_timestamp=None):
        ...
        :param uid: The param of the Metadata
        :type uid: str
        :param name: The param of the Metadata
        :type name: str
        :param labels: The param of the Metadata
        :type labels: dict(str, str)
        :param annotations: The param of the Metadata
        :type annotations: dict(str, str)
        :param update_timestamp: The param of the Metadata
        :type update_timestamp: date
        :param creation_timestamp: The param of the Metadata
