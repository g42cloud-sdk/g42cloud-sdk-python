...
class CreateNodeRequest:
    ...
    def __init__(self, cluster_id=None, nodepool_scale_up=None, body=None):
        ...
        :param cluster_id: The param of the CreateNodeRequest
        :type cluster_id: str
        :param nodepool_scale_up: The param of the CreateNodeRequest
        :type nodepool_scale_up: str
        :param body: The param of the CreateNodeRequest
        :type body: :class:`g42cloudsdkcce.v3.NodeCreateRequest`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkcce.v3.NodeCreateRequest`
        """
        return self._body
