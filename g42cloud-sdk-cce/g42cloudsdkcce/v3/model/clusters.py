...
class Clusters:
    ...
    def __init__(self, name=None, cluster=None):
        ...
        :param name: The param of the Clusters
        :type name: str
        :param cluster: The param of the Clusters
        :type cluster: :class:`g42cloudsdkcce.v3.ClusterCert`
        """
    ...
    def cluster(self):
        ...
        :rtype: :class:`g42cloudsdkcce.v3.ClusterCert`
        """
