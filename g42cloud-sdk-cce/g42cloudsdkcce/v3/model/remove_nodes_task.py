...
class RemoveNodesTask:
    ...
    def __init__(self, api_version=None, kind=None, spec=None, status=None):
        ...
        :param api_version: The param of the RemoveNodesTask
        :type api_version: str
        :param kind: The param of the RemoveNodesTask
        :type kind: str
        :param spec: The param of the RemoveNodesTask
        :type spec: :class:`g42cloudsdkcce.v3.RemoveNodesSpec`
        :param status: The param of the RemoveNodesTask
