...
class ListAddonInstancesResponse(SdkResponse):
    ...
    def __init__(self, kind=None, api_version=None, items=None):
        ...
        :param kind: The param of the ListAddonInstancesResponse
        :type kind: str
        :param api_version: The param of the ListAddonInstancesResponse
        :type api_version: str
        :param items: The param of the ListAddonInstancesResponse
        :type items: list[:class:`g42cloudsdkcce.v3.AddonInstance`]
        """
    ...
    def items(self):
        ...
        :rtype: list[:class:`g42cloudsdkcce.v3.AddonInstance`]
        """
        return self._items
