...
class AddonInstanceStatus:
    ...
    def __init__(self, status=None, reason=None, message=None, target_versions=None, current_version=None):
        ...
        :param status: The param of the AddonInstanceStatus
        :type status: str
        :param reason: The param of the AddonInstanceStatus
        :type reason: str
        :param message: The param of the AddonInstanceStatus
        :type message: str
        :param target_versions: The param of the AddonInstanceStatus
        :type target_versions: list[str]
        :param current_version: The param of the AddonInstanceStatus
        :type current_version: :class:`g42cloudsdkcce.v3.Versions`
        """
    ...
    def current_version(self):
        ...
        :rtype: :class:`g42cloudsdkcce.v3.Versions`
        """
