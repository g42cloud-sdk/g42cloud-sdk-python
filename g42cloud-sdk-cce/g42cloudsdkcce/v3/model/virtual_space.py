...
class VirtualSpace:
    ...
    def __init__(self, name=None, size=None, lvm_config=None, runtime_config=None):
        ...
        :param name: The param of the VirtualSpace
        :type name: str
        :param size: The param of the VirtualSpace
        :type size: str
        :param lvm_config: The param of the VirtualSpace
        :type lvm_config: :class:`g42cloudsdkcce.v3.LVMConfig`
        :param runtime_config: The param of the VirtualSpace
        :type runtime_config: :class:`g42cloudsdkcce.v3.RuntimeConfig`
        """
    ...
    def lvm_config(self):
        ...
        :rtype: :class:`g42cloudsdkcce.v3.LVMConfig`
        """
    ...
    def runtime_config(self):
        ...
        :rtype: :class:`g42cloudsdkcce.v3.RuntimeConfig`
        """
