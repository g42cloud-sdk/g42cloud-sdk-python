...
class StorageSelectors:
    ...
    def __init__(self, name=None, storage_type=None, match_labels=None):
        ...
        :param name: The param of the StorageSelectors
        :type name: str
        :param storage_type: The param of the StorageSelectors
        :type storage_type: str
        :param match_labels: The param of the StorageSelectors
        :type match_labels: :class:`g42cloudsdkcce.v3.StorageSelectorsMatchLabels`
        """
    ...
    def match_labels(self):
        ...
        :rtype: :class:`g42cloudsdkcce.v3.StorageSelectorsMatchLabels`
        """
