...
class NodeCreateRequest:
    ...
    def __init__(self, kind=None, api_version=None, metadata=None, spec=None):
        ...
        :param kind: The param of the NodeCreateRequest
        :type kind: str
        :param api_version: The param of the NodeCreateRequest
        :type api_version: str
        :param metadata: The param of the NodeCreateRequest
        :type metadata: :class:`g42cloudsdkcce.v3.NodeMetadata`
        :param spec: The param of the NodeCreateRequest
