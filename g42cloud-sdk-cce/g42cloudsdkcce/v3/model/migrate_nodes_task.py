...
class MigrateNodesTask:
    ...
    def __init__(self, api_version=None, kind=None, spec=None, status=None):
        ...
        :param api_version: The param of the MigrateNodesTask
        :type api_version: str
        :param kind: The param of the MigrateNodesTask
        :type kind: str
        :param spec: The param of the MigrateNodesTask
        :type spec: :class:`g42cloudsdkcce.v3.MigrateNodesSpec`
        :param status: The param of the MigrateNodesTask
    ...
    def api_version(self):
        """Gets the api_version of this MigrateNodesTask.

        :return: The api_version of this MigrateNodesTask.
        :rtype: str
        """
    ...
    def api_version(self, api_version):
        """Sets the api_version of this MigrateNodesTask.
    ...
    @property
    def kind(self):
        """Gets the kind of this MigrateNodesTask.

        :return: The kind of this MigrateNodesTask.
        :rtype: str
        """
        return self._kind
    ...
    @kind.setter
    def kind(self, kind):
        """Sets the kind of this MigrateNodesTask.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MigrateNodesTask):
            return False
