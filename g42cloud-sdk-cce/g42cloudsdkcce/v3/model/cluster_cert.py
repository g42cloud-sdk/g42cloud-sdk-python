...
class ClusterCert:
    ...
    def __init__(self, server=None, certificate_authority_data=None, insecure_skip_tls_verify=None):
        ...
        :param server: The param of the ClusterCert
        :type server: str
        :param certificate_authority_data: The param of the ClusterCert
        :type certificate_authority_data: str
        :param insecure_skip_tls_verify: The param of the ClusterCert
