...
class NodePool:
    ...
    def __init__(self, kind=None, api_version=None, metadata=None, spec=None, status=None):
        ...
        :param kind: The param of the NodePool
        :type kind: str
        :param api_version: The param of the NodePool
        :type api_version: str
        :param metadata: The param of the NodePool
        :type metadata: :class:`g42cloudsdkcce.v3.NodePoolMetadata`
        :param spec: The param of the NodePool
        :type spec: :class:`g42cloudsdkcce.v3.NodePoolSpec`
        :param status: The param of the NodePool
