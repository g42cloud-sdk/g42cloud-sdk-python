...
class UpdateNodeRequest:
    ...
    def __init__(self, cluster_id=None, node_id=None, body=None):
        ...
        :param cluster_id: The param of the UpdateNodeRequest
        :type cluster_id: str
        :param node_id: The param of the UpdateNodeRequest
        :type node_id: str
        :param body: The param of the UpdateNodeRequest
        :type body: :class:`g42cloudsdkcce.v3.ClusterNodeInformation`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkcce.v3.ClusterNodeInformation`
        """
        return self._body
