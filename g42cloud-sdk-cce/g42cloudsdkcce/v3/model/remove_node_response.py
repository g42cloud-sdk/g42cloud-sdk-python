...
class RemoveNodeResponse(SdkResponse):
    ...
    def __init__(self, api_version=None, kind=None, spec=None, status=None):
        ...
        :param api_version: The param of the RemoveNodeResponse
        :type api_version: str
        :param kind: The param of the RemoveNodeResponse
        :type kind: str
        :param spec: The param of the RemoveNodeResponse
        :type spec: :class:`g42cloudsdkcce.v3.RemoveNodesSpec`
        :param status: The param of the RemoveNodeResponse
    ...
    def spec(self):
        ...
        :rtype: :class:`g42cloudsdkcce.v3.RemoveNodesSpec`
        """
        return self._spec
