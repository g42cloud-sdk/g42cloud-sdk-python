...
class InstanceSpec:
    ...
    def __init__(self, cluster_id=None, version=None, addon_template_name=None, addon_template_type=None, addon_template_logo=None, addon_template_labels=None, description=None, values=None):
        ...
        :param cluster_id: The param of the InstanceSpec
        :type cluster_id: str
        :param version: The param of the InstanceSpec
        :type version: str
        :param addon_template_name: The param of the InstanceSpec
        :type addon_template_name: str
        :param addon_template_type: The param of the InstanceSpec
        :type addon_template_type: str
        :param addon_template_logo: The param of the InstanceSpec
        :type addon_template_logo: str
        :param addon_template_labels: The param of the InstanceSpec
        :type addon_template_labels: list[str]
        :param description: The param of the InstanceSpec
        :type description: str
        :param values: The param of the InstanceSpec
