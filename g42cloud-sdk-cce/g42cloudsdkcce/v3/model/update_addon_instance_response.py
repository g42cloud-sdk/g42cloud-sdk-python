...
class UpdateAddonInstanceResponse(SdkResponse):
    ...
    def __init__(self, kind=None, api_version=None, metadata=None, spec=None, status=None):
        ...
        :param kind: The param of the UpdateAddonInstanceResponse
        :type kind: str
        :param api_version: The param of the UpdateAddonInstanceResponse
        :type api_version: str
        :param metadata: The param of the UpdateAddonInstanceResponse
        :type metadata: :class:`g42cloudsdkcce.v3.Metadata`
        :param spec: The param of the UpdateAddonInstanceResponse
        :type spec: :class:`g42cloudsdkcce.v3.InstanceSpec`
        :param status: The param of the UpdateAddonInstanceResponse
