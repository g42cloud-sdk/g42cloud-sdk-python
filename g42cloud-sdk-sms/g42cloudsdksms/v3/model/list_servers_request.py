...
class ListServersRequest:
    ...
    def __init__(self, state=None, name=None, id=None, ip=None, migproject=None, limit=None, offset=None, migration_cycle=None, connected=None, enterprise_project_id=None):
        ...
        :param state: The param of the ListServersRequest
        :type state: str
        :param name: The param of the ListServersRequest
        :type name: str
        :param id: The param of the ListServersRequest
        :type id: str
        :param ip: The param of the ListServersRequest
        :type ip: str
        :param migproject: The param of the ListServersRequest
        :type migproject: str
        :param limit: The param of the ListServersRequest
        :type limit: int
        :param offset: The param of the ListServersRequest
        :type offset: int
        :param migration_cycle: The param of the ListServersRequest
        :type migration_cycle: str
        :param connected: The param of the ListServersRequest
        :type connected: bool
        :param enterprise_project_id: The param of the ListServersRequest
