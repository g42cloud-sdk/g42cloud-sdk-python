...
class UpdateDiskInfoRequest:
    ...
    def __init__(self, source_id=None, body=None):
        ...
        :param source_id: The param of the UpdateDiskInfoRequest
        :type source_id: str
        :param body: The param of the UpdateDiskInfoRequest
        :type body: :class:`g42cloudsdksms.v3.PutDiskInfoReq`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdksms.v3.PutDiskInfoReq`
        """
        return self._body
