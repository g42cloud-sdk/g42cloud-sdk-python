...
class CheckNetAclRequest:
    ...
    def __init__(self, t_project_id=None, t_network_id=None, region_id=None, os_type=None):
        ...
        :param t_project_id: The param of the CheckNetAclRequest
        :type t_project_id: str
        :param t_network_id: The param of the CheckNetAclRequest
        :type t_network_id: str
        :param region_id: The param of the CheckNetAclRequest
        :type region_id: str
        :param os_type: The param of the CheckNetAclRequest
        :type os_type: str
        """
