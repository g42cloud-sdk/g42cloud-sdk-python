...
class UpdateTaskStatusRequest:
    ...
    def __init__(self, task_id=None, body=None):
        ...
        :param task_id: The param of the UpdateTaskStatusRequest
        :type task_id: str
        :param body: The param of the UpdateTaskStatusRequest
        :type body: :class:`g42cloudsdksms.v3.UpdateTaskStatusReq`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdksms.v3.UpdateTaskStatusReq`
        """
        return self._body
