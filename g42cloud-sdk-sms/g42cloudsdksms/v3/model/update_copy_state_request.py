...
class UpdateCopyStateRequest:
    ...
    def __init__(self, source_id=None, body=None):
        ...
        :param source_id: The param of the UpdateCopyStateRequest
        :type source_id: str
        :param body: The param of the UpdateCopyStateRequest
        :type body: :class:`g42cloudsdksms.v3.PutCopyStateReq`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdksms.v3.PutCopyStateReq`
        """
        return self._body
