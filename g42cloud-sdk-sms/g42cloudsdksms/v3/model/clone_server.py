...
class CloneServer:
    ...
    def __init__(self, vm_id=None, name=None, clone_error=None, clone_state=None, error_msg=None):
        ...
        :param vm_id: The param of the CloneServer
        :type vm_id: str
        :param name: The param of the CloneServer
        :type name: str
        :param clone_error: The param of the CloneServer
        :type clone_error: str
        :param clone_state: The param of the CloneServer
        :type clone_state: str
        :param error_msg: The param of the CloneServer
        :type error_msg: str
        """
