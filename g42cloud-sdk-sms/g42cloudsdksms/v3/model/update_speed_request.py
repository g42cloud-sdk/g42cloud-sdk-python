...
class UpdateSpeedRequest:
    ...
    def __init__(self, task_id=None, body=None):
        ...
        :param task_id: The param of the UpdateSpeedRequest
        :type task_id: str
        :param body: The param of the UpdateSpeedRequest
        :type body: :class:`g42cloudsdksms.v3.SpeedLimit`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdksms.v3.SpeedLimit`
        """
        return self._body
