...
class ShowServerResponse(SdkResponse):
    ...
    def __init__(self, id=None, ip=None, name=None, hostname=None, enterprise_project_id=None, add_date=None, os_type=None, os_version=None, oem_system=None, state=None, connected=None, firmware=None, init_target_server=None, cpu_quantity=None, memory=None, current_task=None, disks=None, volume_groups=None, btrfs_list=None, networks=None, checks=None, migration_cycle=None, state_action_time=None, replicatesize=None, totalsize=None, last_visit_time=None, stage_action_time=None, agent_version=None):
        ...
        :param id: The param of the ShowServerResponse
        :type id: str
        :param ip: The param of the ShowServerResponse
        :type ip: str
        :param name: The param of the ShowServerResponse
        :type name: str
        :param hostname: The param of the ShowServerResponse
        :type hostname: str
        :param enterprise_project_id: The param of the ShowServerResponse
        :type enterprise_project_id: str
        :param add_date: The param of the ShowServerResponse
        :type add_date: int
        :param os_type: The param of the ShowServerResponse
        :type os_type: str
        :param os_version: The param of the ShowServerResponse
        :type os_version: str
        :param oem_system: The param of the ShowServerResponse
        :type oem_system: bool
        :param state: The param of the ShowServerResponse
        :type state: str
        :param connected: The param of the ShowServerResponse
        :type connected: bool
        :param firmware: The param of the ShowServerResponse
        :type firmware: str
        :param init_target_server: The param of the ShowServerResponse
        :type init_target_server: :class:`g42cloudsdksms.v3.InitTargetServer`
        :param cpu_quantity: The param of the ShowServerResponse
        :type cpu_quantity: int
        :param memory: The param of the ShowServerResponse
        :type memory: int
        :param current_task: The param of the ShowServerResponse
        :type current_task: :class:`g42cloudsdksms.v3.TaskByServerSource`
        :param disks: The param of the ShowServerResponse
        :type disks: list[:class:`g42cloudsdksms.v3.ServerDisk`]
        :param volume_groups: The param of the ShowServerResponse
        :type volume_groups: list[:class:`g42cloudsdksms.v3.VolumeGroups`]
        :param btrfs_list: The param of the ShowServerResponse
        :type btrfs_list: list[:class:`g42cloudsdksms.v3.BtrfsFileSystem`]
        :param networks: The param of the ShowServerResponse
        :type networks: list[:class:`g42cloudsdksms.v3.NetWork`]
        :param checks: The param of the ShowServerResponse
        :type checks: list[:class:`g42cloudsdksms.v3.EnvironmentCheck`]
        :param migration_cycle: The param of the ShowServerResponse
        :type migration_cycle: str
        :param state_action_time: The param of the ShowServerResponse
        :type state_action_time: int
        :param replicatesize: The param of the ShowServerResponse
        :type replicatesize: int
        :param totalsize: The param of the ShowServerResponse
        :type totalsize: int
        :param last_visit_time: The param of the ShowServerResponse
        :type last_visit_time: int
        :param stage_action_time: The param of the ShowServerResponse
        :type stage_action_time: int
        :param agent_version: The param of the ShowServerResponse
    ...
    def init_target_server(self):
        ...
        :rtype: :class:`g42cloudsdksms.v3.InitTargetServer`
        """
    ...
    def current_task(self):
        ...
        :rtype: :class:`g42cloudsdksms.v3.TaskByServerSource`
        """
    ...
    def checks(self):
        ...
        :rtype: list[:class:`g42cloudsdksms.v3.EnvironmentCheck`]
        """
        return self._checks
