...
class UpdateTaskRequest:
    ...
    def __init__(self, task_id=None, body=None):
        ...
        :param task_id: The param of the UpdateTaskRequest
        :type task_id: str
        :param body: The param of the UpdateTaskRequest
        :type body: :class:`g42cloudsdksms.v3.PutTaskReq`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdksms.v3.PutTaskReq`
        """
        return self._body
