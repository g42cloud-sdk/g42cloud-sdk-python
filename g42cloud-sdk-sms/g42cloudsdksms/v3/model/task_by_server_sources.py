...
class TaskByServerSources:
    ...
    def __init__(self, id=None, name=None, type=None, state=None, estimate_complete_time=None, start_date=None, speed_limit=None, migrate_speed=None, compress_rate=None, start_target_server=None, vm_template_id=None, region_id=None, project_name=None, project_id=None, target_server=None, log_collect_status=None, exist_server=None, use_public_ip=None, clone_server=None, remain_seconds=None, log_bucket=None, log_expire=None, log_upload_time=None, log_share_url=None):
        ...
        :param id: The param of the TaskByServerSources
        :type id: str
        :param name: The param of the TaskByServerSources
        :type name: str
        :param type: The param of the TaskByServerSources
        :type type: str
        :param state: The param of the TaskByServerSources
        :type state: str
        :param estimate_complete_time: The param of the TaskByServerSources
        :type estimate_complete_time: int
        :param start_date: The param of the TaskByServerSources
        :type start_date: int
        :param speed_limit: The param of the TaskByServerSources
        :type speed_limit: int
        :param migrate_speed: The param of the TaskByServerSources
        :type migrate_speed: float
        :param compress_rate: The param of the TaskByServerSources
        :type compress_rate: float
        :param start_target_server: The param of the TaskByServerSources
        :type start_target_server: bool
        :param vm_template_id: The param of the TaskByServerSources
        :type vm_template_id: str
        :param region_id: The param of the TaskByServerSources
        :type region_id: str
        :param project_name: The param of the TaskByServerSources
        :type project_name: str
        :param project_id: The param of the TaskByServerSources
        :type project_id: str
        :param target_server: The param of the TaskByServerSources
        :type target_server: :class:`g42cloudsdksms.v3.TargetServerById`
        :param log_collect_status: The param of the TaskByServerSources
        :type log_collect_status: str
        :param exist_server: The param of the TaskByServerSources
        :type exist_server: bool
        :param use_public_ip: The param of the TaskByServerSources
        :type use_public_ip: bool
        :param clone_server: The param of the TaskByServerSources
        :type clone_server: :class:`g42cloudsdksms.v3.CloneServer`
        :param remain_seconds: The param of the TaskByServerSources
        :type remain_seconds: int
        :param log_bucket: The param of the TaskByServerSources
        :type log_bucket: str
        :param log_expire: The param of the TaskByServerSources
        :type log_expire: int
        :param log_upload_time: The param of the TaskByServerSources
        :type log_upload_time: int
        :param log_share_url: The param of the TaskByServerSources
    ...
    def target_server(self):
        ...
        :rtype: :class:`g42cloudsdksms.v3.TargetServerById`
        """
