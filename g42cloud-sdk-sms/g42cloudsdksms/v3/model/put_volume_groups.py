...
class PutVolumeGroups:
    ...
    def __init__(self, logical_volumes=None, id=None, need_migration=None, adjust_size=None):
        ...
        :param logical_volumes: The param of the PutVolumeGroups
        :type logical_volumes: list[:class:`g42cloudsdksms.v3.PutLogicalVolume`]
        :param id: The param of the PutVolumeGroups
        :type id: str
        :param need_migration: The param of the PutVolumeGroups
        :type need_migration: bool
        :param adjust_size: The param of the PutVolumeGroups
    ...
    def logical_volumes(self):
        ...
        :rtype: list[:class:`g42cloudsdksms.v3.PutLogicalVolume`]
        """
