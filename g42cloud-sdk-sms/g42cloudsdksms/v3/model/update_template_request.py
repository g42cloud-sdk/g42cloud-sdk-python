...
class UpdateTemplateRequest:
    ...
    def __init__(self, id=None, body=None):
        ...
        :param id: The param of the UpdateTemplateRequest
        :type id: str
        :param body: The param of the UpdateTemplateRequest
        :type body: :class:`g42cloudsdksms.v3.UpdateTemplateReq`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdksms.v3.UpdateTemplateReq`
        """
        return self._body
