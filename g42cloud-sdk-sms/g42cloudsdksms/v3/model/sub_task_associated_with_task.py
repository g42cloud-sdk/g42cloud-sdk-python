...
class SubTaskAssociatedWithTask:
    ...
    def __init__(self, id=None, name=None, progress=None, start_date=None, end_date=None, process_trace=None):
        ...
        :param id: The param of the SubTaskAssociatedWithTask
        :type id: int
        :param name: The param of the SubTaskAssociatedWithTask
        :type name: str
        :param progress: The param of the SubTaskAssociatedWithTask
        :type progress: int
        :param start_date: The param of the SubTaskAssociatedWithTask
        :type start_date: int
        :param end_date: The param of the SubTaskAssociatedWithTask
        :type end_date: int
        :param process_trace: The param of the SubTaskAssociatedWithTask
