...
class TargetServerById:
    ...
    def __init__(self, vm_id=None, name=None):
        ...
        :param vm_id: The param of the TargetServerById
        :type vm_id: str
        :param name: The param of the TargetServerById
        :type name: str
        """
    ...
    def vm_id(self):
        ...
        :return: The vm_id of this TargetServerById.
        :rtype: str
        """
        return self._vm_id
    ...
    def name(self):
        ...
        :return: The name of this TargetServerById.
        :rtype: str
        """
        return self._name
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TargetServerById):
            return False
