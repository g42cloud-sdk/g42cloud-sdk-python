...
class UpdateMigprojectRequest:
    ...
    def __init__(self, mig_project_id=None, body=None):
        ...
        :param mig_project_id: The param of the UpdateMigprojectRequest
        :type mig_project_id: str
        :param body: The param of the UpdateMigprojectRequest
        :type body: :class:`g42cloudsdksms.v3.MigProject`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdksms.v3.MigProject`
        """
        return self._body
