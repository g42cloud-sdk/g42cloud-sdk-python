...
class SourceServerResponse:
    ...
    def __init__(self, id=None, ip=None, name=None, os_type=None, os_version=None, oem_system=None, state=None, migration_cycle=None):
        ...
        :param id: The param of the SourceServerResponse
        :type id: str
        :param ip: The param of the SourceServerResponse
        :type ip: str
        :param name: The param of the SourceServerResponse
        :type name: str
        :param os_type: The param of the SourceServerResponse
        :type os_type: str
        :param os_version: The param of the SourceServerResponse
        :type os_version: str
        :param oem_system: The param of the SourceServerResponse
        :type oem_system: bool
        :param state: The param of the SourceServerResponse
        :type state: str
        :param migration_cycle: The param of the SourceServerResponse
