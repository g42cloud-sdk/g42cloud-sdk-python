...
class DeleteTasksRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the DeleteTasksRequest
        :type body: :class:`g42cloudsdksms.v3.DeleteTasksReq`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdksms.v3.DeleteTasksReq`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteTasksRequest):
            return False
