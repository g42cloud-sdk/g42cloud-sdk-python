...
class PutDiskInfoReq:
    ...
    def __init__(self, disks=None, volumegroups=None, btrfs_list=None):
        ...
        :param disks: The param of the PutDiskInfoReq
        :type disks: list[:class:`g42cloudsdksms.v3.ServerDisk`]
        :param volumegroups: The param of the PutDiskInfoReq
        :type volumegroups: list[:class:`g42cloudsdksms.v3.VolumeGroups`]
        :param btrfs_list: The param of the PutDiskInfoReq
