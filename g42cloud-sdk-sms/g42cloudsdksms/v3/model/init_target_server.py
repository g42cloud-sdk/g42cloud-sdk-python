...
class InitTargetServer:
    ...
    def __init__(self, disks=None, volume_groups=None):
        ...
        :param disks: The param of the InitTargetServer
        :type disks: list[:class:`g42cloudsdksms.v3.DiskIntargetServer`]
        :param volume_groups: The param of the InitTargetServer
    ...
    def disks(self):
        ...
        :rtype: list[:class:`g42cloudsdksms.v3.DiskIntargetServer`]
        """
        return self._disks
