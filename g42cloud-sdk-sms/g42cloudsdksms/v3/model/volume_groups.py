...
class VolumeGroups:
    ...
    def __init__(self, components=None, free_size=None, logical_volumes=None, name=None, size=None):
        ...
        :param components: The param of the VolumeGroups
        :type components: str
        :param free_size: The param of the VolumeGroups
        :type free_size: int
        :param logical_volumes: The param of the VolumeGroups
        :type logical_volumes: list[:class:`g42cloudsdksms.v3.LogicalVolumes`]
        :param name: The param of the VolumeGroups
        :type name: str
        :param size: The param of the VolumeGroups
        :type size: int
        """
    ...
    def logical_volumes(self):
        ...
        :rtype: list[:class:`g42cloudsdksms.v3.LogicalVolumes`]
        """
