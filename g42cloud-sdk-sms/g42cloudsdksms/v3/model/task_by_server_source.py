...
class TaskByServerSource:
    ...
    def __init__(self, id=None, name=None, type=None, state=None, start_date=None, speed_limit=None, migrate_speed=None, start_target_server=None, vm_template_id=None, region_id=None, project_name=None, project_id=None, target_server=None, log_collect_status=None, exist_server=None, use_public_ip=None, clone_server=None):
        ...
        :param id: The param of the TaskByServerSource
        :type id: str
        :param name: The param of the TaskByServerSource
        :type name: str
        :param type: The param of the TaskByServerSource
        :type type: str
        :param state: The param of the TaskByServerSource
        :type state: str
        :param start_date: The param of the TaskByServerSource
        :type start_date: int
        :param speed_limit: The param of the TaskByServerSource
        :type speed_limit: int
        :param migrate_speed: The param of the TaskByServerSource
        :type migrate_speed: float
        :param start_target_server: The param of the TaskByServerSource
        :type start_target_server: bool
        :param vm_template_id: The param of the TaskByServerSource
        :type vm_template_id: str
        :param region_id: The param of the TaskByServerSource
        :type region_id: str
        :param project_name: The param of the TaskByServerSource
        :type project_name: str
        :param project_id: The param of the TaskByServerSource
        :type project_id: str
        :param target_server: The param of the TaskByServerSource
        :type target_server: :class:`g42cloudsdksms.v3.TargetServerById`
        :param log_collect_status: The param of the TaskByServerSource
        :type log_collect_status: str
        :param exist_server: The param of the TaskByServerSource
        :type exist_server: bool
        :param use_public_ip: The param of the TaskByServerSource
        :type use_public_ip: bool
        :param clone_server: The param of the TaskByServerSource
