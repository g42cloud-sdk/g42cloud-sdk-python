...
class UpdateMigprojectResponse(SdkResponse):
    ...
    def __init__(self, body=None):
        ...
        :param body: The param of the UpdateMigprojectResponse
        :type body: str
        """
        
        super(UpdateMigprojectResponse, self).__init__()
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateMigprojectResponse):
            return False
