...
class ShowOverviewResponse(SdkResponse):
    ...
    def __init__(self, waiting=None, replicating=None, syncing=None, other=None):
        ...
        :param waiting: The param of the ShowOverviewResponse
        :type waiting: int
        :param replicating: The param of the ShowOverviewResponse
        :type replicating: int
        :param syncing: The param of the ShowOverviewResponse
        :type syncing: int
        :param other: The param of the ShowOverviewResponse
        :type other: int
        """
