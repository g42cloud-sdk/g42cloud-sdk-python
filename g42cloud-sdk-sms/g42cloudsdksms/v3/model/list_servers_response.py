...
class ListServersResponse(SdkResponse):
    ...
    def __init__(self, count=None, source_servers=None):
        ...
        :param count: The param of the ListServersResponse
        :type count: int
        :param source_servers: The param of the ListServersResponse
        :type source_servers: list[:class:`g42cloudsdksms.v3.SourceServersResponseBody`]
        """
    ...
    def source_servers(self):
        ...
        :rtype: list[:class:`g42cloudsdksms.v3.SourceServersResponseBody`]
        """
