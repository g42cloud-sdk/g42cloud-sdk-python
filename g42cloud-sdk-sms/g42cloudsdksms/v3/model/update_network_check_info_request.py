...
class UpdateNetworkCheckInfoRequest:
    ...
    def __init__(self, task_id=None, body=None):
        ...
        :param task_id: The param of the UpdateNetworkCheckInfoRequest
        :type task_id: str
        :param body: The param of the UpdateNetworkCheckInfoRequest
        :type body: :class:`g42cloudsdksms.v3.NetworkCheckInfoRequestBody`
        """
