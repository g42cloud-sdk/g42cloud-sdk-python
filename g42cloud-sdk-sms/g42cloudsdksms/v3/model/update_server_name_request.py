...
class UpdateServerNameRequest:
    ...
    def __init__(self, source_id=None, body=None):
        ...
        :param source_id: The param of the UpdateServerNameRequest
        :type source_id: str
        :param body: The param of the UpdateServerNameRequest
        :type body: :class:`g42cloudsdksms.v3.PutSourceServerBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdksms.v3.PutSourceServerBody`
        """
        return self._body
