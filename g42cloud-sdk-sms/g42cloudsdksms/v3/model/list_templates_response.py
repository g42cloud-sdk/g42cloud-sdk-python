...
class ListTemplatesResponse(SdkResponse):
    ...
    def __init__(self, count=None, templates=None):
        ...
        :param count: The param of the ListTemplatesResponse
        :type count: int
        :param templates: The param of the ListTemplatesResponse
        :type templates: list[:class:`g42cloudsdksms.v3.TemplateResponseBody`]
        """
    ...
    def templates(self):
        ...
        :rtype: list[:class:`g42cloudsdksms.v3.TemplateResponseBody`]
        """
