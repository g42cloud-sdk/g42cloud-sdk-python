...
class BtrfsSubvolumn:
    ...
    def __init__(self, uuid=None, is_snapshot=None, subvol_id=None, parent_id=None, subvol_name=None, subvol_mount_path=None):
        ...
        :param uuid: The param of the BtrfsSubvolumn
        :type uuid: str
        :param is_snapshot: The param of the BtrfsSubvolumn
        :type is_snapshot: str
        :param subvol_id: The param of the BtrfsSubvolumn
        :type subvol_id: str
        :param parent_id: The param of the BtrfsSubvolumn
        :type parent_id: str
        :param subvol_name: The param of the BtrfsSubvolumn
        :type subvol_name: str
        :param subvol_mount_path: The param of the BtrfsSubvolumn
