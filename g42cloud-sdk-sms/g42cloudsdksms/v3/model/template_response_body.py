...
class TemplateResponseBody:
    ...
    def __init__(self, id=None, name=None, is_template=None, region=None, projectid=None, target_server_name=None, availability_zone=None, volumetype=None, flavor=None, vpc=None, nics=None, security_groups=None, publicip=None, disk=None, data_volume_type=None, target_password=None, image_id=None):
        ...
        :param id: The param of the TemplateResponseBody
        :type id: str
        :param name: The param of the TemplateResponseBody
        :type name: str
        :param is_template: The param of the TemplateResponseBody
        :type is_template: str
        :param region: The param of the TemplateResponseBody
        :type region: str
        :param projectid: The param of the TemplateResponseBody
        :type projectid: str
        :param target_server_name: The param of the TemplateResponseBody
        :type target_server_name: str
        :param availability_zone: The param of the TemplateResponseBody
        :type availability_zone: str
        :param volumetype: The param of the TemplateResponseBody
        :type volumetype: str
        :param flavor: The param of the TemplateResponseBody
        :type flavor: str
        :param vpc: The param of the TemplateResponseBody
        :type vpc: :class:`g42cloudsdksms.v3.VpcObject`
        :param nics: The param of the TemplateResponseBody
        :type nics: list[:class:`g42cloudsdksms.v3.Nics`]
        :param security_groups: The param of the TemplateResponseBody
        :type security_groups: list[:class:`g42cloudsdksms.v3.SgObject`]
        :param publicip: The param of the TemplateResponseBody
        :type publicip: :class:`g42cloudsdksms.v3.PublicIp`
        :param disk: The param of the TemplateResponseBody
        :type disk: list[:class:`g42cloudsdksms.v3.TemplateDisk`]
        :param data_volume_type: The param of the TemplateResponseBody
        :type data_volume_type: str
        :param target_password: The param of the TemplateResponseBody
        :type target_password: str
        :param image_id: The param of the TemplateResponseBody
        :type image_id: str
        """
