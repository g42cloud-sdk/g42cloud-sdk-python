...
class PutSourceServerBody:
    ...
    def __init__(self, name=None, migprojectid=None, disks=None, volume_groups=None):
        ...
        :param name: The param of the PutSourceServerBody
        :type name: str
        :param migprojectid: The param of the PutSourceServerBody
        :type migprojectid: str
        :param disks: The param of the PutSourceServerBody
        :type disks: list[:class:`g42cloudsdksms.v3.PutDisk`]
        :param volume_groups: The param of the PutSourceServerBody
        :type volume_groups: list[:class:`g42cloudsdksms.v3.PutVolumeGroups`]
        """
    ...
    def disks(self):
        ...
        :rtype: list[:class:`g42cloudsdksms.v3.PutDisk`]
        """
        return self._disks
    ...
    def volume_groups(self):
        ...
        :rtype: list[:class:`g42cloudsdksms.v3.PutVolumeGroups`]
        """
