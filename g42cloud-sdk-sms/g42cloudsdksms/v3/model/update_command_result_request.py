...
class UpdateCommandResultRequest:
    ...
    def __init__(self, server_id=None, body=None):
        ...
        :param server_id: The param of the UpdateCommandResultRequest
        :type server_id: str
        :param body: The param of the UpdateCommandResultRequest
        :type body: :class:`g42cloudsdksms.v3.CommandBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdksms.v3.CommandBody`
        """
        return self._body
