...
class TargetServerByTask:
    ...
    def __init__(self, btrfs_list=None, disks=None, name=None, vm_id=None, volume_groups=None):
        ...
        :param btrfs_list: The param of the TargetServerByTask
        :type btrfs_list: list[:class:`g42cloudsdksms.v3.BtrfsFileSystem`]
        :param disks: The param of the TargetServerByTask
        :type disks: list[:class:`g42cloudsdksms.v3.TargetDisks`]
        :param name: The param of the TargetServerByTask
        :type name: str
        :param vm_id: The param of the TargetServerByTask
        :type vm_id: str
        :param volume_groups: The param of the TargetServerByTask
    ...
    def disks(self):
        ...
        :rtype: list[:class:`g42cloudsdksms.v3.TargetDisks`]
        """
        return self._disks
