...
class UpdateTaskSpeedRequest:
    ...
    def __init__(self, task_id=None, body=None):
        ...
        :param task_id: The param of the UpdateTaskSpeedRequest
        :type task_id: str
        :param body: The param of the UpdateTaskSpeedRequest
        :type body: :class:`g42cloudsdksms.v3.UpdateTaskSpeedReq`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdksms.v3.UpdateTaskSpeedReq`
        """
        return self._body
