...
class PutDisk:
    ...
    def __init__(self, need_migration=None, id=None, adjust_size=None, physical_volumes=None):
        ...
        :param need_migration: The param of the PutDisk
        :type need_migration: bool
        :param id: The param of the PutDisk
        :type id: str
        :param adjust_size: The param of the PutDisk
        :type adjust_size: int
        :param physical_volumes: The param of the PutDisk
        :type physical_volumes: list[:class:`g42cloudsdksms.v3.PutVolume`]
        """
    ...
    def physical_volumes(self):
        ...
        :rtype: list[:class:`g42cloudsdksms.v3.PutVolume`]
        """
