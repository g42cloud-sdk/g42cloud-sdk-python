...
class TemplateDisk:
    ...
    def __init__(self, id=None, index=None, name=None, disktype=None, size=None, device_use=None):
        ...
        :param id: The param of the TemplateDisk
        :type id: int
        :param index: The param of the TemplateDisk
        :type index: int
        :param name: The param of the TemplateDisk
        :type name: str
        :param disktype: The param of the TemplateDisk
        :type disktype: str
        :param size: The param of the TemplateDisk
        :type size: int
        :param device_use: The param of the TemplateDisk
        :type device_use: str
        """
