...
class MigrationErrors:
    ...
    def __init__(self, error_json=None, host_name=None, name=None, source_id=None, source_ip=None, target_ip=None):
        ...
        :param error_json: The param of the MigrationErrors
        :type error_json: str
        :param host_name: The param of the MigrationErrors
        :type host_name: str
        :param name: The param of the MigrationErrors
        :type name: str
        :param source_id: The param of the MigrationErrors
        :type source_id: str
        :param source_ip: The param of the MigrationErrors
        :type source_ip: str
        :param target_ip: The param of the MigrationErrors
        :type target_ip: str
        """
