...
class LogicalVolumes:
    ...
    def __init__(self, block_count=None, block_size=None, file_system=None, inode_size=None, device_use=None, mount_point=None, name=None, size=None, used_size=None, free_size=None):
        ...
        :param block_count: The param of the LogicalVolumes
        :type block_count: int
        :param block_size: The param of the LogicalVolumes
        :type block_size: int
        :param file_system: The param of the LogicalVolumes
        :type file_system: str
        :param inode_size: The param of the LogicalVolumes
        :type inode_size: int
        :param device_use: The param of the LogicalVolumes
        :type device_use: int
        :param mount_point: The param of the LogicalVolumes
        :type mount_point: str
        :param name: The param of the LogicalVolumes
        :type name: str
        :param size: The param of the LogicalVolumes
        :type size: int
        :param used_size: The param of the LogicalVolumes
        :type used_size: int
        :param free_size: The param of the LogicalVolumes
        :type free_size: int
        """
