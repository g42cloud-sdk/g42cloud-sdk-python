...
class SubTask:
    ...
    def __init__(self, id=None, name=None, progress=None, start_date=None, end_date=None, migrate_speed=None, user_op=None, process_trace=None):
        ...
        :param id: The param of the SubTask
        :type id: int
        :param name: The param of the SubTask
        :type name: str
        :param progress: The param of the SubTask
        :type progress: int
        :param start_date: The param of the SubTask
        :type start_date: int
        :param end_date: The param of the SubTask
        :type end_date: int
        :param migrate_speed: The param of the SubTask
        :type migrate_speed: float
        :param user_op: The param of the SubTask
        :type user_op: str
        :param process_trace: The param of the SubTask
