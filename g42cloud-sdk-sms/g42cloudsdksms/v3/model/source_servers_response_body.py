...
class SourceServersResponseBody:
    ...
    def __init__(self, id=None, ip=None, name=None, enterprise_project_id=None, add_date=None, os_type=None, os_version=None, oem_system=None, state=None, connected=None, cpu_quantity=None, memory=None, current_task=None, checks=None, init_target_server=None, replicatesize=None, stage_action_time=None, totalsize=None, last_visit_time=None, migration_cycle=None, state_action_time=None):
        ...
        :param id: The param of the SourceServersResponseBody
        :type id: str
        :param ip: The param of the SourceServersResponseBody
        :type ip: str
        :param name: The param of the SourceServersResponseBody
        :type name: str
        :param enterprise_project_id: The param of the SourceServersResponseBody
        :type enterprise_project_id: str
        :param add_date: The param of the SourceServersResponseBody
        :type add_date: int
        :param os_type: The param of the SourceServersResponseBody
        :type os_type: str
        :param os_version: The param of the SourceServersResponseBody
        :type os_version: str
        :param oem_system: The param of the SourceServersResponseBody
        :type oem_system: bool
        :param state: The param of the SourceServersResponseBody
        :type state: str
        :param connected: The param of the SourceServersResponseBody
        :type connected: bool
        :param cpu_quantity: The param of the SourceServersResponseBody
        :type cpu_quantity: int
        :param memory: The param of the SourceServersResponseBody
        :type memory: int
        :param current_task: The param of the SourceServersResponseBody
        :type current_task: :class:`g42cloudsdksms.v3.TaskByServerSources`
        :param checks: The param of the SourceServersResponseBody
        :type checks: list[:class:`g42cloudsdksms.v3.EnvironmentCheck`]
        :param init_target_server: The param of the SourceServersResponseBody
        :type init_target_server: :class:`g42cloudsdksms.v3.InitTargetServer`
        :param replicatesize: The param of the SourceServersResponseBody
        :type replicatesize: int
        :param stage_action_time: The param of the SourceServersResponseBody
        :type stage_action_time: int
        :param totalsize: The param of the SourceServersResponseBody
        :type totalsize: int
        :param last_visit_time: The param of the SourceServersResponseBody
        :type last_visit_time: int
        :param migration_cycle: The param of the SourceServersResponseBody
        :type migration_cycle: str
        :param state_action_time: The param of the SourceServersResponseBody
    ...
    def current_task(self):
        ...
        :rtype: :class:`g42cloudsdksms.v3.TaskByServerSources`
        """
