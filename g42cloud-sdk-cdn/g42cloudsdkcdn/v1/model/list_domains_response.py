...
class ListDomainsResponse(SdkResponse):
    ...
    def __init__(self, total=None, domains=None):
        ...
        :param total: The param of the ListDomainsResponse
        :type total: int
        :param domains: The param of the ListDomainsResponse
        :type domains: list[:class:`g42cloudsdkcdn.v1.Domains`]
        """
    ...
    def domains(self):
        ...
        :rtype: list[:class:`g42cloudsdkcdn.v1.Domains`]
        """
