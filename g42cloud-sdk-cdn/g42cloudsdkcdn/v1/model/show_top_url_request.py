...
class ShowTopUrlRequest:
    ...
    def __init__(self, enterprise_project_id=None, start_time=None, end_time=None, domain_name=None, service_area=None, stat_type=None):
        ...
        :param enterprise_project_id: The param of the ShowTopUrlRequest
        :type enterprise_project_id: str
        :param start_time: The param of the ShowTopUrlRequest
        :type start_time: int
        :param end_time: The param of the ShowTopUrlRequest
        :type end_time: int
        :param domain_name: The param of the ShowTopUrlRequest
        :type domain_name: str
        :param service_area: The param of the ShowTopUrlRequest
        :type service_area: str
        :param stat_type: The param of the ShowTopUrlRequest
        :type stat_type: str
        """
