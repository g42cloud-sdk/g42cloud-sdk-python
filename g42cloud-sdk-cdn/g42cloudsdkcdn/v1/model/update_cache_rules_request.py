...
class UpdateCacheRulesRequest:
    ...
    def __init__(self, domain_id=None, enterprise_project_id=None, body=None):
        ...
        :param domain_id: The param of the UpdateCacheRulesRequest
        :type domain_id: str
        :param enterprise_project_id: The param of the UpdateCacheRulesRequest
        :type enterprise_project_id: str
        :param body: The param of the UpdateCacheRulesRequest
        :type body: :class:`g42cloudsdkcdn.v1.CacheConfigRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkcdn.v1.CacheConfigRequestBody`
        """
        return self._body
