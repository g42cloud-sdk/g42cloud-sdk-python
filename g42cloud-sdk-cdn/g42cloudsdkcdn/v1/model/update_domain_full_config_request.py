...
class UpdateDomainFullConfigRequest:
    ...
    def __init__(self, domain_name=None, enterprise_project_id=None, body=None):
        ...
        :param domain_name: The param of the UpdateDomainFullConfigRequest
        :type domain_name: str
        :param enterprise_project_id: The param of the UpdateDomainFullConfigRequest
        :type enterprise_project_id: str
        :param body: The param of the UpdateDomainFullConfigRequest
        :type body: :class:`g42cloudsdkcdn.v1.ModifyDomainConfigRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkcdn.v1.ModifyDomainConfigRequestBody`
        """
        return self._body
