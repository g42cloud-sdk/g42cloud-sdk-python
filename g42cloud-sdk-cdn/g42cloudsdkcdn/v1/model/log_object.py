...
class LogObject:
    ...
    def __init__(self, domain_name=None, start_time=None, end_time=None, name=None, size=None, link=None):
        ...
        :param domain_name: The param of the LogObject
        :type domain_name: str
        :param start_time: The param of the LogObject
        :type start_time: int
        :param end_time: The param of the LogObject
        :type end_time: int
        :param name: The param of the LogObject
        :type name: str
        :param size: The param of the LogObject
        :type size: int
        :param link: The param of the LogObject
        :type link: str
        """
