...
class Quotas:
    ...
    def __init__(self, quota_limit=None, type=None, used=None, user_domain_id=None):
        ...
        :param quota_limit: The param of the Quotas
        :type quota_limit: int
        :param type: The param of the Quotas
        :type type: str
        :param used: The param of the Quotas
        :type used: int
        :param user_domain_id: The param of the Quotas
