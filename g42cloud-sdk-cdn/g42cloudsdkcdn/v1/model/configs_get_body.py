...
class ConfigsGetBody:
    ...
    def __init__(self, origin_request_header=None, http_response_header=None, url_auth=None, https=None, sources=None, origin_protocol=None, force_redirect=None, compress=None):
        ...
        :param origin_request_header: The param of the ConfigsGetBody
        :type origin_request_header: list[:class:`g42cloudsdkcdn.v1.OriginRequestHeader`]
        :param http_response_header: The param of the ConfigsGetBody
        :type http_response_header: list[:class:`g42cloudsdkcdn.v1.HttpResponseHeader`]
        :param url_auth: The param of the ConfigsGetBody
        :type url_auth: :class:`g42cloudsdkcdn.v1.UrlAuthGetBody`
        :param https: The param of the ConfigsGetBody
        :type https: :class:`g42cloudsdkcdn.v1.HttpGetBody`
        :param sources: The param of the ConfigsGetBody
        :type sources: list[:class:`g42cloudsdkcdn.v1.SourcesConfig`]
        :param origin_protocol: The param of the ConfigsGetBody
        :type origin_protocol: str
        :param force_redirect: The param of the ConfigsGetBody
        :type force_redirect: :class:`g42cloudsdkcdn.v1.ForceRedirectConfig`
        :param compress: The param of the ConfigsGetBody
        :type compress: :class:`g42cloudsdkcdn.v1.Compress`
        """
    ...
    def origin_request_header(self):
        ...
        :rtype: list[:class:`g42cloudsdkcdn.v1.OriginRequestHeader`]
        """
    ...
    def http_response_header(self):
        ...
        :rtype: list[:class:`g42cloudsdkcdn.v1.HttpResponseHeader`]
        """
    ...
    def url_auth(self):
        ...
        :rtype: :class:`g42cloudsdkcdn.v1.UrlAuthGetBody`
        """
    ...
    def https(self):
        ...
        :rtype: :class:`g42cloudsdkcdn.v1.HttpGetBody`
        """
        return self._https
    ...
    def sources(self):
        ...
        :rtype: list[:class:`g42cloudsdkcdn.v1.SourcesConfig`]
        """
    ...
    def force_redirect(self):
        ...
        :rtype: :class:`g42cloudsdkcdn.v1.ForceRedirectConfig`
        """
    ...
    def compress(self):
        ...
        :rtype: :class:`g42cloudsdkcdn.v1.Compress`
        """
