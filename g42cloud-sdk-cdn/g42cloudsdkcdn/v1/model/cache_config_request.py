...
class CacheConfigRequest:
    ...
    def __init__(self, ignore_url_parameter=None, follow_origin=None, compress=None, rules=None):
        ...
        :param ignore_url_parameter: The param of the CacheConfigRequest
        :type ignore_url_parameter: bool
        :param follow_origin: The param of the CacheConfigRequest
        :type follow_origin: bool
        :param compress: The param of the CacheConfigRequest
        :type compress: :class:`g42cloudsdkcdn.v1.CompressRequest`
        :param rules: The param of the CacheConfigRequest
    ...
    def compress(self):
        ...
        :rtype: :class:`g42cloudsdkcdn.v1.CompressRequest`
        """
