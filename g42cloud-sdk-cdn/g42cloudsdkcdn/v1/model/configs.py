...
class Configs:
    ...
    def __init__(self, origin_request_header=None, http_response_header=None, url_auth=None, https=None, sources=None, origin_protocol=None, force_redirect=None, compress=None):
        ...
        :param origin_request_header: The param of the Configs
        :type origin_request_header: list[:class:`g42cloudsdkcdn.v1.OriginRequestHeader`]
        :param http_response_header: The param of the Configs
        :type http_response_header: list[:class:`g42cloudsdkcdn.v1.HttpResponseHeader`]
        :param url_auth: The param of the Configs
        :type url_auth: :class:`g42cloudsdkcdn.v1.UrlAuth`
        :param https: The param of the Configs
        :type https: :class:`g42cloudsdkcdn.v1.HttpPutBody`
        :param sources: The param of the Configs
        :type sources: list[:class:`g42cloudsdkcdn.v1.SourcesConfig`]
        :param origin_protocol: The param of the Configs
        :type origin_protocol: str
        :param force_redirect: The param of the Configs
        :type force_redirect: :class:`g42cloudsdkcdn.v1.ForceRedirectConfig`
        :param compress: The param of the Configs
    ...
    def url_auth(self):
        ...
        :rtype: :class:`g42cloudsdkcdn.v1.UrlAuth`
        """
    ...
    def https(self):
        ...
        :rtype: :class:`g42cloudsdkcdn.v1.HttpPutBody`
        """
        return self._https
