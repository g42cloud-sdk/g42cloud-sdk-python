...
class DomainItemDetail:
    ...
    def __init__(self, start_time=None, end_time=None, stat_type=None, domains=None):
        ...
        :param start_time: The param of the DomainItemDetail
        :type start_time: int
        :param end_time: The param of the DomainItemDetail
        :type end_time: int
        :param stat_type: The param of the DomainItemDetail
        :type stat_type: str
        :param domains: The param of the DomainItemDetail
