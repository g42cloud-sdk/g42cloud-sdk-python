...
class DomainOriginHost:
    ...
    def __init__(self, domain_id=None, origin_host_type=None, customize_domain=None):
        ...
        :param domain_id: The param of the DomainOriginHost
        :type domain_id: str
        :param origin_host_type: The param of the DomainOriginHost
        :type origin_host_type: str
        :param customize_domain: The param of the DomainOriginHost
