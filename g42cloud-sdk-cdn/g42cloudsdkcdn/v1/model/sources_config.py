...
class SourcesConfig:
    ...
    def __init__(self, origin_addr=None, origin_type=None, priority=None, obs_web_hosting_status=None, http_port=None, https_port=None, host_name=None):
        ...
        :param origin_addr: The param of the SourcesConfig
        :type origin_addr: str
        :param origin_type: The param of the SourcesConfig
        :type origin_type: str
        :param priority: The param of the SourcesConfig
        :type priority: int
        :param obs_web_hosting_status: The param of the SourcesConfig
        :type obs_web_hosting_status: str
        :param http_port: The param of the SourcesConfig
        :type http_port: int
        :param https_port: The param of the SourcesConfig
        :type https_port: int
        :param host_name: The param of the SourcesConfig
        :type host_name: str
        """
