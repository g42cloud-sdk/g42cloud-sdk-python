...
class OriginHostRequest:
    ...
    def __init__(self, origin_host=None):
        ...
        :param origin_host: The param of the OriginHostRequest
        :type origin_host: :class:`g42cloudsdkcdn.v1.OriginHostBody`
        """
    ...
    def origin_host(self):
        ...
        :rtype: :class:`g42cloudsdkcdn.v1.OriginHostBody`
        """
