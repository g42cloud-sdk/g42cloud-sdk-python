...
class UpdateHttpsInfoResponse(SdkResponse):
    ...
    def __init__(self, https=None):
        ...
        :param https: The param of the UpdateHttpsInfoResponse
        :type https: :class:`g42cloudsdkcdn.v1.HttpInfoResponseBody`
        """
    ...
    def https(self):
        ...
        :rtype: :class:`g42cloudsdkcdn.v1.HttpInfoResponseBody`
        """
        return self._https
