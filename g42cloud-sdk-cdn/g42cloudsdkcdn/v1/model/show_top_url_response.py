...
class ShowTopUrlResponse(SdkResponse):
    ...
    def __init__(self, service_area=None, top_url_summary=None):
        ...
        :param service_area: The param of the ShowTopUrlResponse
        :type service_area: str
        :param top_url_summary: The param of the ShowTopUrlResponse
        :type top_url_summary: list[:class:`g42cloudsdkcdn.v1.TopUrlSummary`]
        """
    ...
    def top_url_summary(self):
        ...
        :rtype: list[:class:`g42cloudsdkcdn.v1.TopUrlSummary`]
        """
