...
class TopUrlSummary:
    ...
    def __init__(self, url=None, value=None, start_time=None, end_time=None, stat_type=None):
        ...
        :param url: The param of the TopUrlSummary
        :type url: str
        :param value: The param of the TopUrlSummary
        :type value: int
        :param start_time: The param of the TopUrlSummary
        :type start_time: int
        :param end_time: The param of the TopUrlSummary
        :type end_time: int
        :param stat_type: The param of the TopUrlSummary
        :type stat_type: str
        """
