...
class ShowHistoryTaskDetailsResponse(SdkResponse):
    ...
    def __init__(self, id=None, task_type=None, status=None, urls=None, create_time=None, processing=None, succeed=None, failed=None, total=None, file_type=None):
        ...
        :param id: The param of the ShowHistoryTaskDetailsResponse
        :type id: str
        :param task_type: The param of the ShowHistoryTaskDetailsResponse
        :type task_type: str
        :param status: The param of the ShowHistoryTaskDetailsResponse
        :type status: str
        :param urls: The param of the ShowHistoryTaskDetailsResponse
        :type urls: list[:class:`g42cloudsdkcdn.v1.UrlObject`]
        :param create_time: The param of the ShowHistoryTaskDetailsResponse
        :type create_time: int
        :param processing: The param of the ShowHistoryTaskDetailsResponse
        :type processing: int
        :param succeed: The param of the ShowHistoryTaskDetailsResponse
        :type succeed: int
        :param failed: The param of the ShowHistoryTaskDetailsResponse
        :type failed: int
        :param total: The param of the ShowHistoryTaskDetailsResponse
        :type total: int
        :param file_type: The param of the ShowHistoryTaskDetailsResponse
        :type file_type: str
        """
    ...
    def urls(self):
        ...
        :rtype: list[:class:`g42cloudsdkcdn.v1.UrlObject`]
        """
        return self._urls
