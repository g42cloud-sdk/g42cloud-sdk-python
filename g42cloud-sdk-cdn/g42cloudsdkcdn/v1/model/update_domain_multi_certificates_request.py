...
class UpdateDomainMultiCertificatesRequest:
    ...
    def __init__(self, enterprise_project_id=None, body=None):
        ...
        :param enterprise_project_id: The param of the UpdateDomainMultiCertificatesRequest
        :type enterprise_project_id: str
        :param body: The param of the UpdateDomainMultiCertificatesRequest
        :type body: :class:`g42cloudsdkcdn.v1.UpdateDomainMultiCertificatesRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkcdn.v1.UpdateDomainMultiCertificatesRequestBody`
        """
        return self._body
