...
class UpdatePrivateBucketAccessRequest:
    ...
    def __init__(self, enterprise_project_id=None, domain_id=None, body=None):
        ...
        :param enterprise_project_id: The param of the UpdatePrivateBucketAccessRequest
        :type enterprise_project_id: str
        :param domain_id: The param of the UpdatePrivateBucketAccessRequest
        :type domain_id: str
        :param body: The param of the UpdatePrivateBucketAccessRequest
        :type body: :class:`g42cloudsdkcdn.v1.UpdatePrivateBucketAccessBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkcdn.v1.UpdatePrivateBucketAccessBody`
        """
        return self._body
