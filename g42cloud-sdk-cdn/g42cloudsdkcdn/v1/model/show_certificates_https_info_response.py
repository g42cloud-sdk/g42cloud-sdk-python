...
class ShowCertificatesHttpsInfoResponse(SdkResponse):
    ...
    def __init__(self, total=None, https=None):
        ...
        :param total: The param of the ShowCertificatesHttpsInfoResponse
        :type total: int
        :param https: The param of the ShowCertificatesHttpsInfoResponse
        :type https: list[:class:`g42cloudsdkcdn.v1.HttpsDetail`]
        """
    ...
    def https(self):
        ...
        :rtype: list[:class:`g42cloudsdkcdn.v1.HttpsDetail`]
        """
        return self._https
