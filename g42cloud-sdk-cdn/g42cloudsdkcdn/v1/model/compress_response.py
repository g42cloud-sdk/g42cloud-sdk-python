...
class CompressResponse:
    ...
    def __init__(self, compress_switch=None, compress_rules=None):
        ...
        :param compress_switch: The param of the CompressResponse
        :type compress_switch: int
        :param compress_rules: The param of the CompressResponse
        :type compress_rules: list[:class:`g42cloudsdkcdn.v1.CompressRules`]
        """
    ...
    def compress_rules(self):
        ...
        :rtype: list[:class:`g42cloudsdkcdn.v1.CompressRules`]
        """
