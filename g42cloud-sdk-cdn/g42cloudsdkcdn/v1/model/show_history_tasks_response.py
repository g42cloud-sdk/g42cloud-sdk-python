...
class ShowHistoryTasksResponse(SdkResponse):
    ...
    def __init__(self, total=None, tasks=None):
        ...
        :param total: The param of the ShowHistoryTasksResponse
        :type total: int
        :param tasks: The param of the ShowHistoryTasksResponse
        :type tasks: list[:class:`g42cloudsdkcdn.v1.TasksObject`]
        """
    ...
    def tasks(self):
        ...
        :rtype: list[:class:`g42cloudsdkcdn.v1.TasksObject`]
        """
        return self._tasks
