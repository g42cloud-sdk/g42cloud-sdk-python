...
class UpdateRangeSwitchResponse(SdkResponse):
    ...
    def __init__(self, origin_range=None):
        ...
        :param origin_range: The param of the UpdateRangeSwitchResponse
        :type origin_range: :class:`g42cloudsdkcdn.v1.OriginRangeBody`
        """
    ...
    def origin_range(self):
        ...
        :rtype: :class:`g42cloudsdkcdn.v1.OriginRangeBody`
        """
