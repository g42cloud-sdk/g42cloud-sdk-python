...
class DomainItemLocationDetails:
    ...
    def __init__(self, start_time=None, end_time=None, stat_type=None, domains=None):
        ...
        :param start_time: The param of the DomainItemLocationDetails
        :type start_time: int
        :param end_time: The param of the DomainItemLocationDetails
        :type end_time: int
        :param stat_type: The param of the DomainItemLocationDetails
        :type stat_type: str
        :param domains: The param of the DomainItemLocationDetails
        :type domains: list[:class:`g42cloudsdkcdn.v1.DomainRegion`]
        """
    ...
    def domains(self):
        ...
        :rtype: list[:class:`g42cloudsdkcdn.v1.DomainRegion`]
        """
