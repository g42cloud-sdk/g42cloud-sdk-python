...
class UpdateBlackWhiteListResponse(SdkResponse):
    ...
    def __init__(self, code=None, result=None, data=None):
        ...
        :param code: The param of the UpdateBlackWhiteListResponse
        :type code: str
        :param result: The param of the UpdateBlackWhiteListResponse
        :type result: str
        :param data: The param of the UpdateBlackWhiteListResponse
        :type data: object
        """
