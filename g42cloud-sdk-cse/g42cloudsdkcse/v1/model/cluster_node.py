...
class ClusterNode:
    ...
    def __init__(self, id=None, az=None, ip=None, label=None, status=None):
        ...
        :param id: The param of the ClusterNode
        :type id: str
        :param az: The param of the ClusterNode
        :type az: str
        :param ip: The param of the ClusterNode
        :type ip: str
        :param label: The param of the ClusterNode
        :type label: str
        :param status: The param of the ClusterNode
        :type status: str
        """
