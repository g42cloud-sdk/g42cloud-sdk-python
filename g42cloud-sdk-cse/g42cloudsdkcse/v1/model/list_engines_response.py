...
class ListEnginesResponse(SdkResponse):
    ...
    def __init__(self, total=None, data=None):
        ...
        :param total: The param of the ListEnginesResponse
        :type total: int
        :param data: The param of the ListEnginesResponse
        :type data: list[:class:`g42cloudsdkcse.v1.EngineSimpleInfo`]
        """
    ...
    def data(self):
        ...
        :rtype: list[:class:`g42cloudsdkcse.v1.EngineSimpleInfo`]
        """
        return self._data
