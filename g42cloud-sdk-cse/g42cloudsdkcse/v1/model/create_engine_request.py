...
class CreateEngineRequest:
    ...
    def __init__(self, x_enterprise_project_id=None, body=None):
        ...
        :param x_enterprise_project_id: The param of the CreateEngineRequest
        :type x_enterprise_project_id: str
        :param body: The param of the CreateEngineRequest
        :type body: :class:`g42cloudsdkcse.v1.EngineCreateReq`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`g42cloudsdkcse.v1.EngineCreateReq`
        """
        return self._body
