...
class Task:
    ...
    def __init__(self, job_id=None, id=None, type=None, assigned=None, task_name=None, engine_name=None, task_order=None, status=None, start_time=None, end_time=None, create_time=None, update_time=None, timeout=None, log=None, output=None, task_executor_brief=None):
        ...
        :param job_id: The param of the Task
        :type job_id: int
        :param id: The param of the Task
        :type id: int
        :param type: The param of the Task
        :type type: str
        :param assigned: The param of the Task
        :type assigned: str
        :param task_name: The param of the Task
        :type task_name: str
        :param engine_name: The param of the Task
        :type engine_name: str
        :param task_order: The param of the Task
        :type task_order: int
        :param status: The param of the Task
        :type status: str
        :param start_time: The param of the Task
        :type start_time: int
        :param end_time: The param of the Task
        :type end_time: int
        :param create_time: The param of the Task
        :type create_time: int
        :param update_time: The param of the Task
        :type update_time: int
        :param timeout: The param of the Task
        :type timeout: int
        :param log: The param of the Task
        :type log: str
        :param output: The param of the Task
        :type output: str
        :param task_executor_brief: The param of the Task
