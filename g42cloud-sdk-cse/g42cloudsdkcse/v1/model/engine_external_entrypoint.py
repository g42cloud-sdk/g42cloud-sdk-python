...
class EngineExternalEntrypoint:
    ...
    def __init__(self, external_address=None, public_address=None, service_endpoint=None, public_service_endpoint=None):
        ...
        :param external_address: The param of the EngineExternalEntrypoint
        :type external_address: str
        :param public_address: The param of the EngineExternalEntrypoint
        :type public_address: str
        :param service_endpoint: The param of the EngineExternalEntrypoint
        :type service_endpoint: dict(str, EntrypointItem)
        :param public_service_endpoint: The param of the EngineExternalEntrypoint
