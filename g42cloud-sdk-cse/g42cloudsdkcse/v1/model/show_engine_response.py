...
class ShowEngineResponse(SdkResponse):
    ...
    def __init__(self, id=None, name=None, description=None, auth_type=None, flavor=None, payment=None, version=None, latest_version=None, status=None, be_default=None, create_user=None, create_time=None, cce_spec=None, external_entrypoint=None, reference=None, latest_job_id=None, enterprise_project_id=None, enterprise_project_name=None, engine_additional_actions=None, spec_type=None, type=None, project_id=None, vm_ids=None):
        ...
        :param id: The param of the ShowEngineResponse
        :type id: str
        :param name: The param of the ShowEngineResponse
        :type name: str
        :param description: The param of the ShowEngineResponse
        :type description: str
        :param auth_type: The param of the ShowEngineResponse
        :type auth_type: str
        :param flavor: The param of the ShowEngineResponse
        :type flavor: str
        :param payment: The param of the ShowEngineResponse
        :type payment: str
        :param version: The param of the ShowEngineResponse
        :type version: str
        :param latest_version: The param of the ShowEngineResponse
        :type latest_version: str
        :param status: The param of the ShowEngineResponse
        :type status: str
        :param be_default: The param of the ShowEngineResponse
        :type be_default: bool
        :param create_user: The param of the ShowEngineResponse
        :type create_user: str
        :param create_time: The param of the ShowEngineResponse
        :type create_time: int
        :param cce_spec: The param of the ShowEngineResponse
        :type cce_spec: :class:`g42cloudsdkcse.v1.Spec`
        :param external_entrypoint: The param of the ShowEngineResponse
        :type external_entrypoint: :class:`g42cloudsdkcse.v1.EngineExternalEntrypoint`
        :param reference: The param of the ShowEngineResponse
        :type reference: :class:`g42cloudsdkcse.v1.EngineReference`
        :param latest_job_id: The param of the ShowEngineResponse
        :type latest_job_id: int
        :param enterprise_project_id: The param of the ShowEngineResponse
        :type enterprise_project_id: str
        :param enterprise_project_name: The param of the ShowEngineResponse
        :type enterprise_project_name: str
        :param engine_additional_actions: The param of the ShowEngineResponse
        :type engine_additional_actions: list[str]
        :param spec_type: The param of the ShowEngineResponse
        :type spec_type: str
        :param type: The param of the ShowEngineResponse
        :type type: str
        :param project_id: The param of the ShowEngineResponse
        :type project_id: str
        :param vm_ids: The param of the ShowEngineResponse
    ...
    def cce_spec(self):
        ...
        :rtype: :class:`g42cloudsdkcse.v1.Spec`
        """
    ...
    def external_entrypoint(self):
        ...
        :rtype: :class:`g42cloudsdkcse.v1.EngineExternalEntrypoint`
        """
    ...
    def reference(self):
        ...
        :rtype: :class:`g42cloudsdkcse.v1.EngineReference`
        """
