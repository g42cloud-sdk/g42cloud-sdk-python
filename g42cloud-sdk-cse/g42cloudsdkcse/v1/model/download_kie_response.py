...
class DownloadKieResponse(SdkResponse):
    ...
    def __init__(self, metadata=None, data=None):
        ...
        :param metadata: The param of the DownloadKieResponse
        :type metadata: :class:`g42cloudsdkcse.v1.DownloadKieResponseBodyMetadata`
        :param data: The param of the DownloadKieResponse
        :type data: list[:class:`g42cloudsdkcse.v1.CreateKieReq`]
        """
    ...
    def metadata(self):
        ...
        :rtype: :class:`g42cloudsdkcse.v1.DownloadKieResponseBodyMetadata`
        """
    ...
    def data(self):
        ...
        :rtype: list[:class:`g42cloudsdkcse.v1.CreateKieReq`]
        """
        return self._data
