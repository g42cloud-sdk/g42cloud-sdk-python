...
class EngineSimpleInfo:
    ...
    def __init__(self, id=None, name=None, enterpris_project_id=None, enterprise_project_name=None, type=None, description=None, flavor=None, payment=None, auth_type=None, status=None, external_address=None, service_endpoint=None, public_address=None, public_service_endpoint=None, total_instance=None, used_instance=None, available_instance=None, version=None, latest_version=None, create_time=None, due_to=None, latest_job_id=None, engine_additional_actions=None, spec_type=None, reference=None):
        ...
        :param id: The param of the EngineSimpleInfo
        :type id: str
        :param name: The param of the EngineSimpleInfo
        :type name: str
        :param enterpris_project_id: The param of the EngineSimpleInfo
        :type enterpris_project_id: str
        :param enterprise_project_name: The param of the EngineSimpleInfo
        :type enterprise_project_name: str
        :param type: The param of the EngineSimpleInfo
        :type type: str
        :param description: The param of the EngineSimpleInfo
        :type description: str
        :param flavor: The param of the EngineSimpleInfo
        :type flavor: str
        :param payment: The param of the EngineSimpleInfo
        :type payment: str
        :param auth_type: The param of the EngineSimpleInfo
        :type auth_type: str
        :param status: The param of the EngineSimpleInfo
        :type status: str
        :param external_address: The param of the EngineSimpleInfo
        :type external_address: str
        :param service_endpoint: The param of the EngineSimpleInfo
        :type service_endpoint: dict(str, EntrypointItem)
        :param public_address: The param of the EngineSimpleInfo
        :type public_address: str
        :param public_service_endpoint: The param of the EngineSimpleInfo
        :type public_service_endpoint: dict(str, EntrypointItem)
        :param total_instance: The param of the EngineSimpleInfo
        :type total_instance: int
        :param used_instance: The param of the EngineSimpleInfo
        :type used_instance: int
        :param available_instance: The param of the EngineSimpleInfo
        :type available_instance: int
        :param version: The param of the EngineSimpleInfo
        :type version: str
        :param latest_version: The param of the EngineSimpleInfo
        :type latest_version: str
        :param create_time: The param of the EngineSimpleInfo
        :type create_time: int
        :param due_to: The param of the EngineSimpleInfo
        :type due_to: int
        :param latest_job_id: The param of the EngineSimpleInfo
        :type latest_job_id: int
        :param engine_additional_actions: The param of the EngineSimpleInfo
        :type engine_additional_actions: list[str]
        :param spec_type: The param of the EngineSimpleInfo
        :type spec_type: str
        :param reference: The param of the EngineSimpleInfo
