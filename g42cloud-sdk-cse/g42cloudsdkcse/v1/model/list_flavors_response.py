...
class ListFlavorsResponse(SdkResponse):
    ...
    def __init__(self, total=None, data=None):
        ...
        :param total: The param of the ListFlavorsResponse
        :type total: int
        :param data: The param of the ListFlavorsResponse
        :type data: list[:class:`g42cloudsdkcse.v1.FlavorBrief`]
        """
    ...
    def data(self):
        ...
        :rtype: list[:class:`g42cloudsdkcse.v1.FlavorBrief`]
        """
        return self._data
