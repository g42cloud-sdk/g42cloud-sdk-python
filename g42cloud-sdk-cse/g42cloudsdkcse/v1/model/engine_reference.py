...
class EngineReference:
    ...
    def __init__(self, vpc=None, az_list=None, network_id=None, subnet_cidr=None, subnet_cidr_v6=None, subnet_gateway=None, public_ip_id=None, service_limit=None, instance_limit=None, inputs=None):
        ...
        :param vpc: The param of the EngineReference
        :type vpc: str
        :param az_list: The param of the EngineReference
        :type az_list: list[str]
        :param network_id: The param of the EngineReference
        :type network_id: str
        :param subnet_cidr: The param of the EngineReference
        :type subnet_cidr: str
        :param subnet_cidr_v6: The param of the EngineReference
        :type subnet_cidr_v6: str
        :param subnet_gateway: The param of the EngineReference
        :type subnet_gateway: str
        :param public_ip_id: The param of the EngineReference
        :type public_ip_id: str
        :param service_limit: The param of the EngineReference
        :type service_limit: int
        :param instance_limit: The param of the EngineReference
        :type instance_limit: int
        :param inputs: The param of the EngineReference
